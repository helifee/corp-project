...
$(function () {
	...
	$('.singleArray-first').xljSingleArraySelector({
	    ...
	    treeUrl: serviceUrl+'flow/businessObjectVariable/getVariableTreeByBusiObject',
...
function querySingleVariable(id){
	$.ajax({
	       url: serviceUrl+"flow/businessObjectVariable/get/"+id+"?t="+ new Date().getTime(),
	       type:'GET',
...
function queryBusinessVariable(dataId){
	$.ajax({
	       url: serviceUrl+"flow/businessObjectVariable/get/"+dataId+"?t="+ new Date().getTime(),
	       type:'GET',
	       contentType:'application/json',
	       dataType:'JSON',
	       success:function (resultData) {
...
function queryRelateBusinessObject(relateObjectId){
	$.ajax({
	       url: serviceUrl+"flow/businessObject/get/"+relateObjectId,
	       type:'GET',
	       contentType:'application/json',
	       dataType:'JSON',
	       success:function (resultData) {
...
function initSearchTable(){
	jQuery("#jqgridList").jqGrid({
        url: serviceUrl+"flow/businessObject/seachKeyword",//获取数据的地址
...
function updateFormData(busiObjDto){
	$.ajax({
	       url: serviceUrl+"flow/businessObjectVariable/update/"+busiObjDto.id,
...
function saveFormData(busiObjDto){
	...
	$.ajax({
	       url: serviceUrl+"flow/businessObjectVariable/save",
	       data:JSON.stringify(busiObjDto),
	       type:'POST',
	       contentType:'application/json',
	       dataType:'JSON',
