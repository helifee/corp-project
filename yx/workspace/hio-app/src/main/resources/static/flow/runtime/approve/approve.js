...
function setMessageOpened() {
	$.ajax({
		type: 'GET',
		url: serviceUrl + 'flow/sysNoticeMsg/setMessageOpened?messageId=' +$.getUrlParam("msgId"),
		contentType: 'application/json; charset=utf-8',
		dataType: 'json',
		success: function() {
...
function withDrawTask() {
	$.ajax({
		type: 'GET',
		url: serviceUrl + 'flow/instance/withDrawTask?instanceId=' + $.getUrlParam('instanceId') 
...
function initOperation() {
	...
	$.ajax({
		type: 'POST',
		url: serviceUrl + 'flow/approveOperation/queryListByApproveRoleCode',
		contentType: 'application/json; charset=utf-8',
		dataType: 'json',
...
function initNext() {
	...
	$.ajax({
		type: 'POST',
		url: serviceUrl + 'flow/instance/queryNext',
		contentType: 'application/json; charset=utf-8',
		dataType: 'json',
