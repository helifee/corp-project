...
function exportDetailData(){  
	...
	var url = serviceUrl+"flow/instanceStat/exportTaskLengthDetail"+paramText;
...
function queryStatDetailList(){
    ...
    jQuery("#jqgridList").jqGrid(//创建jqGrid组件
        {
            url : serviceUrl+"flow/instanceStat/detailTaskLengthList",//获取数据的地址
    		...
    		ondblClickRow:function(rowId){
    	    	var url = serviceUrl+"flow/runtime/approve/flow.html?instanceId=" + rowId
