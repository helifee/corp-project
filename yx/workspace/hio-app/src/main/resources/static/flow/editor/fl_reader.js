...
function queryFlowReaderList(){
	...
	var dataList;
	$.ajax({  
	       url: serviceUrl+"flow/participant/queryFlowReaderList",
...
function deleteReaderByFormData(readerObjDto){
	...
	$.ajax({
	       url: serviceUrl+"flow/participant/deleteReaderByFormData",
...
function addResetReaderFormData(readerObjDto){
	console.log("readerObjDto="+JSON.stringify(readerObjDto));
	$.ajax({
	       url: serviceUrl+"flow/participant/addResetReaderFormData",
	       data: JSON.stringify(readerObjDto),
	       type: 'POST',
	       contentType: 'application/json',
	       dataType: 'JSON',
