...
function exportData(){  
	...
	var url = serviceUrl+"flow/instanceStat/exportOperateTimes"+paramText;  
...
function exportData_01(){  
	...
	$.ajax({  
        type: 'GET',  
        url: serviceUrl+"flow/instanceStat/exportUseTimes",  
...
function gotoDetail(operateType, statWay, statWayId){
	...
	var url = encodeURI(serviceUrl+"flow/stat/operate_times_detail.html?statWayId="+statWayId+"&operateType="+operateType+"&statWay="+statWay
...
function initStatGridList(){
	...
	var urlText = serviceUrl+"/flow/instanceStat/statOperateTimes";
	var colModel = [ 
