...
function exportData(){  
	...
	var url = serviceUrl+"flow/instanceStat/exportTaskLength"+paramText;  
...
function gotoDetail(statType, statWay, statWayId){
	...
	var url = encodeURI(serviceUrl+"flow/stat/task_length_detail.html?statType="+statType+"&statWay="+statWay
...
function initStatGridList(){
	...
	var urlText = serviceUrl+"/flow/instanceStat/statTaskLength";
	var colModel = [ 
