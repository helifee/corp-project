...
define(['xljUtils', 'utils','actions'], function (xljUtils, utils,action) {
    ...
    var initInstanceGraph = function () {
        ...
        $.ajax({
            type: "get",
            url: serviceUrl + "flow/instance/getInstanceGraph/" + instanceId + "?entryType=true&time=" + new Date().getTime(),
    ...
    //设置画布编辑器高度
    var resizeFlowEditorHeight = function (){
        $("#_designer").height(($(window).height()-2)+"px");
