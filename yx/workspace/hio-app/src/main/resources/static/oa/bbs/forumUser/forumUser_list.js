;(function($,window,document,undefined){
    ...
    function  bindButton() {
        ...
        $('#removeGagBtn').click(function () {
            ...
            if(idVal){
                $.ajax({
                    type: 'PUT',
                    url: serviceUrl + "oa/bbs/forumUser/update/"+idVal,
                    dataType: "json",
    ...
    function initJqGrid(){
        jqGrid = $("#list").jqGrid(
            {
                url: serviceUrl+"/oa/bbs/forumUser/page",
    ...
    function getOperationAuthorition() {
        ...
        $.ajax({
            type: 'GET',
            url: serviceUrl + 'sys/authentication/getUserAuthenticationOperation?t_='+new Date().getTime()+'&appCode=OA&menuCode=jyjl',
            dataType: 'json',
            //contentType: 'application/json',
            async: false,
