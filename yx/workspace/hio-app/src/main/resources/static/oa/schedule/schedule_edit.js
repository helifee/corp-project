...
$(function () {
    ...
    function initFormData() {
        $.ajax({
            url:serviceUrl + 'oa/workSchedule/get/'+urlParams.workScheduleId,
            type:'GET',
            dataType:'JSON',
    ...
    $('#saveBtn').on('click',function () {
        ...
        if(urlParams.act=='create'){
            $('#workScheduleForm').attr('action',serviceUrl+'oa/workSchedule/save');
            $('#workScheduleForm').attr('method','POST');
        }else if(urlParams.act=='update'){
            $('#workScheduleForm').attr('action',serviceUrl+'oa/workSchedule/update/'+urlParams.workScheduleId);
...
function saveForm(operateType) {
    ...
    if (operateType == "create") {
        $.ajax({
            url: serviceUrl + "/oa/workSchedule/save",
