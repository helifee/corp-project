    ...
    function initFormData() {
        if(urlParamJson.act=='create'){
           ...
           if(name != null && name != "undefined" && name != "null"){
            ...
            var idVal = urlParamJson.id;
            $.ajax({
                url:serviceUrl+'oa/servey/serveyCategory/get/'+idVal+'?time='+Math.random(),
                type:'GET',
                dataType:'JSON',
...
function serverCategoryEdit(serveyCategoryFormType){
	...
	var type = '';
	if(urlParamJson.act=='create'){
		url = serviceUrl+'oa/servey/serveyCategory/save';
		type = 'POST';
	}else if(urlParamJson.act=='update'){
		var idVal = urlParamJson.id;
		url = serviceUrl+'oa/servey/serveyCategory/update/'+idVal;
		type = 'put';
	}
...
function serveyCategoryQueryList(parentId,name) {
    $.ajax({
        type: "post",
        contentType: "application/json",
        url: serviceUrl + "oa/servey/serveyCategory/queryList?time=" + Math.random(),
