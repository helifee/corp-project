...
(function(window,document){
    var _entryList = {
    	...
    	get_dataList:function(){
    		var my = this;
    		jQuery('#tree').jqGrid({
				url:serviceUrl+"sys/quick/entry/queryTreeList"+'?time='+Math.random(),
    	...
    	to_updateStatus:function(_val){
    		...
    		$.ajax({
    			url:serviceUrl+"sys/quick/entry/updateStatus/"+ids,
    			type:'PUT',
    			dataType:'JSON',
    	...
    	to_deleteEntry:function(){
    		...
    		pop_text_open("blue",str,function(){
    			$.ajax({
    				url:serviceUrl+"sys/quick/entry/deletePseudoBatch/"+delIds,
    				type:'DELETE',
    				dataType:'JSON',
    	...
    	upRulerSort:function (type){
    		...
    		$.ajax({
    			url:serviceUrl+"sys/quick/entry/updateSort/"+ids,
    			type:'put',
    			dataType:'JSON',
