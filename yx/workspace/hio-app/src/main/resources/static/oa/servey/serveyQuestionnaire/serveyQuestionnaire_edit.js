...
;(function ($,window,document,undefined) {
    ...
    $(document).ready(function () {
        try {
            ...
            if(oper == 'DY'){
            	...
            	$.ajax({ //发送更新的ajax请求
                    type: "post",
                    url: serviceUrl+"flow/sysNoticeMsg/updateStatusOfNoticeMsg?time="+Math.random(),
                    dataType: "json",
                    async: false,
    ...
    function bindButton() {
        ...
        $("#replyInfo").click(function () {
            ...
            $.ajax({
                ...
                url:serviceUrl + 'oa/servey/serveyParty/queryJoinServeyUserInfo/'+'?time='+Math.random(),
    ...
    function createContentRowTypeForm() {
        $.ajax({
            type: "post",
            contentType: "application/json",
            url: serviceUrl + "oa/servey/serveyQuestion/queryList?time=" + Math.random(),
    ...
    function matrixMultiSelectQuestion(questionId) {
        ...
        $.ajax({
            ...
            type: 'POST',
            async: false,
            url: serviceUrl + 'oa/servey/serveySubQuestion/queryList',
            dataType: "json",
...
function getQuestionById(idVal){
	var result="";
	 $.ajax({
        url:serviceUrl+'oa/servey/get/'+idVal+'?time='+Math.random(),
        type:'GET',
        async: false,
        dataType:'JSON',
        success:function (resultData) {
