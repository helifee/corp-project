...
(function ($) {
    ...
    $.fn.eCalendar.defaults = {
        ...
        //默认事件
        events: [
            {title: '默认事件一', description: '周中汇报', datetime: new Date(2017, new Date().getMonth(), 1, 17)},
            {title: '默认事件二', description: 'BRA x ARG - Semifinal', datetime: new Date(2017, new Date().getMonth(), 3, 16)},
            {title: '默认事件三', description: 'Classificatórias de equipes', datetime: new Date(2017, new Date().getMonth(), 8, 16)}
        ],
        firstDayOfWeek: 0
    };
}(jQuery));