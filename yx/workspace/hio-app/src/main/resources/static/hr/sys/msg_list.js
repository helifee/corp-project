...
(function ($, window, document, undefined) {
    ...
    function initMsgList() {
        ...
        jqGridMsg = jQuery("#msgList").jqGrid(
            {
                url: platformhosturl + "flow/sysNoticeMsg/queryList",//创建完成之后请求数据的url
    ...
    function testTimeMsg(type) {
        ...
        $.ajax({
            url: serviceUrl + "sys/sysNoticeMsg/testTimeMsg",
            type: 'POST',
            dataType: 'JSON',
            contentType: 'application/json',
    ...
    function examNoticeMsg(personIds,showText) {
        ...
        $.ajax({
            url: serviceUrl + "sys/sysNoticeMsg/examNoticeMsg",
            type: 'POST',
            dataType: 'JSON',
            contentType: 'application/json',
            data: JSON.stringify(postDto),
    ...
    function del() {
        ...
        if (idsVal && idsVal != "") {
            $.xljUtils.confirm("blue", "确认要删除这【" + idsVal.length + "】条数据吗？", function () {
                $.ajax({
                    url: platformhosturl + "flow/sysNoticeMsg/deleteBatch/" + idsVal,
                    type: 'DELETE',
                    dataType: 'JSON',
                    contentType: 'application/json',
                    data: JSON.stringify({}),
