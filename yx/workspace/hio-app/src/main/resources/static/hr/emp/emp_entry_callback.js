        ...
        jQuery("#hrWageChangeForm").jqGrid(
            {
                ...
                contentType : "application/json",
                autowidth:true,
                colNames : [ 'id','年薪','薪资等级','原因'],
                colModel : [
                    {name : 'id',label : 'id',editable:true,width : 60,sortable:false,hidden:true},
                    {name : 'salBefore',label : 'salBefore',editable:true,width : 60,sortable:false},
                    {name : 'rankBefore',label : 'rankBefore',editable:true,width : 60,sortable:false,formatter:getWageRank},
                    {name : 'cause',label : 'cause',editable:true,width : 60,sortable:false}
                ],
                postData:{"applyId":applicationUUID},
                multiboxonly:true,
                rownumbers:true,
        ...
        jQuery("#hrWageSubchangeForm").jqGrid(
            {
                ...
                colModel : [
                    ...
                    {name : 'telSubsidyBefore',label : 'telSubsidyBefore',editable:true,width : 60,sortable:false},
                    {name : 'tranSubsidyBefore',label : 'tranSubsidyBefore',editable:true,width : 60,sortable:false},
                    {name : 'houseSubsidyBefore',label : 'houseSubsidyBefore',editable:true,width : 60,sortable:false},
                    {name : 'workPlaceRankBefore',label : 'workPlaceRankBefore',editable:true,width : 60,sortable:false,formatter:$.hrUtils.getHRCodeNameById}
                ],
                postData:{"applyId":applicationUUID},
                multiboxonly:true,
                rownumbers:true,
