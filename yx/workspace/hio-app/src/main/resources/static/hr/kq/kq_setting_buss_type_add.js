...
$(function () {
    ...
    if (type == 'add') {
        $('title').text("出差设置-新增");
        $(".xj-form-title").text("出差设置-新增");
        pageInit();
        initUuid();
        getMaxCode();
    } else if (type = 'update') {
        $('title').text("出差设置-修改");
        $(".xj-form-title").text("出差设置-修改");
        holidayTypeEditId = $.xljUtils.getUrlParam("holidayEditId");//window.opener.holidayTypeEditId;
        systemItemFlag = $.xljUtils.getUrlParam("systemItemFlag");//window.opener.systemItemFlag;
        pageInit();
...
function queryHolidayUnitList() {
    $.ajax({
        url: serviceUrl + "kq/hrKqHolidaytypeSetting/queryHolidayUnitList",
        type: 'POST',
        dataType: 'JSON',
...
function queryCalculateRuleList() {
    $.ajax({
        url: serviceUrl + "kq/hrKqHolidaytypeSetting/queryCalculateRuleList",
        type: 'POST',
        dataType: 'JSON',
        async: false,
        contentType: 'application/json',
...
function queryHolidayTypeList() {
    $.ajax({
        url: serviceUrl + "kq/hrKqHolidaytypeSetting/queryHolidayTypeList",
        type: 'POST',
        dataType: 'JSON',
        async: false,
        contentType: 'application/json',
...
function queryHolidayStatusList() {
    $.ajax({
        url: serviceUrl + "kq/hrKqHolidaytypeSetting/queryHolidayStatusList",
        type: 'POST',
        dataType: 'JSON',
        async: false,
        contentType: 'application/json',
...
function queryHolidayPropertyList() {
    $.ajax({
        url: serviceUrl + "kq/hrKqHolidaytypeSetting/queryHolidayPropertyList",
        type: 'POST',
        dataType: 'JSON',
        async: false,
        contentType: 'application/json',
...
function getHolidayTypeInfoById(id) {
    var urlBody = "kq/hrKqBusstypeSetting/get/" + id + "?time=" + Math.random();
...
function addSaveForm(sign) {
    ...
    hrKqHolidaytypeSettingDto.delflag = false;
    // hrKqHolidaytypeSettingDto.status = "1092100169";//启用

    $.ajax({
        url: serviceUrl + "kq/hrKqBusstypeSetting/save",
        type: 'POST',
        dataType: 'JSON',
        contentType: 'application/json',
...
function checkIfRename() {
    var name = $("#name").val();
    $.ajax({
        url: serviceUrl + "kq/hrKqHolidaytypeSetting/queryIfRename",
        type: 'POST',
        dataType: 'JSON',
        contentType: 'application/json',
        async: false,
...
function editSaveForm() {
    ...
    $.ajax({
        url: serviceUrl + "kq/hrKqBusstypeSetting/update/" + hrKqHolidaytypeSettingDto.id,
        type: 'PUT',
        dataType: 'JSON',
        contentType: 'application/json',
        data: JSON.stringify(hrKqHolidaytypeSettingDto),
...
function getMaxCode() {
    var maxCode = 0;
    var urlBody = "kq/hrKqBusstypeSetting/getMaxCode";
    var urlAll = serviceUrl + urlBody;
    $.ajax({
        type: 'POST',
        url: urlAll,
