...
(function ($, window, document, undefined) {
    ...
    function iniPersonListList() {
        ...
        jqGridOrgSize = jQuery("#personList").jqGrid(
            {
                url: serviceUrl + '/wage/wageRecord/queryListDimissionNoStopSalary',//创建完成之后请求数据的url
                datatype: "JSON",//请求数据返回的类型。可选json,xml,txt
                mtype: "post",//向后台请求数据的ajax的类型。可选post,get
                ajaxGridOptions: {contentType: 'application/json'},
                contentType: "application/json",
                postData: postData,
                colNames: ['id', '姓名', '人员编号', '所属机构', '岗位', '人员类别', '证件号码', '入职日期', '进入本公司日期'],//列名
                colModel: [ //jqGrid每一列的配置信息。包括名字，索引，宽度,对齐方式.....
                    ...
                    {name: 'orgId', index: 'orgId', editable: true, width: 100, align: "center"},
