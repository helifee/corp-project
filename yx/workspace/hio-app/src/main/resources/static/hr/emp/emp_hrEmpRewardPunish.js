;(function($, window, document, undefined){
    ...
    window.submitAddForm = function(){
        ...
        hrEmpRewardPunishDto.delflag=false;//有效标志位
        hrEmpRewardPunishDto.personId=id;//关联人员Id
        hrEmpRewardPunishDto.id=uuid;//主键
        $.ajax({
            type: 'POST',
            url: baseUrl+'emp/hrEmpRewardPunish/save?time=' + Math.random(),
    ...
    window.submitEditForm = function(){
        ...
        $.ajax({
            type: 'PUT',
            url: baseUrl+'emp/hrEmpRewardPunish/update/'+id,
            data: JSON.stringify(hrEmpRewardPunishDto),
            dataType: "json",
            contentType: "application/json;charset=utf-8",
            success: function (xhr) {
    ...
    function editHrEmpRewardPunishInfo(id){
        url = baseUrl+'emp/hrEmpRewardPunish/get/'+id;
        $.ajax({
            type:'GET',
