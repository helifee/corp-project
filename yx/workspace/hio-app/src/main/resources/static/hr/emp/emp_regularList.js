...
(function ($, window, document, undefined) {
    ...
    $(function () {
        ...
        $("#addBtn").click(function(){
            var winObjEI = window.open("emp_regular.html?oper=add");
            // var isClose = 1;
            // //关闭open页面时刷新父页面列表
            ...
            if (idsVal && idsVal != "") {
                if (idsVal.length > 1) {
                    ...
                    if(rowData.status == '草稿'){
                        var winObjEI = window.open("emp_regular.html?oper=edit&id="+idsVal);
                        // var isClose = 1;
                        // //关闭open页面时刷新父页面列表
                        // var loop = setInterval(function () {
                        //     if (winObjEI.closed && isClose == 1) {
                        ...
                        var winObjEI = window.open("emp_regular_read.html?oper=edit&id="+idsVal);
                    }
                }
            } else {
        ...
        var jqGridSysInfoSet = jQuery("#empRegularForm").jqGrid(
            {
                ...
                ondblClickRow:function () {
                    ...
                    rowData = $('#empRegularForm').jqGrid('getRowData', rowId);
                    if(rowData.status == '草稿'){
                        var winObjEI = window.open("emp_regular.html?oper=edit&id="+rowId);
                        // var isClose = 1;
                        // //关闭open页面时刷新父页面列表
                        // var loop = setInterval(function () {
                        //     if (winObjEI.closed && isClose == 1) {
                        ...
                        // $.xljUtils.tip("blue", "非草稿状态数据不能修改！");
                        var winObjEI = window.open("emp_regular_read.html?oper=edit&id="+rowId);
                    }
                },
                gridComplete: function () {
