...
$(function () {
    ...
    if (type == 'add') {
        $('title').text("假期设置-新增");
        $(".xj-form-title").text("假期设置-新增");
        pageInit();
        initUuid();
        getMaxCode();
    } else if (type = 'update') {
        $('title').text("假期设置-修改");
        $(".xj-form-title").text("假期设置-修改");
        holidayTypeEditId = $.xljUtils.getUrlParam("holidayTypeEditId");//window.opener.holidayTypeEditId;
...
function addSaveForm(sign) {
    ...
    $.ajax({
        url: serviceUrl + "kq/hrKqHolidaytypeSetting/save",
        type: 'POST',
        dataType: 'JSON',
        contentType: 'application/json',
...
function editSaveForm() {
    ...
    $.ajax({
        url: serviceUrl + "kq/hrKqHolidaytypeSetting/update/" + hrKqHolidaytypeSettingDto.id,
        type: 'PUT',
        dataType: 'JSON',
        contentType: 'application/json',
        data: JSON.stringify(hrKqHolidaytypeSettingDto),
