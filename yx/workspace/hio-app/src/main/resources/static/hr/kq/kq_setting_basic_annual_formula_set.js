...
function saveAnnualFormulaLimit(sign) {
    ...
    hrAnnualFormulaDto.delflag = false;

    $.ajax({
        url: serviceUrl + "kq/hrAnnualFormula/save",
        // url: serviceUrl + "kq/hrAnnualFormula/update/2c06c731a8ec494dadacfcc652e6017e",
        type: 'POST',
        dataType: 'JSON',
...
function queryAnnualLimitType() {
    $.ajax({
        url: serviceUrl + "kq/hrAnnualFormula/queryAnnualLimitType",
        type: "post",
        data: "{}",
        dataType: 'JSON',
        async: false,
...
function saveAnnualStandardForm(sign) {
    ...
    hrAnnualStandardDto.delflag = false;

    $.ajax({
        url: serviceUrl + "kq/hrAnnualStandard/saveAnnualStandard2",
        type: 'POST',
        dataType: 'JSON',
        contentType: 'application/json',
...
function queryAnnualStandard() {
    var standardType = $("input[name='standardType']:checked").val();
    $.ajax({
        url: serviceUrl + "kq/hrAnnualStandard/queryListByCondition",
        type: "post",
        // data: "{}",
