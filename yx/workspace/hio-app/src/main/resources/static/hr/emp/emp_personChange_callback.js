        ...
        jQuery("#empChangeApplyForm").jqGrid(
            {
                ...
                colModel : [
                    ...
                    {name : 'personId',label : 'personId',editable:true,width : 60,sortable:false,hidden:true,align:'center'},
                    {name : 'personName',label : 'personName',editable:true,width : 60,sortable:false,align:'center'},
                    ...
                    {name : 'subsidyRankBefore',label : 'subsidyRankBefore',editable:true,width : 60,sortable:false,align:'center',formatter:$.hrUtils.getHRCodeNameById},
                    ...
                    {name : 'subsidyRankAfter',label : 'subsidyRankAfter',editable:true,width : 60,sortable:false,align:'center',formatter:$.hrUtils.getHRCodeNameById},
                    {name : 'telSubsidyAfter',label : 'telSubsidyAfter',editable:true,width : 60,sortable:false,align:'center',hidden:true},
                    {name : 'tranSubsidyAfter',label : 'tranSubsidyAfter',editable:true,width : 60,sortable:false,align:'center'},
                    {name : 'houseSubsidyAfter',label : 'houseSubsidyAfter',editable:true,width : 60,sortable:false,align:'center'},
                    {name : 'telPercent',label : 'telPercent',editable:true,width : 60,sortable:false,align:'center',hidden:true},
                    {name : 'tranPercent',label : 'tranPercent',editable:true,width : 60,sortable:false,align:'center'},
                    {name : 'housePercent',label : 'housePercent',editable:true,width : 60,sortable:false,align:'center'},
                    ...
                    {name : 'wageRankBefore',label : 'wageRankBefore',editable:true,width : 60,sortable:false,align:'center',formatter:$.hrUtils.getHRCodeNameById},
                    {name : 'salBefore',label : 'salBefore',editable:true,width : 60,sortable:false,align:'center'},
                    {name : 'wageRankAfter',label : 'wageRankAfter',editable:true,width : 60,sortable:false,align:'center',formatter:$.hrUtils.getHRCodeNameById},
                    ...
                    {name : 'orgBefore',label : 'orgBefore',editable:true,width : 60,sortable:false,align:'center',formatter:$.hrUtils.getHRPrefixOrgNameById},
                    ...
                    {name : 'orgAfter',label : 'orgAfter',editable:true,width : 60,sortable:false,align:'center',formatter:$.hrUtils.getHRPrefixOrgNameById},
                    {name : 'deptAfter',label : 'deptAfter',editable:true,width : 60,sortable:false,align:'center',formatter:$.hrUtils.getHROrgNameById},
                    {name : 'postAfter',label : 'postAfter',editable:true,width : 60,sortable:false,align:'center',formatter:$.hrUtils.getHRPostNameById},
                    {name : 'headshipRankAfter',label : 'headshipRankAfter',editable:true,width : 60,sortable:false,align:'center',formatter:$.hrUtils.getHRCodeNameById},
                    {name : 'workPlaceRankBefore',label : 'workPlaceRankBefore',editable:true,width : 60,sortable:false,align:'center',formatter:$.hrUtils.getHRCodeNameById},
                    {name : 'workPlaceRankAfter',label : 'workPlaceRankAfter',editable:true,width : 60,sortable:false,align:'center',formatter:$.hrUtils.getHRCodeNameById}
                ],
