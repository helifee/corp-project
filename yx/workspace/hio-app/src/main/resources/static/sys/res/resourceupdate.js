...
function getResourceById(){
	var resourceId = window.opener.updateResourceId;
	var uBody = "platform-app/sys/res/resource/get/"+resourceId;
	...
	$.ajax({
        ...
        success: function(data) {
         ...
         $("#resourceFrom").find("input[name='id']").val(data.result.id);
         $("#resourceFrom").find("input[name='code']").val(data.result.code);
...
function saveForm(){
   ...
   var uBody = "platform-app/sys/res/resource/update/"+resourceId;
   var uAll = urlHost + uBody;
   $.ajax({
       url:uAll,
