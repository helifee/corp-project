...
//            callMarkEventDays();
        ...
        var dayClickEvent = function() {
            ...
            $.ajax({
                url:'http://127.0.0.1:9999/platform-app/oa/workSchedule/getScheduleByDate?_t='+new Date().getTime(),
                    ...
                    if(resultData.success){
                        ...
                        for (var i = 0; i < resultList.length; i++) {
                            ...
                            if(obj.type=='PERSONAL_PROCEEDING'){
                                eventObj.title = '事项';
                                eventObj.url =  'http://127.0.0.1:9999/platform-app/oa/schedule/schedule_edit.html?act=view&workScheduleId='+obj.id;
                            }else if(obj.type=='TASK'){
                                if(obj.status==1){
                                    isColor = true;
                                }
                                eventObj.title = '任务';
                                eventObj.url =  'http://127.0.0.1:9999/platform-app/oa/taskPackageDispatch/taskPackageDispatch_edit.html?dispatchId='+obj.id;
