    ...
    SingleSelector.prototype = {
        ...
        _init:function () {
			...
			modalContainer.on('show.bs.modal',function () {
                ...
                case 'org':
                    var url = serviceUrl + 'org/orgRoot/getTree';
                ...
                case 'org-selectDeptOnly'://机构只选择部门
                    ...
                    break;
                case 'person':
                    var url = serviceUrl+'/org/orgRoot/getUserTree';
					...
					if(typeof that.options.treeParam.userStatus == 'undefined'){
						that.options.treeParam.userStatus = '1143100260';//在职
					}else{
				...
				case 'post-standard'://选择标准岗位
                    ...
                    var url = serviceUrl+'org/post/getPostTree';
                    if(that.options.treeUrl){
                        url = that.options.treeUrl;
                    }
                    that.options.treeParam.rootDelFlag = false;
                    ...
                    break;
                case 'post'://选择机构下岗位
                    var url = serviceUrl+'org/post/getPostTreeMul';
                    if(that.options.treeUrl){
                        url = that.options.treeUrl;
                    }
                    that.options.treeParam.rootDelFlag = false;
                ...
                case 'menu':
                    ...
                    break;
                case 'hrSysCode':
                    var url = serviceUrl+'sys/sysCodeItem/getCodeTree';
                    if(that.options.treeUrl){
                        url = that.options.treeUrl;
                    }
                    that.options.treeParam.delflag = false;
                    ...
                    break;
                case 'hrSysCodeSet':
                    var url = serviceUrl+'sys/sysCodeSet/getCodeSetTree';
                    if(that.options.treeUrl){
                        url = that.options.treeUrl;
                    }
                    that.options.treeParam.delflag = false;
                ...
                case 'person-platform'://人员-平台
                    var url = platformhosturl+'sys/org/user/getUserTree';
					...
					break;
                case 'org-platform':
                    var url = platformhosturl + 'sys/org/root/getTree';
                    if(that.options.treeUrl){
                        url = that.options.treeUrl;
                    }
                    that.options.treeParam.rootDelFlag = false;
					...
					break;
                case 'company':
                    var url = serviceUrl + 'org/orgRoot/getCompanyTree';
                    if(that.options.treeUrl){
                        url = that.options.treeUrl;
                    }
                    that.options.treeParam.rootDelFlag = false;
                ...
                case 'allCompany':   //无需权限查询所有公司
                    var url = serviceUrl + 'org/orgRoot/getAllCompanyTree';
                    if(that.options.treeUrl){
                        url = that.options.treeUrl;
                    }
                    that.options.treeParam.rootDelFlag = false;
                ...
                case 'hrEvaDimensionalityTree':
                    var url = serviceUrl+'eva/hrEvaDimensionalityTree/queryEvaDimensionalityTreeList';
                    if(that.options.treeUrl){
                        url = that.options.treeUrl;
                    }
                    that.options.treeParam.delflag = false;
