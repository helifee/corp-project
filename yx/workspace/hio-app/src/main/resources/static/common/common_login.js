...
document.write('<script src="https://cdn.bootcss.com/html5shiv/3.7.2/html5shiv.min.js" type="text/javascript"></script>');
document.write('<script src="https://cdn.bootcss.com/respond.js/1.4.2/respond.js" type="text/javascript"></script>');
document.write('<![endif]-->');
//document.write('<script src="'+baseUrl+'common/jquery/jquery-2.2.3.min.js" type="text/javascript"></script>');
document.write('<script src="'+baseUrl+'common/jquery/jquery-1.11.3.js" type="text/javascript"></script>');
