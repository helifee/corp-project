...
//document.write('<script src="' + serviceUrl + 'common/hrUtils/hrUtils.js" type="text/javascript"></script>');
//document.write('<script src="' + serviceUrl + 'common/hrUtils/code_tree.js" type="text/javascript"></script>');
//注：字典选择组件需要与平台的合并到一起，否则一起引用会出问题
// document.write('<script src="' + serviceUrl + 'common/hrUtils/hr_multipleSelector.js" type="text/javascript"></script>');
// document.write('<script src="' + serviceUrl + 'common/hrUtils/hr_singleSelector.js" type="text/javascript"></script>');
// document.write('<script src="' + serviceUrl + 'common/hrUtils/org_tree.js" type="text/javascript"></script>');
// document.write('<script src="' + serviceUrl + 'common/hrUtils/sys_apply.js" type="text/javascript"></script>');
// document.write('<script src="' + serviceUrl + 'common/hrUtils/sys_constant.js" type="text/javascript"></script>');
