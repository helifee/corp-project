$(function () {
    ...
    function initDictionaryTree() {
        $.ajax({
            type: "POST",
            url: serviceUrl + "oa/dictionary/contentDictionary/queryDictionaryTree",
            data: JSON.stringify({}),
            dataType: "json",
    ...
    $('#deleteDictionaryBtn').on('click',function () {
        ...
        $.xljUtils.confirm('blue', '确定要删除此字典项吗', function () {
            $.ajax({
                url: serviceUrl + "oa/dictionary/contentDictionary/deletePseudo/" + id,
                type: 'DELETE',
                dataType: 'JSON',
    ...
    $('#deleteItemBtn').on('click',function () {
        ...
        $.xljUtils.confirm('blue','确定要删除这'+ids.length+'条数据吗？',function () {
            $.ajax({
                url: serviceUrl + "oa/dictionary/contentDictionaryItem/deleteBatch/" + ids,
                type: 'DELETE',
                dataType: 'JSON',
                success: function (resultData) {
                    if (resultData && resultData.success) {
    ...
    $('#saveItemBtn').on('click',function () {
        ...
        $.ajax({
            url:serviceUrl + 'oa/dictionary/contentDictionaryItem/saveAllDictionaryItem',
