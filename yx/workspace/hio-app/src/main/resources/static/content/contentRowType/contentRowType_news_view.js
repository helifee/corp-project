...
$(function () {
                        ...
                        success:function (resultData ) {
                            if(resultData) {
                                ...
                                if(successFlag) {
                                    ...
                                    //contentDivObj.load(serviceUrl+resultData.msg);
                                }else {
    ...
    window.editBusiForm = function () {
        window.location.href = serviceUrl + 'content/contentRowType/contentRowType_news_edit.html?_time='+new Date().getTime()+'&id='+contentRowTypeId+'&oper=edit&approveType='+urlParam.approveType+'&iframeMode='+urlParam.iframeMode;
    };
