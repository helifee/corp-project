...
$(function () {
    ...
    function initAttributeGqGrid(contentTypeId) {
        ...
        jQuery("#contentTypeAttrGrid").jqGrid({
            url: serviceUrl + "oa/content/contentRowAttribute/page",
    ...
    $('#deleteBtn').on('click',function () {
        ...
        $.xljUtils.confirm('blue','确定要删除这'+ids.length+'条数据吗？',function () {
            $.ajax({
                url:serviceUrl+'oa/content/contentRowAttribute/deleteBatch/'+ids,
                type:'DELETE',
                dataType:'JSON',
    ...
    function udpateAttrStatus(isUsing) {
        ...
        $.ajax({
            ...
            url: serviceUrl + "oa/content/contentRowAttribute/updateBatchAttribute/" + ids.join(','),
    ...
    function sortContentAttr(sortType) {
        ...
        $.ajax({
            type: 'PUT',
            contentType: "application/json",
            url: serviceUrl + 'oa/content/contentRowAttribute/sortAttr/id',
