    ...
    function initFormData() {
        ...
        switch (act){
            case 'create':
                ...
                $('#contentDictionaryForm').attr('action',serviceUrl+'oa/dictionary/contentDictionary/save');
                ...
                $.ajax({
                    ...
                    success:function (resultData) {
                        if(resultData&&resultData.success) {
                            ...
                            $('#contentDictionaryForm').attr('action',serviceUrl+'oa/dictionary/contentDictionary/update/'+id);
