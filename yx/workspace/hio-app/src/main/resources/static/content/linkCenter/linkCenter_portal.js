$(function () {
    function initLinkList() {
        $.ajax({
            type: 'post',
            url: 'http://127.0.0.1:9999/platform-app/oa/sys/sysLinkCenter/queryListGroup?_t='+new Date().getTime(),
            dataType: 'json',
            ...
            complete:function(){
            	   $.ajax({
                       type: 'get',
                       url: 'http://127.0.0.1:9999/platform-app/oa/sys/sysLinkCenter/getQRcode?_t='+new Date().getTime(),
                       success:function(data){
