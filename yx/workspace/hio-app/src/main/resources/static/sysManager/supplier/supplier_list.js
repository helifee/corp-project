...
function getSupplierAccont(){
	  jQuery("#list3").jqGrid({
 		 	url:serviceUrl+'sys/base/baseSupplierAccont/getAccontBySupplierId',
          ajaxGridOptions: { contentType: 'application/json' },
          mtype : "POST",  
          contentType : "application/json",  
          datatype : "json", 
...
function  updateStatus(e){
	...
	$.ajax({
		url:serviceUrl+"sys/base/baseSupplier/updateStatus/"+ids,
		type:'PUT',
		dataType:'JSON',
		success:function (resultData ) {
			if (resultData&&resultData.success) {
...
function sendMessageToNCAgain(){
	...
	$.ajax({
		url:serviceUrl+"sys/base/baseSupplier/sendMessageToNCAgain/"+ids,
		type:'PUT',
		dataType:'JSON',
		success:function (resultData ) {
			if (resultData&&resultData.success) {
...
function sendMessageToNC(){
	...
	$.ajax({
        type:'post',
        url:serviceUrl+'sys/base/baseSupplier/sendMessageToNC/',
        dataType:'JSON',
