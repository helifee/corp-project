...
//					var appList=data.result;
	...
	$.ajax({
		type:'post',
		url:serviceUrl+'sys/res/dataPoint/queryByPram',
		dataType:'json',
		contentType:'application/json',
	...
	// var url = serviceUrl+'sys/res/funcPermission/queryAuthorizationListByAppIds';
	// var postAllData={
	// 		appIds:appIds
	// }
...
function getRoleAuthorizationData(operationIds,type){
	...
	if("standardPost"==objType){//标准岗位
		queryAuthorizationListUrl = serviceUrl+'sys/res/funcPermission/queryAuthorizationListAllRoles';
	}else if("role"==objType){//角色
		queryAuthorizationListUrl = serviceUrl+'sys/res/funcPermission/queryAuthorizationListAllCurrencyRoles';
	}else if("post"==objType){//岗位
		queryAuthorizationListUrl = serviceUrl+'sys/res/funcPermission/queryAuthorizationListAllPost';
	}else if("user"==objType){//用户
		queryAuthorizationListUrl = serviceUrl+'sys/res/funcPermission/queryAuthorizationListAllUser';
	}
	if(false){
