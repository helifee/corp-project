...
function pageInit(){
	if(parentId&&parentId!="null"){
		...
		$.ajax({
	        type:'get',
	        url:serviceUrl+"sys/base/baseProjectType/get/"+parentId+'?time='+Math.random(),
...
function getProjectTypeData(id){
	$.ajax({
        type:'get',
        url:serviceUrl+"sys/base/baseProjectType/get/"+id+'?time='+Math.random(),
        success: function(data) {
        	if(data.success){
...
function saveForm(op){
	...
	var baseProjectTypeDto={};
		...
		if(type=="add"){
			$.ajax({
				url:serviceUrl+"sys/base/baseProjectType/save",
			...
			var ids=baseProjectTypeDto.id;
			   $.ajax({
			       url:serviceUrl+"sys/base/baseProjectType/update/"+ids,
			       data:JSON.stringify(baseProjectTypeDto),
			       type:'put',
			       contentType:'application/json',
			       dataType:'JSON',
