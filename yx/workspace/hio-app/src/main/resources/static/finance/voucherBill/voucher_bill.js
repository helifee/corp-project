...
function getAccountSetList(){
	...
	jQuery("#systemGrid").jqGrid(
            {
                url: serviceUrl+'finance/accountSet/getSystemRegisterpage',
...
function getVoucherCompany(){
	...
	$.ajax({
        type:'post',
        url:serviceUrl+'finance/accountSetCompany/queryList',
        dataType:'json',
        contentType:'application/json',
...
function getVoucherTemplatType(){
	var updatedata ={
		...
		$.ajax({
	        type:'post',
	        url:serviceUrl+'finance/voucherTemplateType/queryList',
	        dataType:'json',
	        contentType:'application/json',
	        data:JSON.stringify(updatedata),
	        async: true,
...
function loadBillGridColmn(){
	...
	$.ajax({
        type:'post',
        url:serviceUrl+'finance/voucherBill/getBillCol',
        dataType:'json',
        contentType:'application/json',
        data:JSON.stringify(updatedata),
        async: true,
...
function loadBillGrid(){
	jQuery("#generateList").jqGrid(
            {
                url: serviceUrl+'finance/voucherBill/getBillPage',
                ajaxGridOptions: { contentType: 'application/json' },
                mtype : "POST",  
                contentType : "application/json",  
                datatype : "json",
...
function createVouchar(flag){
	...
	$.ajax({
        type:'post',
        url:serviceUrl+'finance/voucherBill/createVouchar/',
        dataType:'JSON',
        data:JSON.stringify(updatedata),
        contentType : 'application/json',
        success: function(data){
...
function noCreateVouchar(){
	...
	$.ajax({
        type:'post',
        url:serviceUrl+'finance/voucherBill/noCreateVoucher/',
        dataType:'JSON',
        data:JSON.stringify(updatedata),
        contentType : 'application/json',
        success: function(data){
...
function loadVoucherGrid(){
	jQuery("#exportList").jqGrid(
            {
                url: serviceUrl+'finance/voucherBill/getVoucherBillPage',
                ajaxGridOptions: { contentType: 'application/json' },
                mtype : "POST",  
                contentType : "application/json",  
                datatype : "json",
...
function outputVoucher(){
	...
	$("#loading").show();
	$.ajax({
		url:serviceUrl+"finance/voucherBill/outputVoucher/"+ids,
		type:'post',
		contentType : 'application/json',
		dataType:'JSON',
...
function delVoucherBill(){
	...
	if(!ids || ids.length==0) {
	  ...
	  pop_text_open("blue",'确认要删除这这'+ids.length+'条数据吗？',function(){
			$.ajax({
				url:serviceUrl+"finance/voucherBill/deletePseudoBatch/"+ids,
				type:'DELETE',
				dataType:'JSON',
				success:function (resultData ) {
					if (resultData&&resultData.success) {
...
function download(filename){
	...
	location.href=serviceUrl + "finance/voucherBill/downLoad?voucherid="+ids+"&filename="+filename;
}