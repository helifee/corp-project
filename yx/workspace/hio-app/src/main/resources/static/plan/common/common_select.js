...
function getCompanySelectData(){
	$.ajax({
        type:'POST',
        url:serviceUrl+'pl/plCompany/queryCompany',
        dataType:'json',
        data:JSON.stringify({}),
        async:false,
...
function selectProject(st){
	$.ajax({
        type:'POST',
        url:serviceUrl+'pl/projectOption/projectPeriod',
        dataType:'json',
        contentType:'application/json',
...
function selectGroup(st){
	$.ajax({
        type:'POST',
        url:serviceUrl+'pl/plGroup/queryGroupByQiId',
        dataType:'json',
        contentType:'application/json',
...
function initScreeing(){
	$.ajax({
        type:'POST',
        url:serviceUrl+'pl/plScreeing/queryScreeing',
        dataType:'json',
        contentType:'application/json',
