...
function getOfficeInfoList(){
 	jQuery("#officeSeo").jqGrid({
    	url : serviceUrl + "oa/office/officeInfo/getOfficeInfopageByCurrentUser",
...
function getOperationAuthorition() {
	...
	$.ajax({
		type: 'GET',
		url: serviceUrl + 'sys/authentication/getUserAuthenticationOperation?t_='+new Date().getTime()+'&appCode=OA&menuCode=ZHCX',
		dataType: 'json',
		//contentType: 'application/json',
		async: false,
