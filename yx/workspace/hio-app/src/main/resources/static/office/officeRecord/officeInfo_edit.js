...
$('.fatherNodeSelector').click(function() {
	var dataPost = {
	 ...
	 $(this).xljSingleSelector({
        ...
        treeUrl: serviceUrl + "oa/office/officeHouse/queryTreeList"+"?time="+Math.random(),
...
//	officeHouseDto.stockHouseId=1;
	var url = serviceUrl+"oa/office/officeInfo/update/"+id;
	$.ajax({
		type: "PUT",
...
function submitForm(flag) {
	...
	//TODO
//	officeHouseDto.stockHouseId=1;
	var url = serviceUrl+"oa/office/officeInfo/save";
	$.ajax({
		type: "POST",
		contentType: "application/json",
		url: url,
