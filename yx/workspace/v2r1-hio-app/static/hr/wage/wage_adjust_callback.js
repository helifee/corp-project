                ...
                if (json.success == true) {
                    ...
                    if (undefined != itemEnable && "" != itemEnable) {
                        ...
                        for (var i = 0; i < itemEnable.length; i++) {
                            ...
                            wageAdjustVal = wageAdjustVal +
                                "<tr class=\"form-tr\"><td class=\"form-label\"><label>当前" + item.name + "</label></td><td>" +
                                "<input type=\"number\"class=\"form-control addInputWidth\" id=\"before_" + item.code + "\" name=\"before_" + item.code + "\" value=\"0\" readonly></td>" +
                                "<td class=\"form-label\"><label>调整后" + item.name + "</label></td><td>" +
                                "<input type=\"number\" class=\"form-control addInputWidth\" id=\"after_" + item.code + "\" value=\"0\" name=\"after_" + item.code + "\" readonly ></td></tr>";
                        }
                        wageAdjustVal = wageAdjustVal +
                            "<tr class=\"form-tr\">\<td class=\"form-label\"><label>调整前工资合计</label></td>" +
                            "<td><input type=\"number\"class=\"form-control addInputWidth\" id=\"before_wage_sum\" name=\"before_wage_sum\" value=\"0\" readonly></td>" +
                            "<td class=\"form-label\"><label>调整后工资合计</label></td>" +
                            "<td><input type=\"number\"class=\"form-control addInputWidth\" id=\"after_wage_sum\" name=\"after_wage_sum\" value=\"0\" readonly></td></tr>" +
                            "<tr class=\"form-tr\">\<td class=\"form-label\"><label>调整幅度(%)</label></td>" +
                            "<td><input type=\"number\"class=\"form-control addInputWidth\" id=\"adjust_rose\" name=\"adjust_rose\" value=\"0\" readonly></td>" +
                            "<td class=\"form-label\"><label><span class=\"req_f\"></span>调整生效时间</label></td>" +
                            "<td>" +
                            "<div class=\"input-group date datetimepicker2\" id=\"datetimepicker\" data-required=\"true\"  style=\"width: 94%\">" +
                            "<input id=\"adjust_take_time\" name=\"adjust_take_time\" type=\"text\" class=\"form-control\" readonly data-required=\"true\" data-placeholder=\"生效时间\">" +
                            "<div class=\"input-group-addon\">" +
                            "<a class=\"glyphicon glyphicon-remove\" onclick=\"emptyDateObject()\"></a></div>" +
                            "<span class=\"input-group-addon \">" +
                            "<span class=\"glyphicon glyphicon-calendar addLeft\"></span>" +
                            ...
                            "</tr>" +
                            "<tr class=\"form-tr\"><td class=\"form-label\"><label>调整原因</label></td>\<td colspan=\"3\">" +
                            "<input type=\"text\"class=\"form-control addInputWidth\" id=\"remark\" name=\"remark\" ></td></tr>";
                        $("#adjustTable").append(wageAdjustVal);
                    }
                    //初始化表单下方历史调整列表数据
                    var itemAll = json.result.queryShowList;
