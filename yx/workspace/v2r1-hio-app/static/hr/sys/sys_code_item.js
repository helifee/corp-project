...
//跳转新建代码项页面
function  add() {
    openPa('sys_code_item_edit.html?sysCodeSetId='+$.xljUtils.getUrlParam("sysCodeSetId")+"&sysCodeSetName="+encodeURI(sysCodeSetName,"UTF-8")+"&type=add");
}
    ...
    jQuery("#sysCodeItemList").jqGrid(
        {
            ...
            colModel: [ //jqGrid每一列的配置信息。包括名字，索引，宽度,对齐方式.....
                ...
                {name :'sid',index:'sid',label : '代码项值',editable:false,align: "center"},
            ...
            ondblClickRow:function(rowId){
                ...
                openPa('sys_code_item_edit.html?id='+rowId+'&type=update');
            },
