...
//        $(".ui-jqgrid-bdiv table").jqGrid().setGridHeight($('.mytable').height() - 60);
        $(".ui-jqgrid-bdiv table").jqGrid().setGridHeight($(window).height() - 185);
...
//        resizeHeight();
        ...
        jqGridByMonth = jQuery("#listResultByMonth").jqGrid(
            {
                ...
                rownumbers: true,
                colModel: [
                    {name: 'personId', label: "所属机构", width: 150, align: "center", frozen: true, hidden: true},
                    {name: 'orgName', label: "所属机构", width: 150, align: "center", frozen: true},
                    {name: 'postName', label: "职务", width: 150, align: "center", frozen: true},
                    {name: 'personName', label: "姓名", width: 100, align: "center", frozen: true},
                    {name: 'date', label: "月份", width: 100, align: "center",formatter: dateFormate},
                    {name: 'phone', label: "手机号", width: 150, align: "center"},
 ...
 /*   window.initDatetimepicker = function () {
    ...
    function queryWagePeriod() {
        ...
        var nowKqEndDate;
        $.ajax({
            url: baseUrl + "wage/wagePeriod/queryList",
            type: 'POST',
            dataType: 'JSON',
            contentType: 'application/json',
            async: false,
    ...
    window.getSelfKq = function (date,personId) {
        // alert(date+"    >>"+personId);
        location.href='../kq/kq_myKq.html?personId='+personId+"&date="+date+"&backflag=team";
    }
