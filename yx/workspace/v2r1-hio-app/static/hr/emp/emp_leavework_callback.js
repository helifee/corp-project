...
;(function($, window, document, undefined){
    ...
    function getInfoByAppId(applyId){
        ...
        //根据审批单Id获取人员信息
        $.ajax({
            url: baseUrl + "emp/empPersonInfo/getPersonAmdContInfo/" + personId,
            type: 'GET',
            dataType: 'JSON',
            contentType: 'application/json',
            success: function (data, textStatus) {
