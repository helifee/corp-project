...
function addBussApplyInfo(sign) {
    if (sign == 0) {
        ...
        // window.open("kq_local_city_add_local.html?type=add");
        window.location.href = "kq_local_city_add_local.html?type=add";
    } else if (sign == 3) {//我的考勤跳转
        // window.open("kq_local_city_add_local.html?type=add&myKqFlag=true");
        window.location.href = "kq_local_city_add_local.html?type=add&myKqFlag=true&myPersonId=" + myPersonId;
    }
}
...
function editBussApplyInfo(sign) {
    ...
    if (ids == "" || ids.length == 0) {
        ...
        bussApplyId = ids[0];
        // window.open("kq_local_city_add_local.html?type=update");
        window.location.href = "kq_local_city_add_local.html?type=update&bussApplyId=" + bussApplyId;
    } else if (sign == 4) {//我的考勤跳转
        bussApplyId = ids[0];
        // window.open("kq_local_city_add_local.html?type=update&myKqFlag=true");
        window.location.href = "kq_local_city_add_local.html?type=update&myKqFlag=true&bussApplyId=" + bussApplyId + "&myPersonId=" + myPersonId;
    }
}
