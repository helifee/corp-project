...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        outsideClick: function(e) {
        	this.autoUpdateInput = false; // add by panbz 默认值
            var target = $(e.target);
        ...
        clickRange: function(e) {
        	this.autoUpdateInput = true; // add by panbz 默认值
            var label = e.target.getAttribute('data-range-key');
        ...
        clickPrev: function(e) {
        	// modify by panbz 开始结束日期修改互不影响 2018-6-5
...
//            }
        ...
        hoverDate: function(e) {
            ...
            //console.log(this.startDate+"=="+this.endDate); // modify by panbz
...
//            }
            if (this.endDate && this.container.find('input[name=daterangepicker_end]').is(":focus")) {
                this.container.find('input[name=daterangepicker_end]').val(date.format(this.locale.format));
            } else if (this.startDate && this.container.find('input[name=daterangepicker_start]').is(":focus")) {
                this.container.find('input[name=daterangepicker_start]').val(date.format(this.locale.format));
            }
