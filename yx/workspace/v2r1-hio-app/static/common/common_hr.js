 ...
 *优化滑动子页面获取参数失败的问题
 */
var getJZYWindow=window.getJZYWindow=function(win){
    win=win||window;
    if(win.hasOwnProperty('JZY')){return win};
    return getJZYWindow(win.parent)
};
...
document.write('<script src="'+baseUrl+'common/HrUserUtil.js" type="text/javascript"></script>');
