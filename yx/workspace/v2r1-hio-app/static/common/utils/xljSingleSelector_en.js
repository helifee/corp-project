...
//                    	this.options.treeParam = JSON.stringify(this.options.treeParam)=='{}'?null:this.options.treeParam
        ...
        _createModalHeaderContainer: function () {
            var modalHeaderContainer = $('<div class="modal-header">'+
                ...
                '   <input type="text" class="form-control modalInput" placeholder="Query keywords" style="width: 28%;margin-left: 0;">'+
                '   <button class="btn btn-sm btnMsearch rm-pad">'+
                '       <i class="fa fa-search" aria-hidden="true"></i>'+
                '   </button>'+
                '   <button class="btn btn-sm blue pull-right save-modal-data" title="Determine/确定" style="padding: 3px 5px;">Determine</button>'+
                '</div>');
