...
(function ($) {
    ...
    function setSize(target, param) {
        ...
        /*//2017/03/07 start
        var leftBorderWidth = parseInt(panel.css('border-left').replace('px',''));
        var rightBorderWidth = parseInt(panel.css('border-right').replace('px',''));
        var leftPaddingWidth = parseInt(panel.css('padding-left').replace('px',''));
        var rightPaddingWidth = parseInt(panel.css('padding-right').replace('px',''));
        panel.width(panel.width()-leftBorderWidth-rightBorderWidth-leftPaddingWidth-rightPaddingWidth);
        //opts.width = panel.width();

        var topBorderHeight = parseInt(panel.css('border-top').replace('px',''));
        var bottomBorderHeight = parseInt(panel.css('border-bottom').replace('px',''));
        var topPaddingHeight = parseInt(panel.css('padding-top').replace('px',''));
        var bottomPaddingHeight = parseInt(panel.css('padding-bottom').replace('px',''));
        panel.css('height',panel.height()-topBorderHeight-bottomBorderHeight-topPaddingHeight-bottomPaddingHeight);
        //2017/03/07 end*/
        ...
        if (!isNaN(opts.width)) {
            if ($.boxModel == true) {
                ...
                pheader.css('width',parseInt(panel.css('width').replace('px',''))+'px');
                pbody.css('width',parseInt(panel.css('width').replace('px',''))+'px');
            }
        } else {
            panel.width('auto');
            pbody.width('auto');
        ...
        if (opts.title && !opts.noheader) {
            ...
            if (opts.tools) {
                for (var i = opts.tools.length - 1; i >= 0; i--) {
                    if( opts.tools[i].iconType && opts.tools[i].iconType=="element" ){
                        var t = $(opts.tools[i].iconCls).appendTo(tool);
                    }else{
