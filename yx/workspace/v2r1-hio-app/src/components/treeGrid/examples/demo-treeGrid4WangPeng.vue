...
例如：" type="error" :closable="false">
            ...
            <el-tab-pane name="demo" label="demo">
                <el-table border>
                    ...
                    <!--{"id":2,"orgType":2,"mainOrg":0,"checked":false,"orgCode":"","orgName":"集团G2","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs"-->
                    ...
                    <el-table-column width="40" label="expanded">
                        <template slot-scope="scope">{{scope.row.$extra.expanded?'y':'n'}}</template>
                    </el-table-column>
                    <el-table-column width="40" label="checked?">
                        <template slot-scope="scope">{{scope.row.checked?'y':'n'}}</template>
                    </el-table-column>
                ...
                <el-button @click="insertFourSiblingsTest()">给第10行增加2个兄弟</el-button>
                <el-button @click="insertTwoChildrenTest()">给第10行增加2个儿子（包含儿子所有嵌套共4条数据）</el-button>
                ...
                <el-table :data="virutalModel" border>
                    ...
                    <el-table-column label="description & path"   width="180">
                        <template slot-scope="scope">
                            ...
                            {{scope.row.description}}<br>
                            <span v-if="scope.row.$extra.path"></span>
...
<script>
    ...
    export default {
        ...
        // :enable-check="enableCheck"
                ...
                // model:
                // [],
                    // [{"id":2,"orgType":2,"mainOrg":0,"checked":false,"orgCode":"","orgName":"集团G2","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs":[{"id":3,"orgType":3,"mainOrg":1,"checked":false,"orgCode":"","orgName":"根业务单元G2-3","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs":[{"id":4,"orgType":3,"mainOrg":0,"checked":false,"orgCode":"","orgName":"初级业务单元B3-4","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs":[{"id":7,"orgType":3,"mainOrg":0,"checked":false,"orgCode":"","orgName":"二级业务单元B4-7","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs":[],"childeDeps":[],"parentBU":null,"parentDep":null}],"childeDeps":[],"parentBU":null,"parentDep":null},{"id":5,"orgType":3,"mainOrg":0,"checked":false,"orgCode":"","orgName":"初级业务单元B3-5","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs":[{"id":6,"orgType":3,"mainOrg":0,"checked":false,"orgCode":"","orgName":"二级业务单元B5-6","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs":[],"childeDeps":[],"parentBU":null,"parentDep":null}],"childeDeps":[],"parentBU":null,"parentDep":null}],"childeDeps":[],"parentBU":null,"parentDep":null}],"childeDeps":[],"parentBU":null,"parentDep":null},{"id":70,"orgType":2,"mainOrg":0,"checked":false,"orgCode":"GC17970665","orgName":"集团-3","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs":[{"id":76,"orgType":3,"mainOrg":1,"checked":false,"orgCode":"BU17970671","orgName":"根业务单元70-1","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs":[{"id":77,"orgType":3,"mainOrg":0,"checked":false,"orgCode":"BU17970672","orgName":"初级业务单元76-1","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs":[{"id":78,"orgType":3,"mainOrg":0,"checked":false,"orgCode":"BU17970673","orgName":"而级业务单元77-1","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs":[],"childeDeps":[],"parentBU":null,"parentDep":null},{"id":79,"orgType":3,"mainOrg":0,"checked":false,"orgCode":"BU17970674","orgName":"二级业务单元77-2","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs":[{"id":80,"orgType":3,"mainOrg":0,"checked":false,"orgCode":"BU17970675","orgName":"三级业务单元79-1","orgShortName":null,"brotherOrgs":[],"brotherDeps":[],"childeBUs":[],"childeDeps":[],"parentBU":null,"parentDep":null}],"childeDeps":[],"parentBU":null,"parentDep":null}],"childeDeps":[],"parentBU":null,"parentDep":null}],"childeDeps":[],"parentBU":null,"parentDep":null}],"childeDeps":[],"parentBU":null,"parentDep":null}],
                    // [
                //     {
                //     "id": 1,
                //     "label": "System",
        ...
        methods:{
            reRenderTreeByCheckedNodes(){
                let allCheckedNodes=this.$refs.treeGrid.getCheckedNodes(true)

                this.$refs.treeGrid.refreshTreeTable(allCheckedNodes,false)
            },
            refreshDataTest(){
                ...
                this.$refs.treeGrid.refreshTreeTable(
                    [{"permissionId":1,"resourceName":"业务系统管理","resourceDesc":null,"belong":100,"parentId":-1,"permissionShow":null,"permissionGroup":null,"url":"","tag":"1.0","subject":"PC","type":"菜单","status":null,"childFuncs":[{"permissionId":4,"resourceName":"组织管理","resourceDesc":null,"belong":100,"parentId":1,"permissionShow":null,"permissionGroup":null,"url":"","tag":"4.0","subject":"PC","type":"菜单","status":null,"childFuncs":[{"permissionId":9,"resourceName":"组织结构定义","resourceDesc":null,"belong":100,"parentId":4,"permissionShow":null,"permissionGroup":null,"url":"","tag":"9.0","subject":"PC","type":"菜单","status":null,"childFuncs":[],"checked":false,"$extra":{"deepth":3,"hasChildren":false,"childsNum":0,"parentId":4,"indeterminate":false,"path":"业务系统管理->组织管理->组织结构定义"}},{"permissionId":10,"resourceName":"管理员管理","resourceDesc":null,"belong":100,"parentId":4,"permissionShow":null,"permissionGroup":null,"url":"","tag":"10.0","subject":"PC","type":"菜单","status":null,"childFuncs":[{"permissionId":18,"resourceName":"管理员管理","resourceDesc":null,"belong":100,"parentId":10,"permissionShow":null,"permissionGroup":null,"url":"","tag":"18.0","subject":"PC","type":"菜单","status":null,"childFuncs":[{"permissionId":73,"resourceName":"删除","resourceDesc":null,"belong":100,"parentId":18,"permissionShow":null,"permissionGroup":null,"url":"","tag":"73.0","subject":"PC","type":"按钮","status":null,"childFuncs":[],"checked":false,"$extra":{"deepth":5,"hasChildren":false,"childsNum":0,"parentId":18,"indeterminate":false,"path":"业务系统管理->组织管理->管理员管理->管理员管理->删除"}}],"checked":false,"$extra":{"deepth":4,"hasChildren":true,"childsNum":1,"parentId":10,"indeterminate":false,"path":"业务系统管理->组织管理->管理员管理->管理员管理"}}],"checked":false,"$extra":{"deepth":3,"hasChildren":true,"childsNum":1,"parentId":4,"indeterminate":false,"path":"业务系统管理->组织管理->管理员管理"}}],"checked":false,"$extra":{"deepth":2,"hasChildren":true,"childsNum":2,"parentId":1,"indeterminate":false,"path":"业务系统管理->组织管理"}}],"checked":false,"$extra":{"deepth":1,"hasChildren":true,"childsNum":1,"parentId":null,"indeterminate":false,"path":"业务系统管理"}}]
                )
