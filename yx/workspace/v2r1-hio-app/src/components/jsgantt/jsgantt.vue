<template>
    <div>
        ...
        <link href="/static/jsgantt/jsgan">
        <div id="embedded-Gantt" style="position:relative" class="gantt" ref="GanttChartDIV"></div>
        <iframe style="    width: 100%;
    height: calc(100%);
    border: none;" src="/static/jsgantt/index.html"></iframe>
    </div>

</template>
<style>
    /*@import "./bootstrap.min.css";*/
    /*@import "../../../static/jsgantt/jsgantt.css";*/
  /*.gfoldercollapse{*/
      /*display:none;*/
  /*}*/
</style>
<script>
    // import './bootstrap.min.css'
    import '../../../static/jsgantt/jsgantt.css'
    import setLan from './jsgantt.locale'
    // import './jsgantt'
    ...
    export default {
        ...
        async mounted() {
            ...
            let res=await Promise.all([JZY.s.getScript('/static/jsgantt/jsgantt.js'),JZY.locale.getCurrentLanguage()])
            ...
            // console.log('kcuf_u gantt res--:',res)
            // var g = new JSGantt.GanttChart(this.$refs.GanttChartDIV, 'day');
            // // setLan(g,res[1])
            // g.setCaptionType('Complete');  // Set to Show Caption (None,Caption,Resource,Duration,Complete)
            // g.setQuarterColWidth(36);
            // g.setDateTaskDisplayFormat('day dd month yyyy'); // Shown in tool tip box
            ...
            // g.setFormatArr('Day', 'Week', 'Month', 'Quarter'); // Even with setUseSingleCell using Hour format on such a large chart can cause issues in some browsers
            // // Parameters                     (pID, pName,                  pStart,       pEnd,        pStyle,         pLink (unused)  pMile, pRes,       pComp, pGroup, pParent, pOpen, pDepend, pCaption, pNotes, pGantt)
            // // g.AddTaskItem(new JSGantt.TaskItem(1,   'Define Chart API',     '2018-04-24',           '2018-05-24',          'gtaskblue',  '',                 0, 'Brian',    0,     1,      0,       1,     '',      '',      '', g ));
            // // g.AddTaskItem(new JSGantt.TaskItem(2,   'Create HTML Shell',    '2018-03-24','2018-03-28', 'gtaskblue',  '',                 0, 'Brian',    20,    1,      0,       1,     '',     '',      '',      g));
            //
            // // g.AddTaskItem(new JSGantt.TaskItem(1, 'Constructor Proc',     '2017-02-21','2017-03-09', 'gtaskblue',    '',                 0, 'Brian T.', 60,    0,      0,      1,     '',      '',      '',      g));
            // // g.AddTaskItem(new JSGantt.TaskItem(2, 'Constructor Proc',     '2018-02-21','2018-09-09', 'gtaskblue',    '',                 0, 'Brian T.', 10,    0,      0,      1,     '',      '',      '',      g));
            //
            //
            // // g.AddTaskItem(new JSGantt.TaskItem(1,   'Define Chart API',     '',           '',          'ggroupblack',  '',                 0, 'Brian',    0,     1,      0,       1,     '',      '',      'Some Notes text', g ));
            // // g.AddTaskItem(new JSGantt.TaskItem(11,  'Chart Object',         '2018-02-20','2018-09-20', 'gmilestone',   '',                 1, 'Shlomy',   10,   0,      1,       1,     '',      '',      '',      g));
            //
            //
            //
            // g.AddTaskItem(new JSGantt.TaskItem(1,   'Define Chart API',     '',           '',          'ggroupblack',  '',                 0, 'Brian',    0,     1,      0,       1,     '',      '',      'Some Notes text', g ));
            ...
            // let taskNameTd=this.$refs.GanttChartDIV.querySelectorAll('.gantt td.gtaskname')[1]
            // taskNameTd.style.fontWeight='bold'
            // taskNameTd.style.textAlign='center'
