<template>
    <div class="history-box">
        <div class="his-con">
            <my_scroller v-on:getList="getPlanList" ref="myScroll" :pageNum="pageNum" :pageTotal="pageTotal" scrollPage="cus_plan" :decision="decisionList" :isContinue="isContinue" :list="list"></my_scroller>
        </div>
    </div>
</template>
<script>
