<template>
    <div class="wrap">
                    ...
                    <li>
                        ...
                        <el-dropdown  @command="handleCommand" size="small">
                            ...
                            <el-dropdown-menu slot="dropdown">
                                ...
                                <el-dropdown-item command="comp" v-if="+operation.projectFinish">完成</el-dropdown-item>
                                <el-dropdown-item command="compCancel" v-if="+operation.projectCancelFinish">取消完成</el-dropdown-item>
                                <el-dropdown-item command="revoke" v-if="+operation.projectActivation">激活</el-dropdown-item>
                                <el-dropdown-item command="back" v-else-if="+operation.projectRevoke">撤销</el-dropdown-item>
                                <el-dropdown-item command="follow" v-if="!+operation.follow&&fromPage!='set'">关注</el-dropdown-item>
                                <el-dropdown-item command="cancelFollow" v-if="+operation.follow&&fromPage!='set'">取消关注</el-dropdown-item>
                                <el-dropdown-item command="del" v-if="+operation.projectDelete">删除</el-dropdown-item>
                            </el-dropdown-menu>
                        </el-dropdown>
                    </li>
        ...
        <div class="project-detail" v-if="projectDetail.projectName">
            <el-tabs v-model="activeName" @tab-click="tabClick">
                ...
                <el-tab-pane v-if="+projectDetail.projectNetDisk" :label='"云盘"+number.netDisk' name="file" >
                ...
                <!--<el-tab-pane label="日程（26）" name="schedule">-->
...
//                    this.$refs.approvalPanel.refleshApprove();
            ...
            goback(){
                ...
                switch (fromPage) {
                    ...
                    case 'create':
                        JZY.router.push('/project')
                    case 'responsible':
                        JZY.router.push('/project/responsible')
                    case 'participate':
                        JZY.router.push('/project/participate')
                    case 'follow':
                        JZY.router.push('/project/follow')
                    case 'shared':
                        JZY.router.push('/project/shared')
                    case 'set':
                        JZY.router.push('/project/set')
                    default:
                        JZY.router.push('/project')
...
//                console.log(res);
        ...
        data(){
            return JZY.s.keepAliveDataCache[JZY.s.getPathName()]||{
                fromPage:'',
                id:'',
                number:{
                    dynamic:'',
...
//                    项目状态：0进行中、1已延期、2未启动、3已完成、4已撤销。5 回滚
                ...
                dynamicData:[{
                    type:1,
                    name:'杨帆',
                    action:'修改任务(项目启动会)状态为完成',
                    time:'2018-01-21 13：23：12'
                },{
                    type:2,
                    name:'杨帆',
                    action:'修改任务(项目启动会)状态为完成',
                ...
                operation:{
                    ...
                    projectCancelFinish:"0",//项目取消完成（有权限true）
        ...
        beforeDestroy(){
          JZY.s.keepAliveDataCache[JZY.s.routerFrom.path]=JZY.u.copy(this._data)
        },
        mounted(){
            JZY.DEBUG_MODE && (window.PROJECT_DETAIL=this)
