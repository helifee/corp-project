<template>
    <div class="wrap" v-loading="loading">
        ...
        <div class="plan-content"  v-show="hasData" >
            <div class="plan-list">
                <ul>
                    <li @click="handleClick(item.sid)" v-for="(item,index) in shareList">
                        <p>{{item.planTitle}}</p>
...
<script>
    ...
    import {postPlanShareList,getPlan} from '@Main/plan/getData.js'
...
//                console.log(this.finalData,"finalDatafinalDatafinalData")
                ...
                this.rqPlanShareListFilter(this.pageNum);
...
//                let isCur = !this.filterData[index].isCur;
                if(this.filterData.length>0){
                    ...
                    console.log(this.userIdList,"this.userIdListthis.userIdList")
                    this.pageNum = 1;
                    this.isLoadData = true;
...
//                this.planType = -1;
                ...
                this.pageNum = 1;
                this.isAll = true;
                this.initPlanShareList(this.pageNum);
            },
            async rqPlanShareListFilter(pageNum){
                let res = await postPlanShareList(this.planType,this.userIdList,pageNum,20);
...
//                console.log(JSON.stringify(res));
            ...
            async initPlanShareList(pageNum){
                let res = await postPlanShareList(this.planType,this.userIdList,pageNum,20);
...
//                console.log(JSON.stringify(res[0]));
            ...
            async initPlanShareList1(pageNum){
                let res = await postPlanShareList(this.planType,this.userIdList,pageNum,20);
                this.shareList = [];
                this.loading = false;
                this.loadLock = true;
...
//            console.log(this.detailData.planType,"this.detailData.planType");
...
//                    console.log(that.loadLock&&!that.loadMore,that.loadLock,!that.loadMore,"that.loadLock&&!that.loadMore")
