<template>
    ...
    <div>
        ...
        <el-button @click="JZY.locale.switchLanguage('zh')">switch to chinese</el-button>
...
<script>
    ...
    import demoLocale from './demo.locale.js'
    locale.add('demo',demoLocale)
        ...
        mounted(){
            jQuery(function() {
                ...
                uploader = WebUploader.create({
                    ...
                    server: JZY.c.uploadPath,
                    // server: 'http://dubaixing.net:7777/uploads',
                    fileNumLimit: 300,
