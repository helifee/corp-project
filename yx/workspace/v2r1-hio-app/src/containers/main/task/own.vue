...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            //获取我关注的任务列表
            async getTaskListData( {type = '1' ,projectId = '' ,taskName = '' ,taskStatus = '' ,pageNum = '1' ,pageCount=10 ,orderby = [] } = {} ){
                let res = await getTaskList( type ,projectId ,taskName ,taskStatus ,pageNum ,pageCount ,orderby  ,'own')
