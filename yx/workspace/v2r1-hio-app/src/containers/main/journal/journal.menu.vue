<template>
    <el-menu :router="true" :default-active="defaultActive" :default-openeds="openeds"  @open="handleOpen" @close="handleClose">
        <el-menu-item index="/journal/mine">
            <i class="el-icon-menu"></i>
            <span slot="title">我的日志</span>
        </el-menu-item>
        <el-menu-item index="/journal/share">
            <i class="el-icon-news"></i>
            <span slot="title">共享我的</span>
        </el-menu-item>
        <el-menu-item index="/journal/comment">
    ...
    export default {
        ...
        methods: {
            handleOpen(key, keyPath) {
                ...
                this.$router.push({ name: 'journal/mine'})
                this.$router.go(1);
            },
