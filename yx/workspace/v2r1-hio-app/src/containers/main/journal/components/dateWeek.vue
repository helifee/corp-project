<template>
    <div>
        ...
        <div class="date-option">
            <div class="filter">
                    <el-button type="primary">{{l('{journalLocale.dateWeek.all}')}}</el-button>
                    <span  style="color: #00a0e9;cursor: pointer" @click="showUserTree = !showUserTree">筛选查看</span>
                    <el-tag
                    ...
                    <ul style="margin-top: 30px">
                        <li >
                            ...
                            <div class="filter-content" @click="showDetailDialog">
                                <p class="member">杨帆</p>
                                <div>今日工作内容已经完成，原型设计</div>
                                <p class="time">2018-01-04 09：52：30</p>
                            </div>
                        </li>
                        <li @click="showDetailDialog">
                            <div class="avatar">头像</div>
        ...
        <dialog-detail :dialog-visible="detailDialogVisible"  @closeCreateModal="closeDetailDialog"></dialog-detail>
    </div>
</template>
