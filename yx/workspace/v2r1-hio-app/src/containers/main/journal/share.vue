<template>
    <div class="share">
        <h3>共享我的</h3>
        <div class="share-content" v-loading="!sysTime">
            <date-week-demo :sysTime="sysTime" @curdate="getCurdate" v-loading="isLoadData" v-if="sysTime">

                <div slot="detail" class="date-option">

                    <div v-if="hasData">
                        <el-button  size="small"  :class="{allBtn:true,isAll:isAll}" @click="allShare">{{l('{journalLocale.dateWeek.all}')}}</el-button>
                        ...
                        <!--<el-button @click="filterTreeChange">筛选查看</el-button>-->
                        ...
                        <ul style="margin-top: 30px" class="filter">
                            <li v-for="(item,index) in listData" @click="showDetailDialog(item.sid)">
                                ...
                                <div class="filter-content">
                                    <p class="member">{{item.createPersonName}}</p>
...
<script>
    ...
    import {postJournalShareList,postJournalCondition} from '@Main/journal/getData.js'
    export default{
        components:{
            dateWeekDemo,
            dialogDetail
        ...
        methods:{
            ...
            filterTreeChange(){
                ...
                this.filterDataUrl = {
                    ...
                    type:'get',
                    url:'/journal/share/filter/'+this.curDate
                }
...
//                let queryData={};
//                queryData.type="share";
//                queryData.journalDate=val;
                this.isAll = true;
                this.curDate = val;
                this.isLoadData = true;
                this.filterData = [];
...
//                this.filterData = [...arr];
//                this.formGroupData.userList = [...arr];
//                this.finalData = [...arr];
//                this.pageNum = "1";
//                this.userIdList = [];
//                if(this.formGroupData.userList.length>0){
...
//                this.filterDataUrl.url = '/journal/share/filter/'+this.curDate;
            },
            allShare(){
                this.filterData = [];
                this.formGroupData.userList=[];
            ...
            async rqJournalListFilter(pageNum,userIdList){
                ...
                let res = await postJournalShareList(queryData);
...
//                    this.hasData = false;
        ...
        mounted (){
            ...
            $(".share").scroll(function(){
                //下面这句主要是获取网页的总高度，
                var htmlHeight=$(".share")[0].scrollHeight;
                //clientHeight是网页在浏览器中的可视高度，
                var clientHeight=document.body.clientHeight||document.documentElement.clientHeight;
                //scrollTop是浏览器滚动条的top位置，
                var scrollTop=$(".share").scrollTop();
                var scrollTop2=$(".share").scrollTop()+clientHeight-66;
        ...
        .share-content{
            ...
            .date-option{
                ...
                .filter{
                    li{
                        position: relative;
                        border-top: 1px solid $theme-grey-input-border;
                        padding: 16px;
                        cursor: pointer;
                        .avatar{
                            width: 40px;
