...
<div>
    <right-slide-modal
        ...
        <div class="distribution">
            ...
            <el-form :model="form">
                <el-form-item label="客户范围" class="customerScopr">
                    <el-select v-model="form.value" disabled placeholder="">
                ...
                <el-form-item label="分配用户">
                    ...
                    <blend-tree
                        ...
                        <!--添加按钮图标的插槽-->
                        <div slot="add_button">
                        <i class="el-icon-circle-plus" @click.stop = "$refs.userTree.blendTreeDialogShow()"></i>
                        </div>
                    </blend-tree>
                ...
                <el-form-item label="分配方式">
                    <p style="display：inline-block; margin-top:0px; font-family: MicrosoftYaHei; font-size: 12px; color: #A0A0A0; letter-spacing: 0;">系统将会把您选中的客户数据，平均分配给您所选择的用户。</p>
                </el-form-item>
            </el-form>
            ...
            operateSubmit(){
                ...
                if(saleIds.length==0){
                    ...
                    if(this.form.value=="0"){
                        obj={
                            'custRangeType':this.form.value,
                            'customerSearch':this.queryData,
                            'custIds':[],
                            'saleIds':saleIds
                        }
                    }else if(this.form.value=="1"){
                        obj={
                            'custRangeType':this.form.value,
                            'customerSearch':{},
...
<style rel="stylesheet/scss" lang="scss">
    .distribution{
        line-height: 48px;
        .customerScopr .el-form-item__label::after{
            content: '*';
            color:red;
        }
