    ...
    <right-slide-modal
        ...
        <div class="record">
            <div class="record-left">
                ...
                <el-form :inline="true" :customerId="form.customerId" ref="form" :model="form" :rules="rules" class="demo-form-inline">
                    <el-form-item label="联系人:" prop="contactId">
                        <el-select :disabled="this.conDisa ?true:false"  v-model="form.contactId" placeholder="联系人">
            ...
            <div class="record-right" >
                ...
                <timeline class="scrollContentOpp" style="max-height:400px; overflow-y:scroll;">
    ...
    export default{
        ...
        methods:{
            ...
            async contactsAllData( {
                ...
                res[0].forEach((item)=>{
                    if(item.sid==this.form.conId){
                        this.conDisa=true;
                        this.form.contactId=this.form.conId;
                    }
                })
...
//            关闭
        ...
        mounted (){
            this.form.conId=this.contactId || this.$route.query.contact;
        },
        created(){
