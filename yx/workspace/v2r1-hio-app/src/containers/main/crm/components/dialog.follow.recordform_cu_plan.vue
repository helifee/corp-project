    ...
    <right-slide-modal
        ...
        <div class="record">
            <div class="record-left">
                ...
                <el-row :gutter="24">
                    <el-col :span="4">
                        <span class="grid-content">跟进目标:</span>
                    </el-col>
                    <el-col :span="8">
                        <span class="grid-content" style="color:red;">{{this.target || '&nbsp;'}}</span>
                    </el-col>
                </el-row>
                <hr>
                <div class="tableCu">
                <h2 style="font-size:14px; padding-left:20px; line-height:40px; background:#dedede; font-weight:normal">跟进记录</h2>
                <el-form :inline="true" :sid="form0.sid" :planId="form0.planId" :customerId="form0.customerId" ref="form0" :model="form0" :rules="rules" class="demo-form-inline">
                    
                    <el-form-item label="联系人:" prop="recoId">
                        <el-select :disabled="this.conDisa ?true:false"   v-model="form0.recoId" placeholder="联系人">
                    ...
                    <el-form-item class="opp" label="商机:">
                        <el-select :disabled="this.disa ?true:false" v-model="form0.recoOp" placeholder="商机">
                    ...
                    <br>
                     <el-form-item class="folCon" label="跟进内容"  prop="recoCon">
                        <el-input class="" v-textarea-limiter type="textarea" :maxlength="2500"  v-model="form0.recoCon" placeholder="跟进内容" style="width:100%"></el-input>
                    </el-form-item>
                    <br>
                ...
                <el-form :inline="true" :customerId="form.customerId" ref="form" :model="form" :rules="rules" class="demo-form-inline">
                    <el-form-item label="联系人:" prop="contactId">
                        <el-select :disabled="this.conDisa ?true:false" class="contact"  v-model="form.contactId" placeholder="联系人">
                            <el-option :key="index" v-for="(item,index) in this.tableData5"  :label="item.name" :value="item.sid"></el-option>
                        </el-select>
                    </el-form-item>
                    ...
                    <el-form-item class="opp" label="商机:" prop="opportunityId">
                        <el-select :disabled="this.disa ?true:false"  v-model="form.opportunityId" placeholder="商机">
                            <el-option :key="index" v-for="(item,index) in this.opportunityList" :label="item.name" :value="item.sid"></el-option>
                            <!-- <el-option label="区域二" value="beijing"></el-option> -->
                        </el-select>
                    </el-form-item>
            ...
            <div class="record-right">
                ...
                <timeline class="scrollContent4" style="max-height:750px; overflow-y:auto;">
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            setScroll(){
                ...
                // 　　    my.pageNum ++;
                       if(my.pageCount>my.dataTotal){
                        ...
                        let customerId=my.$route.query.customerId || my.$route.query.customer || my.recordformId;

                        let opportunityId=my.$route.params.id;
                        if(opportunityId !==undefined){
                            opportunityId=my.$route.params.id;
                        }else{
                            opportunityId="";
                        }
                        ...
                        if(contactId !==undefined){
                            contactId=my.$route.query.contactId;
                        }else{
                            contactId='';
                        }
                        let planId='';
            ...
            test(data,conId,opportunityId,planId,target){
                this.recordformId=data;
                this.conId=conId;
                this.opportunityId=opportunityId;
                if(this.opportunityId==-1 || this.opportunityId=="" || this.opportunityId==null){
                    this.disa=false;
                    this.form0.recoOp='';
                ...
                // let planId='';
                let contactIdNum=this.$route.query.contactId;
                if(contactIdNum !==undefined){
                    contactIdNum=this.$route.query.contactId;
                }else{
                    contactIdNum="";
                }

                let opportunityIdNum=this.$route.params.id;
                if(opportunityIdNum !==undefined){
                    opportunityIdNum=this.$route.params.id;
                }else{
                    opportunityIdNum="";
                }
                ...
                if(this.showList==false){
                   this.$refs[form0].validate((valid) => {
                       if (valid) {
                        ...
                        let planId=this.$refs[form0].$options.propsData.model.planId;                        
