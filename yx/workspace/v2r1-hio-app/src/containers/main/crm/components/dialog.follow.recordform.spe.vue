    ...
    <right-slide-modal
        ...
        <div class="record">
            <div class="record-left">
                ...
                <el-form :inline="true" :customerId="form.customerId" ref="form" :model="form" :rules="rules" class="demo-form-inline">
                    <el-form-item label="联系人:" prop="contactId">
                        <el-select :disabled="form.contactId ?true:false" v-model="form.contactId" placeholder="联系人">
            ...
            <div class="record-right" >
                ...
                <timeline class="scrollContentSpe" style="max-height:400px; overflow-y:scroll;">
