            ...
            <div class="record-left">
                ...
                <el-form :inline="true" :sid="form0.sid" :customerId="form0.customerId" ref="form0" :model="form0" :rules="rules" class="demo-form-inline">
                    <el-form-item label="联系人:" prop="recoId">
                        <el-select  v-model="form0.recoId" placeholder="联系人">
                    ...
                    <el-form-item class="opp" label="商机:">
                        <el-select disabled v-model="form0.recoOp" placeholder="商机">
                ...
                <el-form :inline="true" :customerId="form.customerId" ref="form" :model="form" :rules="rules" class="demo-form-inline">
                    <el-form-item label="联系人:" prop="contactId">
                        <el-select  class="contact"  v-model="form.contactId" placeholder="联系人">
                            <el-option :key="index" v-for="(item,index) in this.tableData5"  :label="item.name" :value="item.sid"></el-option>
                        </el-select>
                    </el-form-item>
                    ...
                    <el-form-item class="opp" label="商机:" prop="opportunityId">
                        <el-select disabled v-model="form.opportunityId" placeholder="商机">
                            <el-option :key="index" v-for="(item,index) in this.opportunityList" :label="item.name" :value="item.sid"></el-option>
                            <!-- <el-option label="区域二" value="beijing"></el-option> -->
                        </el-select>
                    </el-form-item>
    ...
    export default{
        ...
        methods:{
            ...
            changeDialogVisible(){
                this.orderDetail = {
                    customerName: {
                            ...
                            sid:this.recordformId || this.$route.query.customer
                        }
                };
            ...
            async followPlanAddData( obj1, obj2 ){
                ...
                // 保存数据
                let customerId=this.$route.query.customerId || this.recordformId || this.$route.query.customer;
                let contactId=this.$route.query.contactId || this.conId;
                let opportunityId=this.$route.query.opportunityId || this.opportunityId || this.$route.params.id;
                let planId='';
                let pageNum=this.pageNum;
                let pageCount=this.pageCount;
                this.customerFollowRecordData({
...
//            关闭
        ...
        mounted (){
            this.conId=this.$route.query.contact || this.contactId;
            // this.form0.recoId=this.contactId;
