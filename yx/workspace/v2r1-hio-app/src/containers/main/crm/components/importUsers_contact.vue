<template>
    <div>
    <!--右侧弹窗导入用户-->
        <right-slide-modal title="导入联系人" :visible.sync="propsDialogVisible" :showClose="false">
                    ...
                    <div class="uploadExcel">
                        <el-upload
                            ...
                            <div slot="tip" class="el-upload__tip">
                                <a  :href="JZY.xhr.transformUrl('/crm/contact/download/template?'+'access_token='+accessToken,'GLOBAL.XU_SHENG_DONG',false)" class="templeUpdoad">下载excel模板</a>
                ...
                <div v-else-if="active==1" class="activeShowTable">
                     <div class="syyl">
                         ...
                         <el-table :data="tableData" :show-header="true">
                             ...
                             <el-table-column label="客户名称" prop="custName" width="120px"></el-table-column>
                             <el-table-column label="联系人姓名" prop="contactName" width="100px"></el-table-column>
                             <el-table-column label="职务" prop="title" width="80px"></el-table-column>
                             <el-table-column label="手机号码" prop="contactPhone" width="150px"></el-table-column>
                            
                             <el-table-column label="电子邮件" prop="contactEmail" width="150px"></el-table-column>
                             <el-table-column label="决策关系" prop="decisionRoleName" width="80px"></el-table-column>
                         </el-table>
                     </div>
                     <div v-if="loadShow" style="position: absolute; top: 50%; left:50%; -webkit-transform: translateX(-50%) translateY(-50%); -webkit-transform: translateX(-50%) translateY(-50%); -moz-transform: translateX(-50%) translateY(-50%); -ms-transform: translateX(-50%) translateY(-50%); transform: translateX(-50%) translateY(-50%);"><img src="../images/load.gif"></div>
                </div>
        ...
        methods:{
            ...
            nextFun(){
                if(this.active==0){
                    ...
                    this.commitImportUserData(pas,'/crm/contact/saveImportData')
            ...
            handleFileChange(file, fileList) {
                ...
                let url= JZY.xhr.transformUrl('/crm/contact/excel/preview','GLOBAL.XU_SHENG_DONG',false);
                JZY.xhr.request({
                    type:'POST',
                    url:url,
            ...
            async commitDownloadFailExcel(){
                ...
                //通过造一个隐藏的form表单方式实现
                let url= JZY.xhr.transformUrl('/crm/contact/download/errorData','GLOBAL.XU_SHENG_DONG',false);
