       ...
       <div class="project-wrap planSearch">
        ...
        <div class="project-search">
            ...
            <el-form :inline="true" :model="searchForm" :rules="searchRules" ref="searchForm">
                <el-form-item label="联系人：" class="btnItem" prop="name" v-if="contactShow">
        ...
        <dialog-follow-recordform-customer :title1="recordformTitle" :dialogVisible="recordformDialogVisible" :recordId="recordId" v-if="recordformDialogVisible" @closeCreateModal="showRecordformDialog"></dialog-follow-recordform-customer>
...
<script>
    ...
    import dialogFollowRecordformCustomer from '@Main/crm/components/dialog.follow.recordform.customer.vue'
    ...
    export default{
        components:{
            // tableCrm,
            dialogFollowRecordformCustomer,
