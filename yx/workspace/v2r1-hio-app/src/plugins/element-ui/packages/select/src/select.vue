...
<script type="text/babel">
  ...
  import ElTag from '@/plugins/element-ui/packages/tag';
  import ElScrollbar from '@/plugins/element-ui/packages/scrollbar';
  import debounce from 'throttle-debounce/debounce';
  import Clickoutside from '@/plugins/element-ui/src/utils/clickoutside';
  import { addClass, removeClass, hasClass } from '@/plugins/element-ui/src/utils/dom';
  import { addResizeListener, removeResizeListener } from '@/plugins/element-ui/src/utils/resize-event';
  import { t } from '@/plugins/element-ui/src/locale';
  import scrollIntoView from '@/plugins/element-ui/src/utils/scroll-into-view';
  import { getValueByPath } from '@/plugins/element-ui/src/utils/util';
