<template>
  <transition v-if="jzyProps!=null" name="el-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      ...
      <div class="el-picker-panel__body-wrapper">
        ...
        <div class="el-picker-panel__body">
          ...
          <div class="el-picker-panel__content">
            <date-table
                :highlight-days="jzyProps.highlightDays"
              v-show="currentView === 'date'"
              @pick="handleDatePick"
...
<script type="text/babel">
  ...
  import ElButton from '@/plugins/element-ui/packages/button';
  ...
  // console.log('formatDateeeeeeeeee---:',formatDate(new Date()))

  export default {

      // beforeMount(){
      //
      //     console.log('vmmmmmm------:',this)
      //     debugger;
      //
      // },
      mounted(){
    ...
    methods: {
      ...
      prevMonth() {
        ...
        console.info("前一个月："+this.date)
        this.showDateItems(this.date)
      },

      nextMonth() {
        this.date = nextMonth(this.date);
        console.info("后一个月"+this.date)
        this.showDateItems(this.date)
      },
      ...
      handleMonthPick(month) {
        ...
        console.info("选择月之后的时间："+this.date)
        this.showDateItems(this.date)
      },
