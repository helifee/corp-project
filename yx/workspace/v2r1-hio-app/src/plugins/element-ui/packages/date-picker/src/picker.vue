<template>
  <el-input
    class="el-date-editor jzy-colorful-datepicker-input"
...
<style>
    .el-date-editor.jzy-colorful-datepicker-input{
        width: 288px;
        margin-left:16px;
    }
    .jzy-colorful-datepicker-input .el-input__inner{
        display: none;
    }
</style>
<script>
...
import Focus from '@/plugins/element-ui/src/mixins/focus';
import ElInput from '@/plugins/element-ui/packages/input';
import merge from '@/plugins/element-ui/src/utils/merge';
...
export default {
    mounted(){
      // console.log("this.highlightDays---:",this.highlightDays)
  ...
  watch: {
      'highlightDays':{
          handler:function(newVal,oldVal){
            ...
            if (this.hasOwnProperty('picker')) {
              this.picker.jzyProps.highlightDays=newVal
            }
              // this.picker.jzyProps={
  ...
  methods: {
    ...
    mountPicker() {
        ...
        // console.log('this.this.panel--:', this.panel,this.panel.prototype,this.panel.prototype.$mount)
      ...
      this.picker = new Vue(this.panel).$mount();
        ...
        // console.log('this.pickerrrrrrr---:',this.picker)
      ...
      this.picker.$on('pick', (date = '', visible = false) => {
          ...
          this.$emit('pick',date,this.highlightDays.find((item)=>{
