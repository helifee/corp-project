...
Ext.namespace('com.ysys.www.pjpginfo');

/**
 * 查询表单
 * @class com.ysys.www.pjpginfo.queryformpanel
 * @extends Ext.form.FormPanel
 */
com.ysys.www.pjpginfo.queryformpanel = Ext.extend(Ext.form.FormPanel,{
	initComponent:function() {
		...
		com.ysys.www.pjpginfo.queryformpanel.superclass.initComponent.call(this);
	}
});

/**
 * 查询窗口
 * @class com.ysys.www.pjpginfo.querywin
 * @extends Ext.Window
 */
com.ysys.www.pjpginfo.querywin = Ext.extend(Ext.Window,{
	initComponent:function() {
		Ext.apply(this,{
	        title:'高级查询',
	        width:455,
		...
		com.ysys.www.pjpginfo.querywin.superclass.initComponent.call(this);
	}
});

/**
 * 内容表单
 * @class com.ysys.www.pjpginfo.dtlformpanel
 * @extends Ext.form.FormPanel
 */
com.ysys.www.pjpginfo.dtlformpanel = Ext.extend(Ext.form.FormPanel,{
	initComponent:function() {
		Ext.apply(this,{
	        labelWidth:100,
	        labelAlign:'right',
...
//	        bodyStyle:'padding:10px',
			...
			items:[{
	        		...
	        		,{xtype:'hidden',fieldLabel:'userid',name:'userid',width:288}
	    ...
	    com.ysys.www.pjpginfo.dtlformpanel .superclass.initComponent.call(this);
	}
...
/**
 * 表单窗口
 * @class com.ysys.www.pjpginfo.dtlwin
 * @extends Ext.Window
 */		
com.ysys.www.pjpginfo.dtlwin =  Ext.extend(Ext.Window,{
	initComponent:function() {
		Ext.apply(this,{
	        width:535,
	        height:400,
		...
		com.ysys.www.pjpginfo.dtlwin.superclass.initComponent.call(this);
	}
});
...
/**
 * 主表格入口
 * @class com.ysys.www.pjpginfo
 * @extends Ext.grid.GridPanel
 */
com.ysys.www.pjpginfoGrid = Ext.extend(Ext.grid.GridPanel,{
    initComponent:function() {
    	this.pageSize=10;
    	this.ds = new Ext.data.Store({
	        url:'../Pjpginfo/extlist.do',
	        reader:new Ext.data.JsonReader({
	            root:'list',
	            totalProperty:'totalSize',
	            id:'id'
		        }
		        ,['userid','projectid','intimestp','uptimestp','cancelflag',]
	        ),
	        baseParams:{
	            limit:this.pageSize
	        },
		...
		Ext.apply(this,{
	        ...
	        , tbar:[
	        	{text:'新增',cls:'x-btn-text-icon',iconCls:'addicon',handler:this.addPjpginfo,scope:this},'-'
	        	,{text:'修改',cls:'x-btn-text-icon',iconCls:'editicon',handler:this.editPjpginfo,scope:this},'-'
	        	,{text:'删除',cls:'x-btn-text-icon',iconCls:'deleteicon',handler:this.deletePjpginfo,scope:this},'-'
	            ...
	            store:new Ext.data.ArrayStore({
        			fields: ['name','code'],
        			data: [['intimestp', 'intimestp'],['uptimestp', 'uptimestp'],['cancelflag', 'cancelflag']]
        		}),
	            displayField:'name',
	            valueField:'code',
		...
		//调用父类构建函数
        com.ysys.www.pjpginfoGrid.superclass.initComponent.call(this);
        //加载数据
        this.store.load({params:{start:0}});
        
 		//扩展类的详细弹出窗口
 		this.dtlformpanel = new com.ysys.www.pjpginfo.dtlformpanel();
 		this.dtlwin =  new com.ysys.www.pjpginfo.dtlwin({items:this.dtlformpanel,buttons:[{
	            text:'保存',
	            handler:this.savePjpginfo,
	            scope:this
	        },{
	            text:'取消',
	    ...
	    //扩展类的查询弹出窗口
	    this.queryformpanel = new com.ysys.www.pjpginfo.queryformpanel();
	    this.querywin =  new com.ysys.www.pjpginfo.querywin({items:this.queryformpanel,buttons:[{
	            text:'确定',
    ...
    */
    ...
    ,onMessageContextMenu : function (grid, rowIndex, e) {
	    ...
	    function rgtEdit() {
				        ...
				        this.dtlwin.setTitle('修改Pjpginfo');
				        this.dtlwin.show();
				        this.dtlformpanel.form.reset();
				        this.dtlformpanel.form.loadRecord(record);
				        this.dtlformpanel.url = '../Pjpginfo/extupdate.do';
	    };
	    //右键删除
		function rgtDelete() {
			messageContextMenu.hide();
			...
			Ext.MessageBox.confirm('确认删除','确定要删除这些记录?',function(btn){
				if (btn == 'yes'){
						Ext.Ajax.request({
						url:'../Pjpginfo/extdelete.do?ids='+record.data.userid,
						method:'POST',
    ...
    //新建窗口
    ,addPjpginfo : function(){
        this.dtlwin.setTitle('新建Pjpginfo');
        this.dtlwin.show();
        this.dtlformpanel.form.reset();
	    this.dtlformpanel.url = '../Pjpginfo/extsave.do';
	}
	
	//编辑操作
    ,editPjpginfo:function(){
    ...
    ,deletePjpginfo:function(){
		...
		Ext.MessageBox.confirm('确认删除','确定要删除这些记录?',function(btn){
			if (btn == 'yes'){
				Ext.Ajax.request({
					url:'../Pjpginfo/extdelete.do?ids='+this.getRecordArrayUtils(records, 'userid'),
		            method:'POST',
		            success:function(response){
		                var data = Ext.util.JSON.decode(response.responseText);
		                if (data.success == true){
 ...
 * 注册主表格的xtype
 */
Ext.reg('pjpginfo', com.ysys.www.pjpginfoGrid);
