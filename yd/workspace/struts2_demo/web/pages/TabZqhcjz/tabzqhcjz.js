...
Ext.namespace('com.ysys.www.tabzqhcjz');

/**
 * 查询表单
 * @class com.ysys.www.tabzqhcjz.queryformpanel
 * @extends Ext.form.FormPanel
 */
com.ysys.www.tabzqhcjz.queryformpanel = Ext.extend(Ext.form.FormPanel,{
	initComponent:function() {
		...
		com.ysys.www.tabzqhcjz.queryformpanel.superclass.initComponent.call(this);
	}
});

/**
 * 查询窗口
 * @class com.ysys.www.tabzqhcjz.querywin
 * @extends Ext.Window
 */
com.ysys.www.tabzqhcjz.querywin = Ext.extend(Ext.Window,{
	initComponent:function() {
		Ext.apply(this,{
	        title:'高级查询',
	        width:455,
		...
		com.ysys.www.tabzqhcjz.querywin.superclass.initComponent.call(this);
	}
});

/**
 * 内容表单
 * @class com.ysys.www.tabzqhcjz.dtlformpanel
 * @extends Ext.form.FormPanel
 */
com.ysys.www.tabzqhcjz.dtlformpanel = Ext.extend(Ext.form.FormPanel,{
	initComponent:function() {
		Ext.apply(this,{
	        labelWidth:100,
	        labelAlign:'right',
...
//	        bodyStyle:'padding:10px',
	    ...
	    com.ysys.www.tabzqhcjz.dtlformpanel .superclass.initComponent.call(this);
	}
...
/**
 * 表单窗口
 * @class com.ysys.www.tabzqhcjz.dtlwin
 * @extends Ext.Window
 */		
com.ysys.www.tabzqhcjz.dtlwin =  Ext.extend(Ext.Window,{
	initComponent:function() {
		Ext.apply(this,{
	        width:535,
	        height:400,
		...
		com.ysys.www.tabzqhcjz.dtlwin.superclass.initComponent.call(this);
	}
});
...
/**
 * 主表格入口
 * @class com.ysys.www.tabzqhcjz
 * @extends Ext.grid.GridPanel
 */
com.ysys.www.tabzqhcjzGrid = Ext.extend(Ext.grid.GridPanel,{
    initComponent:function() {
    	this.pageSize=10;
    	this.ds = new Ext.data.Store({
	        url:'../TabZqhcjz/extlist.do',
	        reader:new Ext.data.JsonReader({
	            root:'list',
	            totalProperty:'totalSize',
	            id:'id'
		        }
		        ,['zqhyid','zqnhyts','cjzid','updatetime',]
	        ),
	        baseParams:{
	            limit:this.pageSize
	        },
		...
		Ext.apply(this,{
	        ...
	        , tbar:[
	        	{text:'新增',cls:'x-btn-text-icon',iconCls:'addicon',handler:this.addTabZqhcjz,scope:this},'-'
	        	,{text:'修改',cls:'x-btn-text-icon',iconCls:'editicon',handler:this.editTabZqhcjz,scope:this},'-'
	        	,{text:'删除',cls:'x-btn-text-icon',iconCls:'deleteicon',handler:this.deleteTabZqhcjz,scope:this},'-'
		...
		//调用父类构建函数
        com.ysys.www.tabzqhcjzGrid.superclass.initComponent.call(this);
        //加载数据
        this.store.load({params:{start:0}});
        
 		//扩展类的详细弹出窗口
 		this.dtlformpanel = new com.ysys.www.tabzqhcjz.dtlformpanel();
 		this.dtlwin =  new com.ysys.www.tabzqhcjz.dtlwin({items:this.dtlformpanel,buttons:[{
	            text:'保存',
	            handler:this.saveTabZqhcjz,
	            scope:this
	        },{
	            text:'取消',
	    ...
	    //扩展类的查询弹出窗口
	    this.queryformpanel = new com.ysys.www.tabzqhcjz.queryformpanel();
	    this.querywin =  new com.ysys.www.tabzqhcjz.querywin({items:this.queryformpanel,buttons:[{
	            text:'确定',
    ...
    */
    ...
    ,onMessageContextMenu : function (grid, rowIndex, e) {
	    ...
	    function rgtEdit() {
				        ...
				        this.dtlwin.setTitle('修改TabZqhcjz');
				        this.dtlwin.show();
				        this.dtlformpanel.form.reset();
				        this.dtlformpanel.form.loadRecord(record);
				        this.dtlformpanel.url = '../TabZqhcjz/extupdate.do';
	    };
	    //右键删除
		function rgtDelete() {
			messageContextMenu.hide();
			...
			Ext.MessageBox.confirm('确认删除','确定要删除这些记录?',function(btn){
				if (btn == 'yes'){
						Ext.Ajax.request({
						url:'../TabZqhcjz/extdelete.do?ids='+record.data.zqhyid,
						method:'POST',
    ...
    //新建窗口
    ,addTabZqhcjz : function(){
        this.dtlwin.setTitle('新建TabZqhcjz');
        this.dtlwin.show();
        this.dtlformpanel.form.reset();
	    this.dtlformpanel.url = '../TabZqhcjz/extsave.do';
	}
	
	//编辑操作
    ,editTabZqhcjz:function(){
    ...
    ,deleteTabZqhcjz:function(){
		...
		Ext.MessageBox.confirm('确认删除','确定要删除这些记录?',function(btn){
			if (btn == 'yes'){
				Ext.Ajax.request({
					url:'../TabZqhcjz/extdelete.do?ids='+this.getRecordArrayUtils(records, 'zqhyid'),
		            method:'POST',
		            success:function(response){
		                var data = Ext.util.JSON.decode(response.responseText);
		                if (data.success == true){
 ...
 * 注册主表格的xtype
 */
Ext.reg('tabzqhcjz', com.ysys.www.tabzqhcjzGrid);
