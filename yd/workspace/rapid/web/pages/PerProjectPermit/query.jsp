...
<head>
	...
	<base href="<%=basePath%>">
	<title><%=PerProjectPermit.TABLE_ALIAS%>查询</title>
</head>

<body>
<%@ include file="/commons/messages.jsp" %>

<s:form action="/pages/PerProjectPermit/list.do" method="post">
	...
	<table class="formTable">
		...
		<tr bgcolor="#FFFFFF">
		   ...
		   <td>
				<input onclick="WdatePicker({dateFmt:'<%=PerProjectPermit.FORMAT_UPDATETIME%>'})" type="text" name="s_updatetime" size="30" maxlength="0" class=""/>
		   </td>
		</tr>
