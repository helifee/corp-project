...
<head>
	...
	<base href="<%=basePath%>">
	<title><%=PerPermitGroupOld.TABLE_ALIAS%>查询</title>
</head>

<body>
<%@ include file="/commons/messages.jsp" %>

<s:form action="/pages/PerPermitGroupOld/list.do" method="post">
	...
	<table class="formTable">
		...
		<tr bgcolor="#FFFFFF">
		   ...
		   <td>
				<input  type="text" name="s_groupName" size="30" maxlength="20" class=""/>
		   </td>
		</tr>
		<tr bgcolor="#FFFFFF">
