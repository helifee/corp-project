...
<s:form action="/pages/Tempinfo/list.do" method="post">
	...
	<table class="formTable">
		...
		<tr bgcolor="#FFFFFF">
		   ...
		   <td>
				<input onclick="WdatePicker({dateFmt:'<%=Tempinfo.FORMAT_EMP_NIAN%>'})" type="text" name="s_empNian" size="30" maxlength="0" class=""/>
		   </td>
		</tr>
		<tr bgcolor="#FFFFFF">
		...
		<tr bgcolor="#FFFFFF">
		   ...
		   <td>
				<input  type="text" name="s_nl" size="30" maxlength="10" class="validate-integer max-value-2147483647"/>
		   </td>
		</tr>
		<tr bgcolor="#FFFFFF">
		...
		<tr bgcolor="#FFFFFF">
		   ...
		   <td>
				<input onclick="WdatePicker({dateFmt:'<%=Tempinfo.FORMAT_LJSR%>'})" type="text" name="s_ljsr" size="30" maxlength="0" class=""/>
		   </td>
		</tr>
		<tr bgcolor="#FFFFFF">
		...
		<tr bgcolor="#FFFFFF">
		   ...
		   <td>
				<input onclick="WdatePicker({dateFmt:'<%=Tempinfo.FORMAT_YJSR%>'})" type="text" name="s_yjsr" size="30" maxlength="0" class=""/>
		   </td>
		</tr>
		<tr bgcolor="#FFFFFF">
