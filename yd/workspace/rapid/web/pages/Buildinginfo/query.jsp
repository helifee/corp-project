...
<s:form action="/pages/Buildinginfo/list.do" method="post">
	...
	<table class="formTable">
		...
		<tr bgcolor="#FFFFFF">
		   ...
		   <td>
				<input  type="text" name="s_surplusNumber" size="30" maxlength="10" class="validate-integer max-value-2147483647"/>
		   </td>
		</tr>
		<tr bgcolor="#FFFFFF">
		   <td class="tdLabel"><%=Buildinginfo.ALIAS_STARTING_PRICE%></td>
		   <td>
				<input  type="text" name="s_startingPrice" size="30" maxlength="10" class="validate-integer max-value-2147483647"/>
		   </td>
		</tr>
		<tr bgcolor="#FFFFFF">
		   <td class="tdLabel"><%=Buildinginfo.ALIAS_EVEN_PRICE%></td>
		   <td>
				<input  type="text" name="s_evenPrice" size="30" maxlength="10" class="validate-integer max-value-2147483647"/>
		   </td>
		</tr>
		<tr bgcolor="#FFFFFF">
		...
		<tr bgcolor="#FFFFFF">
		   ...
		   <td>
				<input onclick="WdatePicker({dateFmt:'<%=Buildinginfo.FORMAT_UPDATETIME%>'})" type="text" name="s_updatetime" size="30" maxlength="0" class=""/>
		   </td>
		</tr>
