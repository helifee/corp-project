...
<s:form action="/pages/Mdistrict/list.do" method="post">
	...
	<table class="formTable">
		...
		<tr bgcolor="#FFFFFF">
		   ...
		   <td>
				<input  type="text" name="s_udflag" size="30" maxlength="10" class="validate-integer max-value-2147483647"/>
		   </td>
		</tr>
		<tr bgcolor="#FFFFFF">
		...
		<tr bgcolor="#FFFFFF">
		   ...
		   <td>
				<input onclick="WdatePicker({dateFmt:'<%=Mdistrict.FORMAT_UPDATETIME%>'})" type="text" name="s_updatetime" size="30" maxlength="0" class=""/>
		   </td>
		</tr>
