...
<TABLE id="tableEXCEL" align=center border=1 CELLSPACING=0 width="560">
	...
	<TR>
	 ...
	 <TR>
      <TD   align=center width="80"height="30" ><font size=2 color=97412d>プロジェクトの主管者</font></TD>
	...
	<TR>
      <TD  width="80" align=center height="30"><font size=2 color=97412d>日本語の名称</font></TD>
      <TD  colspan=3 width="450"   ><s:property value="prjmei_d"/></TD>
	</TR>
      <TR>
      <TD  width="80" align=center height="30"><font size=2 color=97412d>中国語の名称</font></TD>
      <TD  colspan=3 width="450"   ><s:property value="projecttyuname_d"/></TD>
	</TR>
	<TR>
      <TD  width="80" align=center height="30"><font size=2 color=97412d>英語の名称</font></TD>
      <TD  colspan=3 width="450"   ><s:property value="projecteiname_d"/></TD>
	</TR>
	<TR>
      <TD  width="80" align=center height="30"><font size=2 color=97412d>客さん名</font></TD>
      <TD  colspan=3 width="450"   ><s:property value="kyakuname_d"/></TD>
	</TR>
	<TR>
      <TD  width="80" align=center height="30"><font size=2 color=97412d>客户负责</font></TD>
      <TD  colspan=3 width="450"   ><s:property value="projecttyuname_d"/></TD>
	</TR>
	<TR>
	...
	<TR>
      <TD  width="80" align=center height="30" ><font size=2 color=97412d>プロジェクトの概要</font></TD>
...
<TR>
      <TD  align=center width="80" ><font size=2 color=97412d>プロジェクトの成員</font></TD>
      <TD  align=center width="200"><font size=2><s:property value="username_d" /></font></TD>
      <TD  align=center width="80" ><font size=2 color=97412d>成員の職務</font></TD>
...
<tr>
	...
	<input type="button" value="メル送信" name="B1" onclick="email() ">
	<input type="button" value="一般ユーザー選択" name="B1" onclick="file_name() ">
	</td>
...
<TD>
<p align=center><a href="se01Action">返回</a></p>
</TD>
</Tr>
</TABLE>
</s:form>
