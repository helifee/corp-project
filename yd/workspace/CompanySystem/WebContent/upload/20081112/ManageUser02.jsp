...
<tr>
	...
	<tr>
		<td width=25% height=7%>
			<p style="font:18px;text-indent:4px ">プロジェクトの主管者</p>
		</td>
		<td width=25% height=7%>
			<s:property value="username_c"/>
		</td>	
		<td width=25% height=7%>
			<p style="font:18px;text-indent:4px ">副主管者</p>
		</td>
		<td width=25% height=7%>
			<p style="font:18px;text-indent:4px ">&nbsp;</p>
		</td>
	...
	<tr>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">取引先の名称</p>
		</td>
	...
	<tr>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">日本語の名称</p>
		</td>
		<td width=50% colspan="2" height=7%>
	...
	<tr>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">中国語の名称</p>
		</td>
		<td width=50% colspan="2" height=7%>
	...
	<tr>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">英語の名称</p>
		</td>
		<td width=50% colspan="2" height=7%>
	...
	<tr>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">取引先は責任を負います</p>
		</td>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">&nbsp;</p>
	...
	<tr>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">プロジェクトの概要</p>
		</td>
		<td width=50% colspan="2" height=7%>
...
<table border="0" width=89％ height=100% align="center">
	...
	<TD colspan="4">
		<p align=center><a href="ManageUser01_init.action">返回</a></p>
	</TD>
	</Tr>
</table>
</s:form>
