...
<body background=D:\backblue.jpg>

 <s:form name="popupForm">
 <input name="username" type="text" id="bb" class="ipt01" value="显示所有" readonly />

	<table align="left">
		<s:iterator value="users" status="st">
			<tr>
			<td align="left"><font size=2><input  type="radio" name="aa" id="id"  value="<s:property value="userid_a" />" onclick="sele()"/> <s:property value="username_a" /></font></td>

			</tr>
	  </s:iterator>
		<tr>
			<td width="130" colspan=3 align="left"><input type="button"
				value="close" name="close" onclick="window.close();"></td>
			<td width="135" colspan=1 align="left"><input
				onClick="javascript:do_ok1();" type="button" name="ok"
				value=" ok "></td>
		</tr>
	</table>
</s:form>
...
<!--  <tr><s:textfield id="username" name="username"/></tr>-->