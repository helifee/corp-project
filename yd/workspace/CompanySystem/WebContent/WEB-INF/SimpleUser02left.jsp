...
<table border="1" width=89％ height=100% align="center" >
<s:iterator value="pjs2" status="st">
	...
	<tr>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">客さん名</p>
		</td>
		<td width=50% colspan="2" height=7%>
	...
	<tr>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">プロジェクト名</p>
		</td>
		<td width=50% colspan="2" height=7%>
	...
	<tr>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">プロジェクト中文名</p>
		</td>
		<td width=50% colspan="2" height=7%>
	...
	<tr>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">プロジェクト英文名</p>
		</td>
		<td width=50% colspan="2" height=7%>
	...
	<tr>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">客さんは責任を負います</p>
		</td>
		<td width=50% colspan="2" height=7%>
			<p style="font:18px;text-indent:4px ">&nbsp;</p>
...
<table border="0" width=89％ height=100% align="center">
	...
	<TD colspan="4">
		<p align=center><a href="javascript:history.back(1)">帰る</a></p>
	</TD>
	</Tr>
