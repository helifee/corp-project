...
<html>	
	...
	<body bgcolor="#ecf6ff">
		<p align="center"><font size="4" color="green"><strong>会议室预约更改</strong></font></p>
		<s:form id="hysyy" name="hysyy" method="post" action="yuyueModify" theme="simple">			 
				<table align="center" cellspacing="10" width="540">
				<tr>
					<td width="85"><s:radio id="dangri" name="yuyueinfo.yuyuetype" list="#{0 : '当日更改'}" 
				...
				<tr>
					<td><s:radio name="yuyueinfo.yuyuetype" list="#{1 : '周期更改'}" 
					...
					<td>
						<table width="350">
							<tr>
								...
								<td width="285">
									<s:checkbox name="yuyueinfo.mon" fieldValue="2" value="isMonday"></s:checkbox>星期一
									<s:checkbox name="yuyueinfo.tue" fieldValue="3" value="isTuesday"></s:checkbox>星期二
									<s:checkbox name="yuyueinfo.wen" fieldValue="4" value="isWensday"></s:checkbox>星期三
								</td>
							</tr>
						</table>
					</td>
					...
					<td>
						<table width="350">
							<tr>
								<td width="53"></td>
								<td width="285">
										<s:checkbox name="yuyueinfo.thu" fieldValue="5" value="isThusday"></s:checkbox>星期四
										<s:checkbox name="yuyueinfo.fri" fieldValue="6" value="isFriday"></s:checkbox>星期五		
								</td>
							</tr>
						</table>						
					</td>
				...
				<tr>
					<td>参加人</td>
				    <td><s:textfield name="yuyueinfo.cjr" cssStyle="width:267px" maxlength="10" ></s:textfield>
				...
				<tr>
					<td >参加人数</td>
				    <td ><s:textfield name="yuyueinfo.cjrs" cssStyle="width:115px" maxlength="2" ></s:textfield></td>
				</tr>
				
				<tr>
					<td >会议记录</td>
					<td ><s:textarea name="yuyueinfo.hyjl" cols="50" rows="4" ></s:textarea></td>
				</tr>				
			</table>
			<br />
			...
			<table align="center" width="260">
				<tr>
					<td align="center"><input type="submit" style="width:70px" id="insert" name="insert" value="更改预约" onclick=""></td>
					<td align="center"><input type="submit" style="width:70px" id="insert" name="insert" value="取消预约" onclick=""></td>		
				</tr>				   
			</table>
