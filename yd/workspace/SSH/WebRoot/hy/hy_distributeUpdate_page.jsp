...
<table width="887" border="0" id="xinjiangenggaiTable" cellpadding="2"
	...
	<tr>
		...
		<td align="right"><input type="button" name="tijiao" value="提交"
			...
			onclick="submitTypeDistributePage(); " disabled="disabled" /></td>
...
<table width="915" border="0" cellspacing="2" cellpadding="2"
	align="center">
	<tr>
       <td align="left" >
                                      每页显示最大记录数: 
...
<pg:index>		 
	记录数:<s:property value="items1"/>&nbsp;
		 ...
		 <a href="#" onclick="conferensituationPageTag('${pageUrl}' , '${pageNumber}'  , '<s:property value="items1"/>' , '<s:property value="maxPageItems1"/>');" >首页</a> 
		 </pg:first>
		 <pg:prev export="pageUrl , pageNumber" >
		 <a href="#" onclick="conferensituationPageTag('${pageUrl}' , '${pageNumber}'  , '<s:property value="items1"/>' , '<s:property value="maxPageItems1"/>');" >上一页</a> 
		 </pg:prev>
		 <pg:pages export="pageUrl , pageNumber" >
		 <a href="#" onclick="conferensituationPageTag('${pageUrl}' , '${pageNumber}'  , '<s:property value="items1"/>' , '<s:property value="maxPageItems1"/>');" >${pageNumber}</a> 
		 </pg:pages>
		 <pg:next export="pageUrl , pageNumber" >
		   <a href="#" onclick="conferensituationPageTag('${pageUrl}' , '${pageNumber}'  , '<s:property value="items1"/>' , '<s:property value="maxPageItems1"/>');" >下一页</a> 
		 </pg:next>
		<pg:last export="pageUrl , pageNumber" >
		   <a href="#" onclick="conferensituationPageTag('${pageUrl}' , '${pageNumber}'  , '<s:property value="items1"/>' , '<s:property value="maxPageItems1"/>');" >尾页</a> 
		</pg:last>   
 </pg:index>		          
        </td>
      </tr>
        ...
        %> 
			...
			<td width="150"><font size="2"><s:property value="hysmc" /></font></td>
              ...
              <s:property value="imagefromx" /> , <s:property value="imagefromy" /> , <s:property value="imagetox" /> , <s:property value="imagetoy" /> , <s:property value="sortid" />);">
				...
				<td width="45" align="center">
				<a href="#"
					onclick="distributeDeleteActionPage( <%=a %> , <s:property value="id" />);">
					<font size="2">删除</font>
				</a></td>
			</tr>
			<%
