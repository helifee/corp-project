		...
		<td height="227" colspan="3" align="center"><s:form
			...
			<table width="896" border="0" cellpadding="2" cellspacing="1"
				...
				<tr bgcolor="#6c95d0" align="center">
					<td width="29"><font color="#FFFFFF" size="2">ID</font></td>
					<td width="151"><font color="#FFFFFF" size="2">会议室名</font></td>
					<td width="69"><font color="#FFFFFF" size="2">容纳人数</font></td>
					<td width="100"><font color="#FFFFFF" size="2">网线接口数量</font></td>
					<td width="41"><font color="#FFFFFF" size="2">电话</font></td>
			...
			<div
				...
				align="center">
			<table width="878"  cellpadding="1" cellspacing="1" rules="none" border="0" 
				 id="xianshiTable">
