...
-->
<!-- add by xieyujun 2010/03/16 fancy-hist.xsl from -->
      ...
      <script type='text/javascript'>
         ...
         var categories = new Array(
            <xsl:for-each select="/BugCollection/BugCategory">
               ...
               <!-- ####### add by xieyujun 2010/03/16 start ####### -->
               [ "<xsl:value-of select="@category" />", "<xsl:value-of select="@category" /> : <xsl:value-of select="Description" />" ],
               <!-- ####### add by xieyujun 2010/03/16 end   ####### -->
            </xsl:for-each>
               [ "", "" ]
            );
         ...
         var codes = new Array(
            <xsl:for-each select="/BugCollection/BugCode">
               ...
               <!-- ####### add by xieyujun 2010/03/16 start ####### -->
                  [ "<xsl:value-of select="@abbrev" />", "<xsl:value-of select="@abbrev" /> : <xsl:value-of select="Description" />" ],
               <!-- ####### add by xieyujun 2010/03/16 end   ####### -->
            </xsl:for-each>
               [ "", "" ]
            );
        ...
        <!--
         ...
         var patterns = new Array(
            <xsl:for-each select="/BugCollection/BugPattern">
               ...
               <!-- ####### add by xieyujun 2010/03/16 start ####### -->
               [ "<xsl:value-of select="@category" />", "<xsl:value-of select="@abbrev" />", "<xsl:value-of select="@type" />", "<xsl:value-of select="@type" /> : <xsl:value-of select="translate(ShortDescription, '&quot;', $apos)" />" ],
               <!-- ####### add by xieyujun 2010/03/16 end   ####### -->
            </xsl:for-each>
               [ "", "", "", "" ]
            );
