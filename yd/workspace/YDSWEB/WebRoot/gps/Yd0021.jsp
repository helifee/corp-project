...
<div class="span-24">
	...
	<div  class="span-23 margin_top_2 margin_bottom_2">
		<div class="span-21">
	...
	<div class="span-23 box_border overflow_hd">
		<div class="span-23">
			<table id="table_exChangeHisList" class="datagrid2 text_center">
			    <tr>
						<th class="percent_20 ">交易时间</th>
						<th class="percent_10 ">账户名</th>
			...
			<s:if test="exChangeHisList.size > 0">
								<s:iterator value="exChangeHisList" status="offset" >
									<tr>
									 ...
									 <td class="percent_10"><s:property value="accId" /></td>
										<s:if test='ioFlag == "1"'>
										...
										<td class="percent_10 ">
											<a href="yd0070Init?fromId=yd0020&orderId=<s:property value="orderId" />"><s:property value="orderId" /></a></td>
										<td class="percent_20 text_left"><s:property value="exRemarks" />
										</td>
									</tr>
								</s:iterator>
							</s:if>
