...
<head>
	...
	<title>选择人员Sample(Dialog方式)</title>
	<script type="text/javascript" src="../js/common/prototype.js"></script>
	<script type="text/javascript" src="../js/sample/userSelectDialogSample.js"></script>
</head>
<body>
...
<ul>
	...
	<li>
		<p>实现display(users)方法。你可以随意选择标签，用于显示所选择的人员，参数为User数组。具体参考代码。</p>
	</li>
	<li>
