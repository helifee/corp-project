...
<head>
	...
	<!-- 画面用js -->
	<script type="text/javascript" src="../../js/ttTraining/j030081.js"></script>
...
<div class="span-20 showgrid ">
	<s:form id="deleteVideoForm" action="j030081DeleteVideo.action" method="post" enctype="multipart/form-data"  >		
	  <table class="datagridtt ellipsis">
	    	...
	    	<s:iterator value="bookAttachmentsList" status="stat">
	    		<tr>
	    			<td class="text_center">
	    				<s:url action="../../tt/manager/getFile?flag=BOOK_MEDIA" id="getFileActionUrl">
	    			...
	    			<td class="text_center"><a href="#" onclick="deleteVideo('${dataId}')">删除</a></td>
	    			<td class="text_center"><a href="#" onclick="recommendVideo('${dataId}')">引用</a></td>
	    		</tr>
	    	</s:iterator>
	    </s:if>
	    <!-- 题库文件资料 -->
	    <s:if test="mode==2">	
	    	<s:iterator value="questionAttachmentsList" status="stat">
	    		<tr>
	    			<td class="text_center">
	    				<s:url action="../../tt/manager/getFile?flag=QUESTION_MEDIA" id="getFileActionUrl">
	    			...
	    			<td><s:property value="createTime" /></td>
	    			<td class="text_center"><s:property value="createUserName" /></td>
	    			<td class="text_center"><a href="#" onclick="deleteVideo('${fileId}')">删除</a></td>
	    			<td class="text_center"><a href="#" onclick="recommendVideo('${fileId}')">引用</a></td>	    			
	    		</tr>
	    	</s:iterator>
	    </s:if>
	  </table>
