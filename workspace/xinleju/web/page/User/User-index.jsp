...
<script language="javascript" type="text/javascript" src="page/User/User-index.js?t=<%=System.currentTimeMillis()%>"></script>
</head>
<body>
	<div id="wrapper">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" id="myTable">
			<tr>
				...
				<td valign="top" width="74%">
					<div>
						<iframe id="user_frame" name="user_frame" frameborder="0"  scrolling="no" onload="setAutoHeight('user_frame',0)" src="User!structUserList.do?limit=10&parentEntityId=0&partyStructTypeId=${partyStructTypeId }" width="100%" marginheight="0" marginwidth="0"  ></iframe>
					</div>
				</td>
			</tr>
		</table>
