...
<script language="javascript" type="text/javascript" src="page/BizAuth/BizAuth-RolesBizBtnList.js?t=<%=System.currentTimeMillis()%>"></script>
</head>
<body>

<form id="frm" name="frm" action="BizAuth!RolesbizBtnList.do" method="post">
