...
var buildTree = function(partyStructTypeId) {
	...
	tree.on('click', function(node) {
		dt = new Date();
		if(userRoleFlag){
			Ext.get(document.getElementById("user_frame")).dom.src ="TurnOverDeal!structParList.do?limit=10&parentEntityId=" + node.id+ "&partyStructTypeId="+node.attributes.partyStructTypeId+"&dt="+dt;
		}else{
