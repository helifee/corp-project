...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="page/DesktopComponent/DesktopComponent-list.js"></script>
		<script language="javascript" type="text/javascript" src="js/My97DatePicker/WdatePicker.js" defer="defer"></script>
		<script type="text/javascript" src="js/jquery.enplaceholder.js"></script>
		<script type="text/javascript" src="js/search.js"></script>
	</head>
	<body>
		<s:form id="frm" action="DesktopComponent!list">
			      ...
			      <ul id="selectedCond">
			      	<s:if test="#request.appMap.get(#request.moduleCode) != null">
			        	<li id="moduleCodeLi">
			        		...
			        		<s:hidden name="moduleCode" value="%{#request.moduleCode}"></s:hidden>
			        	</li>
			      	</s:if>
			...
			<div class="t_title">
			  ...
			  <div class="tool">
			  		<a href="#" onclick="javascript:newDesktopComponent()">新增</a>
			...
			<table width="100%" cellpadding="0" cellspacing="1" class="wd_tablelist01">
				...
				<s:else>
					<tr>
						...
						<td align="center">
							<a href="#" onclick="javascript:newDesktopComponent('${item.id}')">编辑</a>
						</td>
					</tr>
				</s:iterator>
			</table>
