...
<script type="text/javascript" src="page/FlowInstanceManager/FlowInstanceManager-replaceCurrentApproval.js"></script>
</head>
<body>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" id="myTable">
			<tr>
				...
				<td width="77%" valign="top" >
					<iframe id="user_frame" name="user_frame" frameborder="0" src="FlowInstanceManager!userList.do?fiId=${fiId}" width="100%" height="550" marginheight="0" marginwidth="0" scrolling="yes"></iframe>
				</td>
			</tr>
	</table>
