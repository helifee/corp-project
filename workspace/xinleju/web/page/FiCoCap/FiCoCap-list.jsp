...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="page/FiCoCap/FiCoCap-list.js?t=new Date()"></script>
	...
	<body>
       ...
       <!--    <div data-options="region:'center',title:'预算科目管理'"> -->
			<div id="grid_tb">
				<a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:addCoCap();" class="t_more">新增</a>
			  	<a class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="javascript:editCoCap();" class="t_more">编辑</a>
			  	<a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:deleteCoCap();" class="t_more">删除</a>
			  	<input id="compay" name="compay" class="easyui-textbox" />
			    <a class="easyui-linkbutton"  plain="true" 
					onclick="javascript:exportCoCap();" class="t_more">导出</a>
				<a class="easyui-linkbutton"  plain="true" 
					onclick="javascript:importCoCap();" class="t_more">导入</a>
		    </div>
            <table  id="grid"></table>
      <!--   </div> -->
		</div>
		 ...
		 <div id="dlg" class="easyui-dialog" style="width:600px;height:550px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
	        ...
	        <form id="fm" method="post" novalidate>
                ...
                <div class="fitem">
                    ...
                    <input id="accountSetId" name="fiCoCap.accountSetId" style="display: none"/>
    	...
    	<div id="dlg-buttons">
	        <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="saveOrUpdateFiCoCap()" style="width:90px">保存</a>
