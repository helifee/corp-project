...
<head>
	...
	<script type="text/javascript" src="page/IdRule/IdRule-tree.js?t=<%=System.currentTimeMillis()%>"></script>
</head>
<style>
.ui-menu { width: 150px; }
</style>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" id="myTable">
		<tr>
			<td width="280" valign="top" height="380" >
				...
				<input id="treeRootName" name="treeRootName" value='${treeRootName}' type="hidden"></input>
				<input id="objectId" name="objectId" value="" type="hidden"></input>
				<input id="objectName" name="objectName" value="" type="hidden"></input>
				<div id="tree"></div>
			</td>
		</tr>
	</table>
