...
<body>
<div class="easyui-layout" data-options="fit:true,border:false" id="treegrid_layout">
        <input type="hidden" id="componentId" value="${param.componentId}"  />
       <input type="hidden" id="model" value="${param.model}"  />
          <div data-options="region:'center'" style="padding:5px;background:#eee;">
                <table  id="tree_grid"></table>
        </div>
       </div>
     <script type="text/javascript" src="${pageContext.request.contextPath}/page/dialog/treegrid.js"></script>
</body>
