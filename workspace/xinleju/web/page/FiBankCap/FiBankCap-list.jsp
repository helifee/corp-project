...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="page/FiBankCap/FiBankCap-list.js?time=New Date()"></script>
	...
	<body>
       ...
       <!--    <div data-options="region:'center',title:'预算科目管理'"> -->
			<div id="grid_tb">
				<a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:addBankCap();" class="t_more">新增</a>
			  	<a class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="javascript:editBankCap();" class="t_more">编辑</a>
			  	<a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:deleteBankCap();" class="t_more">删除</a>
			  	<input id="compay" name="compay" class="easyui-textbox" />
			  	<a class="easyui-linkbutton"  plain="true" 
					onclick="javascript:exportBankCap();" class="t_more">导出</a>
				<a class="easyui-linkbutton"  plain="true" 
					onclick="javascript:importBankCap();" class="t_more">导入</a>
      ...
      <!--   </div> -->
		...
		<!-- 新增/编辑 对话框 -->
		 <div id="dlg" class="easyui-dialog" style="width:600px;height:550px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
        	<div class="ftitle">银行对应会计科目编辑</div>
	        <form id="fm" method="post" novalidate>
	            ...
	            <div class="fitem">
	                ...
	                <input id="bankId" name="bid" style="display: none"/>
	                <input id="id" name="id" style="display: none"/>
	                <input id="sysId" name="sysId" style="display: none"/>
	                <input id="accountSetId" name="fiBankCap.accountSetId" style="display: none"/>
	                <input id="createDate" name="createDate"  style="display: none"/>
	                <input id="companyId" name="fiBankCap.companyId" style="display: none"/>
	                <!-- <input id="bankId" name="fiBankCap.bid" style="display: none"/> -->
	                <input id="bankCode" name="bankCode" style="display: none"/>
	                <input id="bankName" name="bankName" style="display: none"/>
	            </div>
	        </form>
    	</div>
    	<div id="dlg-buttons">
	        <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="saveOrUpdateFiBankCap()" style="width:90px">保存</a>
