    ...
    <head>
        ...
        <script type="text/javascript">
           $(function(){
               ...
               $('#tzgg_count',$(parent.document)).html(total);
           });
        </script>
    </head>
    <body>
        <s:set id="msgTz" value="@com.xinleju.erp.frame.models.Msg@MSG_TYPE_TZ"></s:set>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td align="right" class="idxmore">
                    <a href="#" onclick="window.parent.location.href='Msg!index.do?msgDto.msgType=${msgTz}'">更多&gt;</a>
                </td>
            </tr>
        </table>
        <jdt:PageMetaTag />
