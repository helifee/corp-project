...
// 	function wpSel(wpId1, wpId) {
// 		$("input[name^='chWpId_']").each(function() {
// 			this.checked = false;
// 		});
	
// 		$("input[name='chWpId_"+wpId1+"_"+wpId+"']").attr("checked", true);
// 		window.parent.selWpId = wpId;
// 	}
	</script>
</head>
<body>
	...
	<table id="zpjl" width="100%" border="0" cellpadding="0" cellspacing="1" class="table_fj">
		<tr>
