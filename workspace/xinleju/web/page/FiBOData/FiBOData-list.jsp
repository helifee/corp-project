...
<script type="text/javascript" src="page/FiBOData/FiBOData-list.js"></script>
<script>
...
<body>
	<div class="easyui-layout" data-options="border:false,fit:true">
		...
		<div data-options="region:'center',title:'凭证生成'" style="padding: 5px; background: #eee;">
			<div class="easyui-layout" data-options="border:false,fit:true" id="layout">
				<div data-options="region:'north',height:'auto',border:false">
					<form id="frm">
						...
						<div class="s1_searchWrap">
							<div class="s2">
								...
								<div class="s2-clear">
								<a id="nl" href="javascript:void(0);">收缩</a>
								</div>
								<div class="s2-clear">
				  ...
				  <div class="tool">
				  <a href="#" onclick="javascript:createVoucher();" class="t_more">生成凭证</a>
