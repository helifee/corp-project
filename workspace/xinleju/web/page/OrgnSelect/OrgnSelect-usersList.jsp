...
<head>
    ...
    <script type="text/javascript" src="page/OrgnSelect/OrgnSelect_usersList.js"></script>
</head>
<body>
		...
		<div  valign="top" align="left"  style="width:350px;height:400px;float:left;">
		    <table width="100%"  align="center"  valign="top" cellpadding="0" cellspacing="1" class="xy_01 mgb8"  id="l_table">
			    ...
			    <s:iterator value="page.items" var="item"  >
				      <tr  id="${item.id}" ondblclick="javascript:additUserSingleList(${item.id});return false;">
					        <td align="center"><input type="checkbox" name="l_user"  value="${item.id}" onclick="javascript:checkOneList(this);" /></td>
	       ...
	       <table width="100%" border="0" cellspacing="0" cellpadding="0">
		           ...
		           <tr>
		               <td height="45" align="center" valign="top">
		                   <a href="#" title="选择" onclick="javascript:additUserList();return false;"><img src="${pageContext.request.contextPath}/images/arrow_03.png" width="32" height="36" />
		                   </a>
		               </td>
		           </tr>
		           <tr>
		               <td height="45" align="center" valign="top">
		                   <a href="#" title="移除" onclick="javascript:removeUserList();return false;"><img src="${pageContext.request.contextPath}/images/arrow_02.png" width="32" height="36" />
		                   </a>
		               </td>
		           </tr>
		           <tr>
