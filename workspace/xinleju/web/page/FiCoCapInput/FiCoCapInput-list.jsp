...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="page/FiCoCapInput/FiCoCapInput-list.js?t=new Date()"></script>
	...
	<body>
       ...
       <!--    <div data-options="region:'center',title:'预算科目管理'"> -->
			<div id="grid_tb">
				<a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:addCoCapInput();" class="t_more">新增</a>
			  	<a class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="javascript:editCoCapInput();" class="t_more">编辑</a>
			  	<a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:deleteCoCapInput();" class="t_more">删除</a>
			    <input id="compay" name="compay" class="easyui-textbox" />
			    <a class="easyui-linkbutton"  plain="true" 
					onclick="javascript:exportCoCapInput();" class="t_more">导出</a>
				<a class="easyui-linkbutton"  plain="true" 
					onclick="javascript:importCoCapInput();" class="t_more">导入</a>
		    </div>
            <table  id="grid"></table>
      <!--   </div> -->
		</div>
		<!-- 新增/编辑 对话框 -->
		 <div id="dlg" class="easyui-dialog" style="width:600px;height:550px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
        	<div class="ftitle">成本科目编辑</div>
	        <form id="fm" method="post" novalidate>
	        	<s:token></s:token>
	            <div class="fitem">
                    <label>成本科目:</label>
                    <input id="coId" name="coId" class="easyui-textbox" style="width:400px" data-options="disabled:false">
	            ...
	            <div class="fitem">
	                ...
	                <input id="accountSetId" name="fiCoCapInput.accountSetId" style="display: none"/>
    	...
    	<div id="dlg-buttons">
	        <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="saveOrUpdateFiCoCapInput()" style="width:90px">保存</a>
