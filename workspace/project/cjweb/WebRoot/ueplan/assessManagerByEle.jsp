  ...
  <body>
  	<table align="center">
    	...
    	<tr>
    		<td>
	    		<a>用电量</a>&nbsp;&nbsp;
	    		<a href="ueplan/assessManager.do?type=water">用水量</a>
	    	</td>
    	</tr>
    	<tr>
    		<td>
				<form id="assessForm" action="ueplan/assessManager.do?type=ele" method="post">
					<table class="t_table">
						<tr>
							<td>用能提示：</td> 
						</tr>
							...
							<td colspan="2">
								<div id="uetip" class="borderlines" style="width:300px;">
									<c:forEach items="${usagePromptList }" var="upList">
										${upList.departName }部门  ${upList.month }月份 用电量 过快<br />
									</c:forEach>
								</div>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								选择月份：
								<input id="date" name="date" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-M'})" value="${date }"/>
							</td> 
						</tr>
						<tr>
							<td colspan="2">
