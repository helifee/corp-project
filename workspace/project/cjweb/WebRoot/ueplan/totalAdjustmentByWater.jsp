...
<html>
  ...
  <body>
  	<table align="center">
    	...
    	<tr>
    		<td>
	    		<a href="ueplan/totalAdjustmentInit.do?type=ele">用电量 </a>&nbsp;&nbsp;
	    		<a>用水量 </a>
    		</td>
    	</tr>
    	<tr>
				...
				<form id="totalAdjustmentForm" action="" method="post">
					<table>
						...
						<tr>
							...
							<td colspan="2">
								金&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;额：<span id="amount" class="underline">0</span>&nbsp;万元
							</td>
						</tr>
						<tr>
							<td>
		...
		<tr>
			<td>
				<table class="table">
					<tr>
						<td>部门名称 </td>
						<td>累计用量(<span class="dw">千瓦时</span>)</td>
						<td>累计用量占比 </td>
						<td>所用时间占比 </td>
						<td>剩余用量(<span class="dw">千瓦时</span>)</td>
						<td>计划总量(<span class="dw">千瓦时</span>)</td>
					</tr>
			...
			<td>
				...
				<table id="adjustmentLog" class="table">
					<tr>
						<td>序号 </td>
						<td>调整日期</td>
						<td>调整后总量(<span class="dw">千瓦时</span>)</td>
