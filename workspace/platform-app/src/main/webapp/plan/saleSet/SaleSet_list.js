  ...
  //增加一项字典项条目
    ...
    $('#deleteItemBtn').on('click',function () {
        ...
        $.xljUtils.confirm('blue','确定要删除这'+ids.length+'条数据么？',function () {
            $.ajax({
                url: hostUrl + "plan/plSaleSet/deleteBatch/" + ids,
                type: 'DELETE',
                dataType: 'JSON',
    ...
    $('#saveItemBtn').on('click',function () {
        ...
        $.ajax({
            url:hostUrl + 'plan/plSaleSet/saveAllSaleSetList',
...
function getCompany(){
	$.ajax({
        type:'post',
        url:hostUrl+'pl/plCompany/queryList',
        dataType:'json',
        contentType:'application/json',
        data:"{}",
...
function initsaleSetList() {
    jQuery("#saleSetList").jqGrid({
    	url:hostUrl+'plan/plSaleSet/page',
