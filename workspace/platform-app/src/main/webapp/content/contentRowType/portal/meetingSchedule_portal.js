...
$(function () {
    ...
    function initPageData() {
        $.ajax({
            ...
            type: 'POST',
            //async: false,
            url: hostUrl + "oa/meeting/meeting/potalPage"+"?time="+Math.random(),
            dataType: "json",
                ...
                if (result) {
                    ...
                    for (var i in result) {
                       ...
                       /* var publishTime = newObj.submittime;//发布时间
                        ...
                        if(status == 0){
            				a.attr('href', hostUrl + "meeting/meeting/meeting_edit.html?act=update&id="+id+"&update="+true);
            			}else{
            				a.attr('href', hostUrl + "meeting/meeting/meeting_view.html?act=view&id="+id+"&update="+false);
            			}
