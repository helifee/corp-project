...
function getConporationEcho(id){
	$.ajax({
        type:'get',
        url:hostUrl+'sys/base/baseCorporation/get/'+id+'?time='+Math.random(),
        success: function(data) {
        	if(data.success){
        	...
        	console.log(CorporationData);
        		...
        		if(CorporationData.companyId&&(!CorporationData.companyName)){
        			$.ajax({
        				type:'get',
        				url:hostUrl+'sys/org/orgnazation/get/'+CorporationData.companyId+'?time='+Math.random(),
        				success: function(data) {
        					if(data.success){
...
function saveForm(op){
	...
	var baseCorporationDto={};
		...
		if(type=='add'){
			   $.ajax({
			       url:hostUrl+"/sys/base/baseCorporation/save",
			...
			$.ajax({
				url:hostUrl+"/sys/base/baseCorporation/update/"+CorporationId,
				data:JSON.stringify(baseCorporationDto),
				type:'PUT',
				contentType:'application/json',
				dataType:'JSON',
