...
mxClient.include(mxClient.basePath+'/js/util/mx_util.js');
...
mxClient.include(mxClient.basePath+'/js/shape/mx_shape.js');
...
mxClient.include(mxClient.basePath+'/js/layout/mx_layout.js');
...
/*mxClient.include(mxClient.basePath+'/js/layout/hierarchical/model/model.js');
mxClient.include(mxClient.basePath+'/js/layout/hierarchical/stage/stage.js');*/
mxClient.include(mxClient.basePath+'/js/layout/hierarchical/mx_hierarchical.js');
...
mxClient.include(mxClient.basePath+'/js/model/mx_model.js');
...
mxClient.include(mxClient.basePath+'/js/view/mx_view.js');
...
mxClient.include(mxClient.basePath+'/js/handler/mx_handler.js');
...
mxClient.include(mxClient.basePath+'/js/editor/mx_editor.js');
...
mxClient.include(mxClient.basePath+'/js/io/mx_io.js');