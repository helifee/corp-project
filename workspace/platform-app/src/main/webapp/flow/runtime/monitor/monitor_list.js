...
function getBusinessObjectPage() {
    ...
    $.xljUtils.initJqGrid({
            ...
            url: hostUrl+"flow/monitorSetting/page",
            postData: {delflag: 0},
            datatype: "json",
            ...
            ondblClickRow:function(rowid,iRow,iCol,e){
            	var urlText = baseUrl + "flow/runtime/monitor/monitor_edit_new.html?monitorId=" + rowid;
                openWin(urlText);
            },
...
function modifyItem(rowid,iRow,iCol,e) {
    ...
    var urlText = baseUrl + "flow/runtime/monitor/monitor_edit_new.html?monitorId=" + rowIds[0];
    openWin(urlText);
...
function deleteItem() {
	...
	pop_text_open("blue", popText, function() {
		$.ajax({
			type : "delete",
			url : hostUrl + "flow/monitorSetting/deletePseudoBatch/" + idText,
			dataType : "json",
