    ...
    //本页面的URL格式是meeting_detail.html?meetingId=e2e1e4dc29af449f9a82351414319e68
    var url = decodeURI(location.href);
  	var urlText = url.split("?")[1];
  	var paramArray = urlText.split("&");
  	var dataId = paramArray[0].split("=")[1]; 
	...
	function getMobileParamAndQueryFormData(){
		$.ajax({
	       url: path+"/mobile/meeting/querySummaryDetail/"+dataId, type: 'GET',
