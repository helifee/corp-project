...
function queryFormDataByMsgId() {
	var paramData = {msgId: msgId,instanceId:instanceId,businessId:businessId,appCode:appCode, typeCode: $.getUrlParam("typeCode"), approveRole: $.getUrlParam("approveRole")};
	var sessionSign = 0;
	$.ajax({
		type: "POST",
