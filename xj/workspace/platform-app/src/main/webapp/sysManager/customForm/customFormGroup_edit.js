...
function initFormData() {
    ...
    if("add"==type){
        ...
        $("#customForumGroupForm").attr('action',baseUrl+'/sys/base/customFormGroup/save');
        ...
        $.ajax({
            ...
            success:function (resultData) {
                if(resultData&&resultData.success) {
                    ...
                    $("#customForumGroupForm").attr('action',baseUrl+'/sys/base/customFormGroup/update/'+result['id']);
