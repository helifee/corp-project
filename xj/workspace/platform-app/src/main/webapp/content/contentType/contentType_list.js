...
$(function () {
    ...
    $('#flowModelBtn').on('click',function () {
        ...
        if(businessObject) {
            ...
            if(!flTemplate){
                window.open(hostUrl+'flow/editor/fl_all.html?appId=9d6cba61c4b24a5699c339a49471a0e7&businessObjectId='+businessObject.id+'&businessObjectName='+encodeURIComponent(businessObject.name)+'&flStatus=2&isDefault=true');
            }else{
                window.open(hostUrl+'flow/editor/fl_all.html?flId='+flTemplate.id+'&businessObjectId='+businessObject.id+'&flStatus=0');
