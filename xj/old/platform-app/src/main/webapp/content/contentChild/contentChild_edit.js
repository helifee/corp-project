    ...
    function initFormData() {
        ...
        switch (act){
            ...
            case 'update':
                var id = urlParam.id;
                $.ajax({
                    url: hostUrl + "oa/content/contentChild/get/" + id+'?_time='+new Date().getTime(),
                    type: 'GET',
                    dataType: 'JSON',
...
function saveFormData(act,saveType) {
    ...
    var url = hostUrl + 'oa/content/contentChild/save';
    var type = 'POST';
    switch (act){
        case 'create':
        ...
        case 'update':
            type = 'PUT';
            url = hostUrl + 'oa/content/contentChild/update/'+$('#id').val();
            break;
    }
