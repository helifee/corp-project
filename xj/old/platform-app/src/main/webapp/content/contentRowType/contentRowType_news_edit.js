...
//登陆人
    ...
    function createForm(resultList) {
        ...
        if(contentChildNameObj[0]){
            ...
            $.ajax({
                url:hostUrl + 'oa/content/contentChild/queryContentChildList',
                        ...
                        //$.when(defObjs.attachDef,defObjs.picDef).done(function () {
                            ...
                            if((saveType=='temporary'||saveType=='save'||saveType=='publish')){
                                if((approveType&&approveType=='JG')||saveType=='temporary'){
                                    ...
                                    window.location.href = hostUrl + "content/contentRowType/contentRowType_news_edit.html?ids=" + jsonData.id + "&oper=edit&contentTypeId=" + contentTypeId + "&process=" + process + "&businessObjectCode=" + businessObjectCode + "&status=" + status;
                                    return saveResult;
                                }
                                ...
                                window.location.href = hostUrl + 'flow/runtime/approve/start.html?businessObjectCode='+businessObjectCode+'&businessId='+contentRowTypeId;
