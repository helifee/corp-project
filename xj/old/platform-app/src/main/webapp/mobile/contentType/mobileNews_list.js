$(function () {
    ...
    function initNewsList(param) {
        mui.ajax(hostUrl+'oa/content/contentRowType/queryListForMobile',{
    ...
    mui(".mui-table-view").on('tap','.mui-table-view-cell',function(){
        ...
        if(urlParams.contentTypeCodes=='DBPT'){
            window.location.href = hostUrl + 'mobile/contentType/mobileDocs_view.html?hideHeader=true&id='+id;
        }else{
            window.location.href = hostUrl + 'mobile/contentType/mobileNews_view.html?hideHeader=true&id='+id;
        }
