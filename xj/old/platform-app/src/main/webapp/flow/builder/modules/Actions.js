...
define(['utils'], function (utils) {
    ...
    var creatCoverBox = function(frame,wndProp){
        var coverDiv = document.createElement("div");
        $(coverDiv).addClass("coverLayerDiv");
        document.body.appendChild(coverDiv);
        //关闭事件
        $(frame).load(function(){
            var close = $(frame.contentDocument.body).find("#closeButton");
            if(close){
                close.on("click",function(){
                    wndProp.destroy();
                    $(".coverLayerDiv").remove();
                });
            }
        });
    };
    ...
    var getAction = function (graphStage, oprType) {
        switch (oprType) {
            case 'baseInfo':
                ...
                var fakeUrlForTest = hostUrl + 'flow/builder/fl_base.html';
                frame.setAttribute('src', fakeUrlForTest);
                frame.style.backgroundColor = 'white';
                var wndProp = utils.openFrameWnd(frame, '基本信息', 0.8);
            ...
            case 'emulation':
                ...
                frame.setAttribute('width', '100%');
                frame.setAttribute('height', '100%');
                var fakeUrlForTest = hostUrl + 'flow/builder/fl_emulation.html';
                frame.setAttribute('src', fakeUrlForTest);
                frame.style.backgroundColor = 'white';
                var wndProp = utils.openFrameWnd(frame, '流程仿真', 0.8);
                creatCoverBox(frame,wndProp);
                break;
            ...
            case 'acProperties':
                ...
                frame.setAttribute('width', '100%');
                frame.setAttribute('height', '100%');
                var fakeUrlForTest =  hostUrl +'/flow/builder/fl_ac.html';
                frame.setAttribute('src', fakeUrlForTest);
                frame.style.backgroundColor = 'white';
               var wndProp = utils.openFrameWnd(frame, '审批环节信息', 0.8);
                creatCoverBox(frame,wndProp);
                break;
            ...
            case 'ccProperties':
                ...
                frame.setAttribute('width', '100%');
                frame.setAttribute('height', '100%');
                var fakeUrlForTest = hostUrl + 'flow/builder/fl_cc.html';
                frame.setAttribute('src', fakeUrlForTest);
                frame.style.backgroundColor = 'white';
                var wndProp = utils.openFrameWnd(frame, '抄送节点信息', 0.8);
                creatCoverBox(frame,wndProp);
                break;
            ...
            case 'stepProperties':
                ...
                frame.setAttribute('width', '100%');
                frame.setAttribute('height', '100%');
                var fakeUrlForTest = hostUrl + 'flow/builder/fl_fork.html';
                frame.setAttribute('src', fakeUrlForTest);
                frame.style.backgroundColor = 'white';
                var wndProp = utils.openFrameWnd(frame, '条件表达式', 0.8);
                creatCoverBox(frame,wndProp);
                break;
            ...
            case 'forkProperties':
                ...
                frame.setAttribute('width', '100%');
                frame.setAttribute('height', '100%');
                var fakeUrlForTest = hostUrl + 'flow/builder/fl_fork_multi.html';
                frame.setAttribute('src', fakeUrlForTest);
                frame.style.backgroundColor = 'white';
                var wndProp = utils.openFrameWnd(frame, '条件网关', 0.8);
                creatCoverBox(frame,wndProp);
                break;
            ...
            case 'duplication':
                ...
                //frame.setAttribute('width', '100%');
                //frame.setAttribute('height', '100%');
                var fakeUrlForTest = hostUrl + 'flow/builder/fl_reference.html';
                frame.setAttribute('src', fakeUrlForTest);
                frame.style.backgroundColor = 'white';
                var wndProp = utils.openFrameWnd(frame, '流程配置-引用流程',0.9);
                creatCoverBox(frame,wndProp);
                break;
