...
function exportData(){  
	...
	var url = hostUrl+"flow/instanceStat/exportInstanceEfficiency"+paramText; 
...
function exportData_01(){  
	...
	$.ajax({  
        type: 'GET',  
        url: hostUrl+"flow/instanceStat/exportInstanceEfficiency",  
...
function gotoDetail(statType, statWay, statWayId){
	...
	var url = encodeURI(hostUrl+"flow/stat/instance_effiency_detail.html?statWayId="+statWayId+"&statType="+statType+"&statWay="+statWay
...
function initStatGridList(){
	...
	var urlText = hostUrl+"/flow/instanceStat/statInstanceEfficiency";
	var colModel = [ 
