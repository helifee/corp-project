...
define(['sidebar', 'toolbar', 'actions', 'utils'], function (sidebar, toolbar, actions, utils) {
    ...
    var setContextMenu = function (container, graphStage) {
        ...
        function createPopupMenu(graph, menu, cell, evt) {
            if (cell != null) {
                menu.addItem('剪切', hostUrl + 'flow/runtime/modify/images/editor/toolbar/cut.png', function () {
                    actions.getAction(graph, 'cut');
                });
                menu.addItem('复制',hostUrl + 'flow/runtime/modify/images/editor/toolbar/copy.png', function () {
                    actions.getAction(graph, 'copy');
                });
                menu.addItem('粘贴', hostUrl + 'flow/runtime/modify/images/editor/toolbar/paste.png', function () {
                    actions.getAction(graph, 'paste');
                });
                menu.addItem('删除', hostUrl + 'flow/runtime/modify/images/editor/toolbar/delete.png', function () {
                    actions.getAction(graph, 'delete');
                });
                /*menu.addItem('前加签', '', function () {
                    actions.getAction(graph, 'preAdd');
                });
                menu.addItem('后加签', '', function () {
                    actions.getAction(graph, 'behindAdd');
                });*/
            } else {
