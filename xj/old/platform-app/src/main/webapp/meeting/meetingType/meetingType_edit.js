...
function judgeChildIdByTargetId(parentId,childId){
    ...
    paramData = JSON.stringify({'parentId':parentId,'childId':childId});
		$.ajax({
			type:'post',
			url:hostUrl+'oa/meeting/meetingType/judgeChildIdByTargetId'+"?time="+Math.random(),
			dataType:'json',
...
function getMeetingTypeData(id){
	$.ajax({
        type:'get',
        url:hostUrl+"oa/meeting/meetingType/get/"+id+'?time='+Math.random(),
        success: function(data) {
        	if(data.success){
...
function saveForm(op){
	...
	var meetingTypeDto={};
		...
		if(type=="add"){
			...
			$.ajax({
				url:hostUrl+"oa/meeting/meetingType/save",
			...
			var ids=meetingTypeDto.id;
			   $.ajax({
			       url:hostUrl+"/oa/meeting/meetingType/update/"+ids,
			       data:JSON.stringify(meetingTypeDto),
			       type:'put',
			       contentType:'application/json',
			       dataType:'JSON',
...
function judgeRepeatObject(meetingTypeDto){
	var tar;
		$.ajax({
			type:'post',
			url:hostUrl+'oa/meeting/meetingType/judgeRepeatObject'+"?time="+Math.random(),
			dataType:'json',
			contentType:'application/json',
			data:JSON.stringify(meetingTypeDto),
			async: false,
