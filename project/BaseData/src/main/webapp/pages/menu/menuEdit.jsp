...
<form id="ff">
	<table cellpadding="5">
		...
		<tr>
			<td>功能选择:</td>
			<td><select class="easyui-combogrid" id="operation" name="operation" style="width:260px;height:60px;" data-options="multiline:true,editable:false"></select></td>
		</tr>
		<tr>
			<td>已选择:</td>
			<td id="selectedOperation"></td>
		</tr>
		<tr>
			<td>审核意见:</td>
