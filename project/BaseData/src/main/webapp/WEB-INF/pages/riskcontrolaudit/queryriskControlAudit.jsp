                           ...
                           <c:forEach items="${datas}" var="item">
	                           <tr>
	                             <td>${item.EId }</td>
	                              <td>${item.EName }</td>
	                              <td>${item.EStatus }</td>
	                              <td>${item.chkStatus }</td>
	                              <td><fmt:formatDate value="${esEproductInfo.item.EDueDate }" pattern="yyyy-MM-dd"/></td>
	                              <td>
	                                <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#business-management-model-detail">审核</a>
	                              </td>
	                           </tr>
	                         </c:forEach>
                          </tbody> --%>
        ...
        <div class="modal-content business-managementlogin-form-area">
                ...
                <div class="modal-body business-management-tab-content">
                            ...
                            <ul class="clearfix">
                                <li class="clearfix">
                                    ...
                                    <div class="site-main-filter-box  project-lg">
                                        ...
                                        <input class="text" type="text" name="arrpId"/>
                                    </div>
                                    <div class="site-main-filter-box  project-lg">
                                        <label>ICP证编号 </label>
                                        <input class="text" type="text" name="icpId"/>
                                    </div>
                                    <div class="site-main-filter-box  project-lg">
                                ...
                                <li>
                                    ...
                                    <div class="site-main-filter-box  project-small" id="event_period">
                                        ...
                                        <input class="text" type="text" name="eDueDate"/>
                                        <span class="interval">至</span>
                                        <input class="text" type="text" name="eDueDate"/>
                                    </div>
                                    <div class="site-main-filter-box  project-lg">
                                        <label>备注</label>
                                        <textarea class="textarea" rows="2" name="remark"></textarea>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <ul class="clearfix">
                                <li class="clearfix">
                                    <div class="site-main-filter-box  project-lg">
                                        ...
                                        <input class="text" type="text" name="corpOwnerNm"/>
                                    </div>
                                    <div class="site-main-filter-box  project-lg">
                                        <label><i>*</i>法定代表人证件类型</label>
                                        <input class="text" type="text" name="ownerCertTp"/>
                                    </div>
                                    <div class="site-main-filter-box  project-lg">
                                        <label><i>*</i>法定代表人证件号码</label>
                                        <input class="text" type="text" name="ownerCertId"/>
                                    </div>
                                    <div class="site-main-filter-box  project-small" id="event_period">
                                        <label><i>*</i>营业期限</label>
                                        <input class="text" type="text" name="bizBeginDate"/>
                                        <span class="interval">至</span>
                                        <input class="text" type="text" name="bizEndDate"/>
                                    </div>
                                ...
                                <li>
                                    <div class="site-main-filter-box  project-lg">
                                        ...
                                        <input class="text" type="text" name="regCapital" value="${esEproductInfo.regCapital}"/>
                                    </div>
                                    <div class="site-main-filter-box  project-small" id="event_period">
                                        <label><i>*</i>成立日期</label>
                                        <input class="text" type="text" name="corpEstDate" value="${esEproductInfo.corpEstDate}" />
                                        <span class="interval">至</span>
                                        <input class="text" type="text" name="corpEstDate" value="${esEproductInfo.corpEstDate}" />
                                    </div>
                                    <div class="site-main-filter-box  project-lg">
                                        <label>住所</label>
                                        <input class="text" type="text" name="" value="${esEproductInfo.属性名}"/>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <ul class="clearfix">
                                    <li class="clearfix">
                                        ...
                                        <div class="site-main-filter-box  project-lg">
                                            ...
                                            <input class="text" type="text" name="bizCommodity"/>
                                        </div> 
                                        <div class="site-main-filter-box  project-lg">
                                            <label><i>*</i>行业大类</label>
                                            <select name="select" class="select" name="industryNo"/>
                                                <option>请选择</option>
                                                <option>类型一</option>
                                                <option>类型二</option>
                                            </select>
                                        ...
                                        <div class="site-main-filter-box  project-lg">
                                            ...
                                            <input class="text" type="text" name="subIndustryNo"/>
                                        </div>
                                        <div class="site-main-filter-box  project-lg">
                                            <label>网站地址</label>
                                            <input class="text" type="text" name="webAddr"/>
                                        </div>
                                        <div class="site-main-filter-box  project-lg">
                                            <label>企业电话</label>
                                            <input class="text" type="text" name="telNo"/>
                                        </div>
                                        <div class="site-main-filter-box  project-lg">
                                            <label><i>*</i>信用级别</label>
                                            <input class="text" type="text" name="creditLvl" />
                                        </div>   
                                    </li>
                                    <li>
                                        <div class="site-main-filter-box  project-lg">
                                        ...
                                        <div class="site-main-filter-box  project-lg">
                                            <label>企业行业描述</label>
                                            <input class="text" type="text" name="industryDesp"/>
                                        </div>
                                        <div class="site-main-filter-box  project-lg">
                                            <label><i>*</i>经营范围（主业）</label>
                                            <textarea class="textarea" rows="2" name="bizScope"/>
                                        </div>
                                        <div class="site-main-filter-box  project-lg">
                                            <label>经营范围（副业）</label>
                                            <textarea class="textarea" rows="2" name="subBizScope" ></textarea>
                                        </div>
                                    </li>
                                </ul>
                                <div class="line-dashed-xl"></div>
                        ...
                        <div class="contacts-information clearfix">
                           <ul class="clearfix" id="esContact1"  style="display: none">
                                ...
                                <li>
                                   <div class="site-main-filter-box  project-lg">
                                       <label><i>*</i>类型</label>
                                       <input class="text" type="text" name="contactorTp"/>
                                   </div>
                                   <div class="site-main-filter-box  project-lg">
                                       <label><i>*</i>姓名</label>
                                   ...
                                   <div class="site-main-filter-box  project-lg">
                                       <label><i>*</i>邮箱</label>
                                       <input class="text" type="text" name="contactorMail"/>
                                   </div>  
                                </li>
                                <li>
                                    <div class="site-main-filter-box  project-lg">
                                        <label><i>*</i>手机</label>
                                        <input class="text" type="text" name="contactorCell"/>
                                    </div>
                                    <div class="site-main-filter-box  project-lg">
                                        <label>座机</label>
                                        <input class="text" type="text" name="contactorTel"/>
                                    </div>  
                                    <div class="site-main-filter-box  project-lg">
                                        <label>传真</label>
                                        <input class="text" type="text" name="contactorFax"/>
                                    </div>    
                                </li>
                            </ul>
                            <ul class="clearfix" id="esContact2" style="display: none">
                                <div class="title">联系人（2 ） </div>
                                 <li>
                                   ...
                                   <div class="site-main-filter-box  project-lg">
                                       <label><i>*</i>姓名</label>
                                       <input class="text" type="text" name="contactorNm"/>
                                   </div>
                                   <div class="site-main-filter-box  project-lg">
                                       <label><i>*</i>邮箱</label>
                                       <input class="text" type="text" name="contactorMail"/>
                                ...
                                <li>
                                    <div class="site-main-filter-box  project-lg">
                                        <label><i>*</i>手机</label>
                                        <input class="text" type="text" name="contactorCell" value="${esContactInfoChktemp.contactorCell}" />
                                    </div>
                                    <div class="site-main-filter-box  project-lg">
                                        <label>座机</label>
                                        <input class="text" type="text" name="contactorTel" value="${esContactInfoChktemp.contactorTel}" />
                                    </div>  
                                    <div class="site-main-filter-box  project-lg">
                                        <label>传真</label>
                                        <input class="text" type="text" name="contactorFax" value="${esContactInfoChktemp.contactorFax}" />
                                    </div>    
                                </li>
                            </ul>  
                        </div>
                        <div class="product-selection">
                            ...
                            <ul class="clearfix">
                                <li><input type="checkbox" class="checkbox" name="" value="${esEproductInfo.属性名}"/>企业付款</li>
                                <li><input type="checkbox" class="checkbox" name="" value="${esEproductInfo.属性名}"/>代发工资</li>
                                <li><input type="checkbox" class="checkbox" name="" value="${esEproductInfo.属性名}"/>企业报销</li>
                                <li><input type="checkbox" class="checkbox" name="" value="${esEproductInfo.属性名}"/>资金划拨</li>
                            </ul>
...
<script src="../js/Management-Tab.js"></script>
...
<script type="text/javascript">
    ...
    // 初始列表数据
    $.ajax({
		url:"${www_url}/risk/queryRiskVerifyDatas",
		type:"POST",
		//async:false,
		data:{
		},
...
$("#querySumbit").click(function(){
    ...
    $.ajax({
		...
		data:{
			...
			opeType:$("#opeType").val(),						       // 操作类型
			joinStartDate:$("#joinStartDate").val(),		//入网开始时间 	格式 yyyy-MM-dd
 ...
 // 点击审核时加载数据
    function getEsEnterpriseInfoChktempByEid(eid){
      $.ajax({
   		url:"${www_url}/risk/getEsEnterpriseInfoChktempByEid",
   		//type:"POST",
   		async:false,
   		data:{
   			eid:eid					// 企业编号
