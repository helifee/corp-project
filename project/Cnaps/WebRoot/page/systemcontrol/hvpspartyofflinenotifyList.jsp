...
<body>
<html:form  method="post" action="/hvpspartyofflinenotifyAction.do?method=findList">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">强制离线通知查询</span></div>
                					</td>
                				</tr>
                			</table>   
              ...
              <table width="95%" class="tbcolor" >
                ...
                <logic:present name="queryList">
                  ...
                  <td  class="text_list">${po.recvbranch }</td>
                    <td  class="text_list">${po.syscd }</td>
