...
<html>
   ...
   A105 =[A01300,A09001];	
	...
	function businessClassCodedf(value,name){
		...
		document.getElementById("certnum").value=obj.certnum;
		document.getElementById("phone").value=obj.phone;
		document.getElementById("address").value=obj.address;
		document.getElementById("payName").value=obj.name;
		...
		document.getElementById("payerAcount").value=obj.payerAcount;
		document.getElementById("payBankNum").value=obj.dbtrBrnchId;//付款 行行号
		document.getElementById("payBankName").value=obj.dbtrBrnchNm;//付款 行名称
		document.getElementById("payOpenBankNum").value=obj.applyOpenBankNum;
		document.getElementById("payOpenBankName").value=obj.applyOpenBankName;
		document.getElementById("dbtrmmbid").value=obj.dbtrMmbId;
		document.getElementById("proposerCstmrId").value=obj.proposerCstmrId;	 
		document.getElementById("totalentryMoney").value=obj.totalentryMoney;	
		document.getElementById("totalentry").value=obj.totalentry;
...
var totalentry  = document.getElementById("totalentry");
				...
				if(boo){
				 		...
				 		if(totalentryMoney==rmoney(moneyNum.value)){
	...
	<body >
		<form  name="form1" method="post"
			...
			<!-- 总账签发 -->
			<input id="cardcrash" name="po.signMd" type="hidden" value="04">
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">定期贷记总账</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
															...
															<tr>
																...
																<td  >
																	<input name="po.counterfoil" id="counterfoil" type="text" readonly="readonly"
																		title="工本费" maxlength="12" readonly="readonly"
																		onKeyPress="amountPress()"
																		onkeyup="value=value.replace(/[^\d.,]/g,'')  "
																		onblur="value=fmoney(value, 2);if(value == 'NaN.undefined') value = '';" />
