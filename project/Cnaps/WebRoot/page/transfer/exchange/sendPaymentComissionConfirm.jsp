...
<body>
<html:form  method="post"  action="/TransProcessAction.do?method=querySendxml&operway=10">
		...
		<tr>
	  	...
	  	<tr valign="top">
	    	...
	    	<td >
	      			...
	      			<input type="hidden" name="po.status" size="32" maxlength="32" value="PR81"/>
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="O">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">发出委托收款复核</span></div>
                					</td>
                				</tr>
                			</table>
