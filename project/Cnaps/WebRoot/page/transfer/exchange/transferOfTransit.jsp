...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=path%>/js/transfer/transferOfTransit.js"></script>
...
<script language="javascript">
	...
	function  PubQueryAccount(paymentGroupNum){
		document.getElementById("dbtramtacctid").value=document.getElementById("dbtracctid").value;
					...
					PubService.QueryAccount(paymentGroupNum,function(obj){
						 ...
						 if(obj==null||obj.acctid==null){
						      ...
						      document.getElementById("proposercstmrid").value=obj.cstmrid==null?"": obj.cstmrid;//付款人客户号
						       ...
						       document.getElementById("dbamtnm").value=obj.mm==null?"": obj.mm;//名称
	...
	<body onload="selectLoad();">
		<form method="post"
			action="<%=path%>/transferOfTransitAction.do?method=sendMessage&signmd=03" name="form1">
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">国内转账汇款</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
                                                      ...
                                                      <tr>
                                                      	<td colspan="4"><span class="text_tablehead">基本信息</span></td>
																...
																<td>
																	...
																	<span name="validate" dataName="sttlmprty" dataType="Empty" msg="优先级不能为空！" class="STYLE1">*</span>
																</td>
															...
															<tr>
																...
																<td>
																	...
																	<span name="validate" dataName="pmttp" dataType="Empty" msg="业务类型编码不能为空！" class="STYLE1">*</span>
																</td>
																<td class="text_tablehead_b" >
																	业务种类编码
																</td>
                                                ...
                                                <div class="table_content">
                                                   	<table>
	                                                   	...
	                                                   	<tr>
																...
																<td>
																<input name="dbtramtacctid" type="hidden"  title="扣款账号" maxlength="32"/>
																<input name="dbamtnm" type="hidden"  title="扣款户名" maxlength="32"/>
															...
															<td class="text_tablehead_b"  >
																...
																<td >
																	<input name="appcertno" id="sgrzjh" type="text" readonly="readonly"  size="19" onblur="checkIdCardNo(this.value,'sgrzjh')"
																...
																<td >
																	 <input type="text"  maxlength="30" name="proposercstmrid" id="proposercstmrid" title="付款人客户号" 
																	 	id="sqrkhh" readonly="readonly">
															<span name="validate" dataName="proposercstmrid" dataType="Empty" msg="付款人客户号不能为空！" class="STYLE1">*</span>
																</td>
																...
																<td>
																	...
																	<span name="validate" dataName="proposeraccttp" dataType="Empty" msg="付款人账户类型不能为空！" class="STYLE1">*</span>	 
																</td>
															...
															<tr>
																...
																<td>
																	<input name="cdtracctnm" id="skhmc" type="text"
																		 title="收款人行名称" maxlength="60" readonly="readonly"
																		onKeyPress="actkeyPress()" />
																...
																<tr>
																	...
																	<td colspan="3">
																		<input name="ntryamt" id="hkje" type="text"
																			...
																			onKeyPress="amountPress()"
																			onkeyup="value=value.replace(/[^\d.,]/g,'')  "
																			onblur="value=fmoney(value, 2);if(value == 'NaN.undefined') value = ''; jisuan();addchange(this.value);" />
															...
															<tr id="A1041" style="display: none;">
																...
																<td>
																	<input name="gkallchange" id="mxhzje104" type="text" 
																		...
																		onkeyup="value=value.replace(/[^\d.,]/g,'')  "
																		onblur="value=fmoney(value, 2);if(value == 'NaN.undefined') value = '';" /><span name="validate" dataName="paymentno" dataType="Empty" msg="支付交易组号不能为空！" class="STYLE1">*</span>
																...
																<td>
																	<input name="gksendcode" id="sbgkdm104" type="text"
																		title="上报国库代码" maxlength="10" /><span name="validate" dataName="paymentno" dataType="Empty" msg="支付交易组号不能为空！" class="STYLE1">*</span>
															...
															<tr id="A1042" style="display: none;">
																...
																<td>
																	<input name="gkreceivecode" id="jsgkdm104" type="text" 
																		title="接收国库代码" maxlength="10" /><span name="validate" dataName="paymentno" dataType="Empty" msg="支付交易组号不能为空！" class="STYLE1">*</span>
																...
																<td>
																	<input name="gktabledate" id="bbrq104" type="text"  value="${sessionScope.workFormatDate } "
																		...
																		onclick="WdatePicker()" /><span name="validate" dataName="paymentno" dataType="Empty" msg="支付交易组号不能为空！" class="STYLE1">*</span>
