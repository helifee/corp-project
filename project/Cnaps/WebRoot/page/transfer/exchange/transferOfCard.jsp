...
<script language="javascript">
	...
	<body onload="selectLoad();">
		<form method="post"
			action="<%=path%>/transferOfTransitAction.do?method=sendMessage&signmd=02" name="form1">
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">国内卡折汇款</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
                                                      ...
                                                      <tr>
                                                      	<td colspan="4"><span class="text_tablehead">基本信息</span></td>
															...
															<tr>
																...
																<td >
																	<input name="paymentno" id="" type="hidden"  readonly="readonly" value="${entity.paymentno }"
																		maxlength="19" title="支付交易组号" />
                                                 		...
                                                 		<tr>
																...
																<input name="dbamtnm" type="hidden"  title="扣款户名" maxlength="32"/>
																	<input name="dbtracctid" id="fkrzh" type="text" onblur="PubQueryAccount(this.value)"
																		...
																		onKeyPress="actkeyPress()" /><span name="validate" dataName="dbtracctid" dataType="Empty" msg="付款人账号不能为空！" class="STYLE1">*</span>
																</td>
																<td class="text_tablehead_b" >
																	付款人名称
																</td>
																<td>
																	<input name="dbtrnm" id="fkrmc" type="text"
																		...
																		onKeyPress="charPress()" /><span name="validate" dataName="dbtrnm" dataType="Empty" msg="付款人名称不能为空！" class="STYLE1">*</span>
																</td>
                                                  			</tr>
                                                  			<tr>
															<td class="text_tablehead_b"  >
																...
																<td>
																	<input type="hidden" name="certtype" id="zjlx" value=""/>
																		<select   name="certtype1" id="zjlx1" disabled="disabled">
																		<option value="">
																			请选择
																		</option>
																...
																<td >
																	<input name="appcertno" id="sgrzjh" type="text"  size="19" onblur="checkIdCardNo(this.value,'sgrzjh')"
																		maxlength="32" title="付款人证件号"  readonly="readonly"/>
																...
																<td >
																	 ...
																	 <input type="text"  maxlength="30" name="proposercstmrid" id="proposercstmrid"
																	  title="付款人客户号" readonly="readonly" id="sqrkhh"><span name="validate" dataName="proposercstmrid" dataType="Empty" msg="付款人客户号不能为空！" class="STYLE1">*</span>
																...
																<td>
																	<input name="proposeraccttp" id="sqrzhlx" type="hidden" value=""/>
																		 <select  name="proposeraccttp1" id="sqrzhlx1" title="付款人账户类型" disabled="disabled">
                                    				...
                                    				<tr>
																...
																<td>
																	<input  name="appphone" id="sqrlxdh" type="text" readonly="readonly"
																		 maxlength="15" title="付款人联系电话" /><span name="validate" dataName="appphone" dataType="Empty" msg="付款人联系电话不能为空！" class="STYLE1">*</span>
																</td>
																</tr>
                                                   	...
                                                   	<table>
	                                                 	  ...
	                                                 	  <tr>
															...
															<tr>
																...
																<td>
																	<input name="cdtrissr" id="skhkhhhh" type="hidden" class="text_tablehead_b_c" readonly="readonly"
															...
															<td class="text_tablehead_b" >
																...
																<td>
																	<input name="cdtrissrnm" id="skrkhhmc" type="hidden"  readonly="readonly"
                                                   	...
                                                   	<table>
	                                                 	  ...
	                                                 	  <tr>
															...
															<tr id="A1091" style="display: none;">
																...
																<td>
																	<input name="collectiondate" id="pjrq109" class="Wdate" type="text" value="" 
															...
															<tr id="A1101" style="display: none;">
																...
																<td>
																	<input id="pjrq110" type="text"  name="honourdate" value="" readonly="readonly"
															...
															<tr id="A2011" style="display: none;">
																...
																<td>
																	<input name="chkdate" id="pjrq201" type="text" value=""
