											...
											<tr>
												<td>
													<div class="text_title">
														<span class="text_blue2">跨境现金汇款</span>
													</div>
												</td>
											</tr>
											<tr>
													...
													<div class="table_body">
														<div class="table_content">
															<table>
																...
																<tr>
																	...
																	<td>
																		<select name="signpertype" title="签发人类型">
																			<option value="0">
																				非金融机构
																			</option>
																			<option value="1">
														...
														<div class="table_content">
															<table>
																...
																<td>
																<input name="accptncdt" type="text" readonly="readonly"
																	title="关联业务委托日期" class="Wdate" onclick="WdatePicker()" />
																</td>
																</tr>
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="sndbkchrg"
																			title="发报行收费"/>
																	</td>
																</tr>
																...
																<tr>
																	...
																	<td>
																		<input name="rcvbkchrg" type="text"
																			title="收报行收费" />
																	</td>
																</tr>
																<tr>
																	...
																	<td colspan="3">
																		<textarea name="crossbrdrpstaddtlinf" rows="2" cols="60"></textarea>
																	</td>
