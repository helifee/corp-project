					...
					PubService.QueryAccount(paymentGroupNum,function(obj){
						 ...
						 if(obj==null||obj.acctid==null){
						      ...
						      document.getElementById("dbtrnm").value=obj.mm==null?"": obj.mm;//名称
						       document.getElementById("sqrzhlx").value=obj.accttp==null?"": obj.accttp;//付款人账户类型 
                                           		 ...
                                           		 <table >
                                                      ...
                                                      <tr>
                                                      	<td colspan="4"><span class="text_tablehead">基本信息</span></td>
																...
																<input type="hidden" id="xth"  name="systemcd" title="系统号" value="HVPS" onChange="selectsyscode(this.value,'ywlxbmval');"> 
                                                   	...
                                                   	<table>
                                                 		...
                                                 		<tr>
															<td class="text_tablehead_b"  >
																...
																<td >
																	 <input type="text"  maxlength="30" name="proposercstmrid" id="proposercstmrid" title="付款人客户号" id="sqrkhh">
															...
															<tr>
																...
																<td>
																	<input name="cdtrissr" id="skhkhhhh" type="hidden" class="text_tablehead_b_c"
																		 title="收款行开户行行号" maxlength="12"  value="123"  
																		  />
																</td>
																...
																<td>
																	<input name="cdtrissrnm" id="skrkhhmc" type="hidden"  
																		title="收款人开户行名称" maxlength="60" value="123"
																		onKeyPress="actkeyPress()" />
																</td>
															</tr>
