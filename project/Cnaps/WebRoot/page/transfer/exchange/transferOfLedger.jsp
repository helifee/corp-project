...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=path%>/js/transfer/transferOfLedger.js"></script>
...
<script language="javascript">
	...
	function queryBypaymentGroupNum(paymentGroupNum){
        ...
        PubService.queryOthersBankAccountMsg(paymentGroupNum,function(obj){
		  ...
		  if(obj==null||obj.accountnumber==null){
			  ...
			  document.getElementById("skhhh").value= obj.issuer==null?"": obj.issuer ;   
			  document.getElementById("skhmc").value=obj.issuernm==null?"":obj.issuernm ;
	...
	function  PubQueryAccount(paymentGroupNum){
					...
					PubService.QueryAccount(paymentGroupNum,function(obj){
						 ...
						 if(obj==null||obj.acctid==null){
						 	 ...
						 	 document.getElementById("fkrzh").value="";
						 	  document.getElementById("fkrmc").value="";
						  	 return;
						 }else{
						 	if(document.getElementById('pmttp').value!=null&&document.getElementById('pmttp').value!='A200'){
			...
			function setSignmethod(pmttp){
				if(pmttp=="A104"||pmttp=="A307"||pmttp=="A200"||pmttp=="A106"){
					document.getElementById('signpertype').value=1;
				}else{
					document.getElementById('signpertype').value=0;
				}
				if(pmttp=="A200"){//行间资金汇划
					document.getElementById("fkrzh").readOnly="readnoly";
					document.getElementById("dbtrnm").readOnly="readnoly";
					document.getElementById("cdtracctid").readOnly="readnoly";
					document.getElementById("cdtrnm").readOnly="readnoly";
					document.getElementById("cdtraddr").readOnly="readnoly";
					
				}else{
					document.getElementById("fkrzh").readOnly="";
					document.getElementById("dbtrnm").readOnly="";
					document.getElementById("cdtracctid").readOnly="";
					document.getElementById("cdtrnm").readOnly="";
					document.getElementById("cdtraddr").readOnly="";
				}
			}
			function commitForm(){
			if(VForm.Validate()){
				...
				var pjje201 =document.getElementById('pjje201');//支票业务 票据金额
				var pj201 =document.getElementById('pj201');//支票业务 牌价
				...
				//支票 金额
				if(pjje201.value.replace(reg, "")!=""){
				    var number = pjje201.value.replace(reg, "");
				   	pjje201.value = number.replace(/[^\d\.-]/g, "");
				}
				//支票 牌价
				if(pj201.value.replace(reg, "")!=""){
				    var number = pj201.value.replace(reg, "");
				   	pj201.value = number.replace(/[^\d\.-]/g, "");
				}
			...
			function jisuan(){
				...
				if(aa=='A104'){
					...
					document.getElementById("hkje").value=fmoney(n,2);
					document.getElementById("gzallchange").value=fmoney(n,2);
					document.getElementById("ze").value = fmoney(rmoney(sxf)+rmoney(ydf)+rmoney(ydjs)+n, 2);
				}else{
	...
	<body onload="selectLoad();">
		<form method="post"
			action="<%=path%>/transferOfTransitAction.do?method=sendMessage&signmd=04" name="form1">
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">国内总账汇款</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
															...
															<td class="text_tablehead_b" >
																...
																<td>
																	<select name="pmttp" id="ywlxbmval" 
																		onChange="transferOfClient(this.value,'select_input');changehkle(this.value,'hkje');clrAmt();setSignmethod(this.value);clrContent();">
                                                ...
                                                <div class="table_content">
                                                   	<table>
	                                                    ...
	                                                    <tr>
																...
																<td>
																	<input name="dbtrnm" id="fkrmc" type="text" readonly="readonly"
                                                 		...
                                                 		<tr>
															<td class="text_tablehead_b"  >
																...
																<td >
																	<input name="appcertno" id="sgrzjh" type="text" size="19" onblur="checkIdCardNo(this.value,'sgrzjh')" readonly="readonly"
																...
																<td >
																	 <input type="text"  maxlength="30" name="proposercstmrid" readonly="readonly"
																		 id="proposercstmrid" title="付款人客户号" id="sqrkhh">
																</td>
																...
																<td>
																		<input type="hidden"  name="proposeraccttp"id="sqrzhlx">
                                                  			...
                                                  			<tr>
																...
																<td colspan="3">
																	<input name="dbtraddr" id="fkrdz" class="text_tablehead_b_addr" readonly="readonly"
                                                  			...
                                                  			<tr>
																...
																<td>
																	<input name="dbtramtacctid" id="kkzh" type="text" 
																		...
																		onKeyPress="actkeyPress()" /> <span name="validate" dataName="dbtramtacctid" dataType="Empty" msg="扣款账号不能为空！" class="STYLE1">*</span>
																</td>
															...
															<tr>
																...
																<td>
																	<input name="cdtracctnm" id="skhmc" type="text"
																		...
																		onKeyPress="actkeyPress()" />
																		<span name="validate" dataName="cdtracctnm" dataType="Empty" msg="收款行名称不能为空！" class="STYLE1">*</span>
																</td>
															</tr>
																<tr>
	                                                 	  ...
	                                                 	  <tr>
															...
															<tr id="A1041" style="display: none;">
																...
																<td class="text_tablehead_b">
																				...
																				<td>
																					<input type="text" name="gkflowno"
																						id="gkflowno" maxlength="10" title="信息流水号" />
															...
															<tr id="A1043" style="display: none;">
																...
																<td>
																	<input name="gktabledate" id="bbrq104" type="text"  value="${sessionScope.workFormatDate } "
															...
															<tr id="A1045" style="display: none;">
																...
																<td>
																	<input name="gkcount" id="listnum1" type="text" readonly="readonly"
																		 value="1" />
																<span  class="STYLE1">*</span>
																</td>
															</tr>
															...
															<tr>
																<td>
																<div id="hjzjhhdetails" style="display: none;">
																	<table>
																...
																<td>
																	<input name="interBkLnRt" id="interBkLnRt" type="text" 
																		title="拆借利率" maxlength="7" onKeyPress="amountPress()" /><span  class="STYLE1">*</span>
																...
																<td>
																	<input name="interBkLmt" id="interBkLmt" type="text"  value="" title="拆借期限" maxlength="5"
																	 onKeyPress="amountPress()" /><span  class="STYLE1">*</span>
															...
															<tr>
																<td>
																<div id="gkzjgzdfdjhbdetails" style="display: none;">
																		<table id="gz_mx" border="0" cellpadding="0"
																			...
																			<tr>
																				...
																				<td>
																					<input type="text" name="gzallchange"
																						id="gzallchange" readonly="readonly" />
																					<font color="#FF0000">*</font>
																				</td>
																				<td class="text_tablehead_b">
																					信息流水号
																				...
																				<td>
																					<input type="text" name="gzflowno"
																						id="gzflowno" maxlength="10" />
																					<font color="#FF0000">*</font>
																				</td>
																			...
																			<tr>
																				...
																				<td>
																					<input type="text" name="gzsendcode"
																						id="gzsendcode" maxlength="10"
																				...
																				<td>
																					<input type="text" name="gzreceivecode" id="gzreceivecode"
																			...
																			<tr>
																				...
																				<td>
																					<input type="text" name="gztabledate"
																						id="gztabledate" readonly="readonly"
																						class="Wdate" onclick="WdatePicker()" />
																					<font color="#FF0000">*</font>
																				</td>
																				<td class="text_tablehead_b">
																				...
																				<td>
																					<input type="text" name="gztableid"
																						id="gztableid" maxlength="10"
																						onkeyup="fun_number(this)"
																						onblur="fun_number(this)" />
																					<font color="#FF0000">*</font>
																				</td>
																			...
																			<tr>
																				...
																				<td>
																					<input type="text" value="1"
																						name="gzcount" id="gz_numoftrnsctns"
																						readonly="readonly" />
																					<font color="#FF0000">*</font>
																				</td>
																			</tr>
