...
<script language="javascript">
	...
	function chargeQuery()
	{
	  ...
	  var money=self.parent.document.getElementById("amount").value;//汇款金额
	  var radsyscd =document.getElementById("radsyscd").value;//系统编号
					 
					data = [
                       {
                          msgtpcd:"beps.133.001.01", 
                          money:"123",
                          pmttp:"E102"
                       },
                        {
					...
					PubService.chargeQuerylist(data,function(obj){
