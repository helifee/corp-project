 ...
 　　}
	...
	<body onload="sendDate()">
		<form  name="form1" method="post"
			action="<%=path%>/ActivePaymentAction.do?method=paymentQuery">
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">主动缴款查询</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
													 ...
													 <tr>
                                                      	<td colspan="4"><span class="text_tablehead">基本信息</span></td>
															...
															<tr>
																...
																<td>
																		<input name="po.instgInDrctPty" id="instgInDrctPty" type="text" 
														readonly=readonly		value="${bankInfo.bankcode }"					maxlength="19" title=" 发起间接参与机构行号"  />
															...
															<td class="text_tablehead_b"  >
																...
																<td >
																<input style="width:180px;" name="po.chrgId" id="chrgId" type="text" size="19"
																...
																<td>
																<input name="po.corprtnId" id="corprtnId" type="text"  
																...
																<td >
																	<input style="width:180px;" name="po.cstmrId" id="cstmrId" type="text" size="19"
