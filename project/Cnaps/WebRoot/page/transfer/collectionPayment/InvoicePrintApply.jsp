 ...
 　　}
	...
	<body onload="sendDate()">
		<form  name="form1" method="post"
			action="<%=path%>/ActivePaymentAction.do?method=invoicePrintApply">
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">发票打印申请</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
                                           		<div class="table_body">
													 ...
													 <tr>
                                                      ...
                                                      <tr>
																...
																<td >
																<input name="poPrint.pmtGrpId" id="pmtGrpId" type="text" readonly="readonly"
																...
																<td >
																<input style="width:180px;" name="poPrint.systemCd" id="systemCd" type="text" size="19"
																value="BEPS" readonly="readonly"		maxlength="19"  />	<font color=red>*</font>																	
															...
															<tr>
																...
																<td>
																		<input name="poPrint.instgDrctPty" id="instgDrctPty" type="text" 
															readonly=readonly			maxlength="19" title=" 发起直接参与机构"  value="${bankInfo.directbankcode }"  />
															...
															接收直接参与机构																</td>
																<td >
																<input name="poPrint.instdDrctPty" id="instdDrctPty" type="text"  
															maxlength="19" 	  title="接收直接参与机构" maxlength="22"
																		  />
																		<font color=red>*</font>
																</td>
															</tr>
																...
																<td>
																<input name="poPrint.instgPty" id="instgPty" type="text"  
																readonly=readonly		value="${bankInfo.bankcode }"			style="width: 180px;" title="发起参与机构行号" maxlength="22"
																		  />
																	<font color=red>*</font>
																</td>
																<td class="text_tablehead_b" >
																...
																<td >
																	...
																	<input style="width:180px;" name="poPrint.instdPty" id="instdPty" type="text" size="19"
																		maxlength="19" title="接收参与机构行号" />	<font color=red>*</font>																	
																</td>
															</tr>
															...
															<td class="text_tablehead_b"  >
																...
																<td >
																		<select  name="poPrint.pmtkd" id="pmtkd">
																...
																<td >
																<input style="width:180px;" name="poPrint.invcId" id="invcId" type="text" size="19"
																		maxlength="19" title="发票标识" />	<font color=red>*</font>																	
																...
																<td>
																<input name="poPrint.corprtnId" id="corprtnId" type="text"  
																...
																<td >
																	<input style="width:180px;" name="poPrint.usrId" id="usrId" type="text" size="19"
															...
															<tr>
																...
																<td>
																<input name="poPrint.invcDt" id="invcDt" type="text"  
																		style="width: 180px;" title="企业标识" maxlength="22"
																		  />
																	<font color=red>*</font>
																</td>
