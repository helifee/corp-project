				...
				<tr valign="top">
					...
					<td style="FILTER: progid:DXImageTransform.Microsoft.Gradient(gradientType=0,startColorStr=#FFFFFF,endColorStr=#FFFFFF);">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
			              ...
			              <tr>
			               		<td  class="text_details_L">收款人数目：</td>
			               		<td  class="text_details_R">${sap.cdtrNb}</td>
			                ...
			                <tr>
			               		<td  class="text_details_L">成功收款总金额：</td>
			               		<td  class="text_details_R">${sap.sndgTtlAmt}</td>
			               		<td  class="text_details_L">	成功收款总笔数：</td>
			               		<td  class="text_details_R">${sap.sndgTtlNb}	</td>
			               </tr>
			              <tr>
