          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2">批量代收查询</span></div></td><td width="781"></td>
                </tr>
              </table>
			 <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_head">
               <tr>
                ...
                <tr>
             		 ...
             		 <td id="zfjyzh_td" >
				                  		<html:text property="bc.btchNb" maxlength="20" />
				                  	</td>
              		<td class="text_tablehead_b">收款人账号</td>
                   <td id="qt_td" >
				                  		<html:text property="bc.cdtrAcct" maxlength="32" />
				   </td>
                  ...
                  <td  class="text_list">${pot.status}</td>
                   <td  class="text_list">
                      ...
                      <span class="text_list"> 
                       <a href="#" onclick="queryDetail('/BatchPaymentAction.do?method=batchCollectionChildQuery&parentid=${pot.id}')">付款人详情</a>&nbsp;
	             	  <a href="#" onclick="repairView('/BatchPaymentAction.do?method=batchCollectionQuery&id=${pot.id}')">明细</a>&nbsp;
