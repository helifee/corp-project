          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2"> 付款人列表信息</span></div></td><td width="781"></td>
                </tr>
              </table>
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                <tr> 
                             <td  align="center" class="text_listhead">明细标识号</td>
				                   ...
				                   <td  align="center" class="text_listhead">合同（协议）号</td>
                ...
                <logic:iterate id="po" name="queryList">
                    <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
						                  ...
						                  <td  class="text_list"><div class="gridCell_standard">${po.agrmtNb}</td>
                   ...
                   <td  class="text_list">
                      ...
                      <span class="text_list"> 
             								...
             								<a href="#" onclick="detailView('/BatchPaymentAction.do?method=batchCollectionChildQuery&id=${po.id}')">明细</a>&nbsp;
