...
function nullsubmit1()
{
	...
	//alert(url);
 	...
 	i.on("beforedestroy",function(){
	 		window.location.href=getRootPath()
				+ "/BatchPaymentAction.do?method=querybatchPaymentChildrenList&parentid=${parentid}";
			return true;
	 	});
 	i.show();
}
            ...
            <div align="center">
			 ...
			 <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_head">
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                <tr>
                  <td  class="text_listhead">收款行行号</td>
                  <td  class="text_listhead">收款人名称</td>
                  <td  class="text_listhead">收款人账号</td>
                  
                  <td  class="text_listhead">合同（协议）号</td>
                  <td  class="text_listhead">核验标识</td>
                  
                  
                  <td  class="text_listhead">货币符号</td>
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
                  <td  class="text_list"><div class="gridCell_standard">${pot.cdtrBrnchId}</td>
							                  <td  class="text_list">${pot.cdtrNm}</td>
							                  <td  class="text_list">${pot.cdtrAcct}</td>
							                   <td  class="text_list">${pot.agrmtNb}</td>
							                 <td  class="text_list">${pot.chckFlg}</td>
							                 							                  <td  class="text_list">${pot.currencyCd}</td>
							                <td  class="text_list">${pot.amount}</td>
                 
                   <td  class="text_list">
                      <div >
                      <span class="text_list"> 
                        <a href="#" onclick="repairView('/BatchPaymentAction.do?method=querybatchPaymentChildrenList&id=${pot.id}')">明细</a>&nbsp;
