...
function queryDetail(url){
	...
	var url = getRootPath()+url;
 	...
 	var i = createWin("wind","付款人详情列表",url);
 	i.on("beforedestroy",function(){
	 		window.location.href=getRootPath()
				+ "/BatchPaymentAction.do?method=batchCollectionQuery";
			return true;
	 	});
 	i.show();
}
function nullsubmit1()
{
	...
	//alert(url);
 	...
 	i.on("beforedestroy",function(){
	 		window.location.href=getRootPath()
				+ "/BatchCustomerAction.do?method=queryList";
			return true;
	 	});
 	i.show();
}
...
<html:form method="post" action="/BatchCustomerAction.do?method=queryList"
>
          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2">批量客户信息查询</span></div></td><td width="781"></td>
                </tr>
              </table>
			 <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_head">
               <tr>
                ...
                <tr>
             		 ...
             		 <td id="zfjyzh_td" >
				                  		<html:text property="customers.msgId" maxlength="20" />
				                  	</td>
              		<td class="text_tablehead_b">支付交易组号</td>
                   <td id="qt_td" >
				                  		<html:text property="customers.pmtGrpId" maxlength="32" />
				   </td>
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                ...
                <td  class="text_listhead">支付交易组号</td>
                  <td  class="text_listhead">业务处理参与机构</td>
                  <td  class="text_listhead">回执报文标识号</td>
                  <td  class="text_listhead">收款人名称</td>
                   <td  class="text_listhead">处理日期</td>
                    <td  class="text_listhead">轧差日期</td>
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
                  ...
                  <td  class="text_list"> ${pot.rjctedPtyId}</td>
							                  <td  class="text_list">${pot.recptMsgId}</td>
							                  <td  class="text_list">${pot.sttlmDt}</td>
							                  <td  class="text_list">${pot.workDt}</td>
							                
                 <td  class="text_list">${pot.netgDt}</td>
                  <td  class="text_list">${pot.status}</td>
                   <td  class="text_list">
                      <div >
                      <span class="text_list"> 
                        <a href="#" onclick="repairView('/BatchCustomerAction.do?method=queryChildrenList&parentId=${pot.id}')">账户清单</a>&nbsp;
                       <a href="#" onclick="repairView('/BatchCustomerAction.do?method=queryList&id=${pot.id}')">明细</a>&nbsp;
