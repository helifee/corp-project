 ...
 　　}
	...
	<body  >
		<form  name="form1" method="post"  enctype="multipart/form-data"
			action="<%=path%>/BatchProtocolManageAction.do?method=saveBatchProtocolManage">
						               ...
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
										...
										readonly=readonly			value="${bankInfo.directbankcode }"					style="width: 180px;" title="发起直接参与机构" maxlength="22"
															...
															<td class="text_tablehead_b"  >
																...
																<td >
																		<select  name="po.qryOrOprTp" id="qryOrOprTp">
																	 <option value="QT00">查询</option>
																	  <option value="QT01">调整</option>
																...
																<td>
																<input name="po.nbOfAgrmt" id="nbOfAgrmt" type="text"  
																		style="width: 180px;" title="协议数目" maxlength="22"
																		  />
																	<font color=red>*</font>
																</td>
																<td class="text_tablehead_b" >
																...
																<td>
																<input name="zcxfiles" id="zcxfiles"  type="file"   
																		style="width: 180px;" title="协议数目" maxlength="22"
																		  />
																	<font color=red>*</font>
																</td>
