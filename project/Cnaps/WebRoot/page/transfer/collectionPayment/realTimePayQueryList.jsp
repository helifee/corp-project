...
function nullsubmit1()
{
	...
	//alert(url);
 	...
 	i.on("beforedestroy",function(){
	 		window.location.href=getRootPath()
				+ "/RealTimeCollectionPayAction.do?method=realTimePayQueryList";
			return true;
	 	});
 	i.show();
}
...
<html:form method="post" action="/RealTimeCollectionPayAction.do?method=realTimePayQueryList"
>
          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2">实时代付查询</span></div></td><td width="781"></td>
                </tr>
              </table>
                  ...
                  <td  class="text_list">${pot.status}</td>
                   <td  class="text_list">
                      ...
                      <span class="text_list"> 
                       <a href="#" onclick="repairView('/RealTimeCollectionPayAction.do?method=realTimePayQueryList&id=${pot.id}')">明细</a>&nbsp;
