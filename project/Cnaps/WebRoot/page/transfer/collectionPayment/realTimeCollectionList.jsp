...
function nullsubmit1()
{
	...
	//alert(url);
 	...
 	i.on("beforedestroy",function(){
	 		window.location.href=getRootPath()
				+ "/RealTimeCollectionPayAction.do?method=realTimePayQueryList&flag=collect";
			return true;
	 	});
 	i.show();
}
...
<html:form method="post" action="/RealTimeCollectionPayAction.do?method=realTimePayQueryList&flag=collect"
>
          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2">实时代收查询</span></div></td><td width="781"></td>
                </tr>
              </table>
			 <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_head">
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
                  ...
                  <td  class="text_list"> ${pot.btchNb}</td>
							                  <td  class="text_list">${pot.cdtrAcct}</td>
							                  <td  class="text_list">${pot.cdtrNm}</td>
							                  <td  class="text_list">${pot.workDt}</td>
							                
                 <td  class="text_list">${pot.amount}</td>
                  <td  class="text_list">${pot.status}</td>
                   <td  class="text_list">
                      <div >
                      <span class="text_list"> 
                       <a href="#" onclick="repairView('/RealTimeCollectionPayAction.do?method=realTimePayQueryList&flag=collect&id=${pot.id}')">明细</a>&nbsp;
