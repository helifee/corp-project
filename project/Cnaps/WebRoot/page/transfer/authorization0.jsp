         ...
         //默认返回01，也就是错误信息，到时注掉就可以
	           ...
	           //   }
	             ...
	             　　if(http_request.responseText=='0'){
	                ...
	                //window.parent.document.form1.waiven.checked="checked";
	                //window.parent.document.form1.sxf.value="0.00";
	                //window.parent.document.form1.ydf.value="0.00";
	                //window.parent.document.form1.ydjs.value="0.00";
	                //window.parent.document.form1.counterfoil.value="0.00";
	                window.parent.document.forms[0].contrperson.value=document.form1.Username.value;
