...
function getpmtkd(pmtkd ){
	...
	//计算总额
	 	...
	 	function commitForm(){
			   ...
			   var msg = "@";
					var pmtgrpid = document.getElementById("pmtgrpid");
					var rcptltd = document.getElementById("rcptltd");
					var amount = document.getElementById("amount");
					var aclmtamt = document.getElementById("aclmtamt");
				                  	...
				                  	<font color="#FF0000">*</font>
				                   		...
				                   		<font color="#FF0000">*</font>
                                                  			...
                                                  			<tr>
																...
																<td >
																		<input type="text" name="po.cdtrissuer" id="cdtrissuer" style="width: 180px;" title="收款人开户行行号" readonly="readonly"  maxlength="14"/><font color="#FF0000">*</font>
				                   		</td>
				                   		<td class="text_tablehead_b" >
																	收款人开户行行名
																</td>
                                                  			...
                                                  			<tr>
																...
																<td>
																	...
																	<input type="text" name="po.cdtrmmbid" id="cdtrmmbid" style="width: 180px;" title="收款清算行行号"   readonly="readonly" maxlength="14"/>
