...
<%
	...
	String flag2=(String)request.getParameter("flag");
	if(null!=flag1){request.setAttribute("flag",flag1);}
	else{request.setAttribute("flag",flag2);}
%>
  ...
  <c:if test="${hvpsfront141.contractSts=='CS03'}">协议未生效</c:if> 
                 ...
                 <td  class="text_list">${hvpsfront141.unactiveDate}</td>
                  ...
                  <td  class="text_list">
                    ...
                    <a href="#"   onClick="repairView('<%=path %>/transfer/PaySignupQueryAction.do?method=queryRepair&id=${hvpsfront141.id}')"><u>维护</u></a>
                    <a href="#"   onClick="detailClient('/transfer/PaySignupCreateAction.do?method=delete&id=${hvpsfront141.id}')"><u>删除</u></a>
                    <a href="#"   onClick="detailClient('/transfer/PaySignupCreateAction.do?method=SetQryPswdErrNbO&id=${hvpsfront141.id}')"><u>激活密码</u></a>
