 ...
 　　}
      ...
      function clrAmt(){
		...
		<script type="text/javascript">
	      function elect(){
	           var a=document.getElementById("businessSizeCode").value;
	           var b=document.getElementById("businessClassCode");
	           var c=document.getElementById("fjxx");
	           b.length=0;
	           if(a=="D100"){
	               c.style.display="none";
	               b[0]=new Option("其他","09001");
	           }
	           if(a=="D200"){
	               c.style.display="none";
	               b[0]=new Option("电费","00100");
	               b[1]=new Option("水暖费","00200");
	               b[2]=new Option("煤气费","00300");
	               b[3]=new Option("电话费","00400");
	               b[4]=new Option("通讯费","00500");
	               b[5]=new Option("保险费","00600");
	               b[6]=new Option("房屋管理费","00700");
	               b[7]=new Option("代理服务费","00800");
	               b[8]=new Option("学教费","00900");
	               b[9]=new Option("有线电视费","01000");
	               b[10]=new Option("企业管理费用","01100");
	               b[11]=new Option("其他","09001");
	           }
	           if(a=="D203"){
	               c.style.display="";
	           	   b[0]=new Option("支票","03401");
	               b[1]=new Option("银行汇票","03402");
	               b[2]=new Option("商业承兑汇票","03403");
	               b[3]=new Option("银行承兑汇票","03404");
	               b[4]=new Option("商业本票","03405");
	               b[5]=new Option("其他","09001");
	           }
	      }
	...
	<body onload="sendDate();elect();">
		<form  name="form1" method="post"
			action="<%=path%>/transfer/PersonCrashSpanBankExchangeAction.do?method=sendCredit&flag=debit">
				...
				<tr valign="top">
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">实时借记业务</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
															...
															<tr>
																	...
																	<td>
																		<select name="po.businessSizeCode"
																			...
																			title="业务类型编码" onchange="elect();">
																			<option value="D100" selected="selected">
																				普通实时借记业务
																			</option>
																			<option value="D200">
																				实时代收
                                                    ...
                                                    <table>
                                                      	...
                                                      	<td colspan="4"><span class="text_tablehead">付款人信息</span></td>
                                                  			...
                                                  			<tr>
																...
																<td colspan="3">
																	<input name="po.payAddress" id="payAddress" class="text_tablehead_b_addr" title='付款人地址'
																		 onKeyPress="actkeyPress()"  onkeyup="limitLength(value,70,'提示：','payAddress')"/>
                                                  			...
                                                  			<tr>
																...
																<td>
																		<select  name="po.payAccountType" title="付款人账户类型" id="payAccountType">
                                                    	...
                                                    	<table>
                                                      	...
                                                      	<td colspan="4"><span class="text_tablehead">收款人信息</span></td>
															...
															<td class="text_tablehead_b"  >
																...
																<td>
																<input  name="po.receAccountType" id="receAccountType" type="hidden" readonly="readonly" title="收款人账户类型" />
																	 <select  name="po.receAccountType" disabled="disabled" title="收款人账户类型" id="receAccountType1">
																		 <option value="" selected>请选择</option>
																		  <option value="AT01">个人贷记卡账户</option>
																		   <option value="AT02">个人借记卡账户</option>
																		 </select>
																...
																<td >
																	 <input type="text" readonly="readonly"  maxlength="30" name="po.proposerCstmrId" id="proposerCstmrId" title="收款人客户号" id="proposerCstmrId">
																		  <input type="hidden" readonly="readonly" name="po.proposerAcctCcy" title="收款人账户币种" id="proposerAcctCcy" value="CNY">
															...
															<tr>
																...
																<td colspan="3">
																	<input type="text" readonly="readonly" class="text_tablehead_b_addr" name="po.cdtrAddr" id="address" title='收款人地址'
					...
					<td >					
						...
						<input type="radio" class="text_tablehead_b_rad" name="po.waive" id="waiven" value="N"  onclick="clrAmt0()">不收取
                                                    ...
                                                    <div class="table_content" id="fjxx" style="display: none;">
															<table>
																<tr>
																	<td colspan="4">
																...
																<tr>
																	...
																	<td>
																		<input name="po.notesnum" id="pjhm" type="text"
																	...
																	<td>
																		<input name="po.issueamt" id="cpje" type="text"
																			title="出票金额" />
																		<span class="STYLE1">*</span>
																	</td>
																...
																<tr>
																	...
																	<td>
																		<input name="po.pymntpswd" id="pymntpswd" type="password"
																			title="支付密码" />
																	</td>
																	<td class="text_tablehead_b">
																		汇票到期日期
																	...
																	<td>
																		<input name="po.maturitydt" id="hpdqr" type="text"
																			class="Wdate" title="汇票到期日期" onclick="WdatePicker()" />
																	</td>
																...
																<tr>
																	...
																	<td>
																		<input name="po.applynm" id="sqrmc" type="text"
																			title="申请人名称" />
																	</td>
																	<td class="text_tablehead_b">
																		申请人账号
																	...
																	<td>
																		<input name="po.applyacct" id="sqrzh" type="text"
																...
																<tr>
																	...
																	<td>
																		<input name="po.accptncagrmntno" id="cdxybh"
																			type="text" title="承兑协议编号" maxlength="30" />
																	</td>
																	<td class="text_tablehead_b">
																		承兑日期
																	</td>
																	<td>
																		<input name="po.accptncdt" id="cdrq" type="text"
																			class="Wdate" title="承兑日期" onclick="WdatePicker()" />
																	</td>
																</tr>
																...
																<tr>
																	...
																	<td>
																		<input name="po.accptncnm" id="cdr" type="text"
																			title="承兑人" maxlength="60" />
																	</td>
																	<td class="text_tablehead_b">
																		出票人全称
																	</td>
																	<td>
																		<input name="po.drawernm" id="cprqc" type="text"
																			title="出票人全称" maxlength="32" />
																	</td>
																...
																<tr>
																	...
																	<td>
																		<input name="po.draweracct" id="cprzh" type="text"
																			title="出票人账号" maxlength="32" />
																	</td>
																	<td class="text_tablehead_b">
																		提示付款日期
																	</td>
																	<td>
																		<input name="po.paydt" id="tsfkrq" class="Wdate"
																...
																<tr>
																	...
																	<td>
																		<input name="po.trnsctncntrctno" id="jyhthm"
																			type="text" title="交易合同号码" maxlength="30" />
																	</td>
																	<td class="text_tablehead_b">
																		原收款人名称
																	</td>
																	<td>
																		<input name="po.oricrdtrnm" id="yskrmc" type="text"
																			maxlength="60" title="原收款人名称" />
																...
																<tr>
																	...
																	<td>
																		<input name="po.numofendrsr" id="numOfEndrsr"
																			type="text" title="背书人数" onblur="namezcx(this)" />
																		<span class="STYLE1">*</span>
																	</td>
																	<td class="text_tablehead_b">
																		用途
