...
<html>
	...
	function OnSave() {
		//obj.issuernm 行名 obj.issuer 行号 obj.mmbid 清算行行号 
		var userMap = {};
		userMap.accountnumber = document.getElementById("payerAcount").value;//账号
		userMap.accountname = document.getElementById("payName").value;//账号户名
		userMap.addr = document.getElementById("payAddress").value;//地址
		userMap.mmbid = document.getElementById("fkqshhh").value;//清算行
                 ...
                 var phone = document.getElementById("phone");
                  var payerAcount = document.getElementById("payerAcount");
                   ...
                   var moneyNum = document.getElementById("moneyNum");
                     ...
                     var chckCdLen  = document.getElementById("chckCdLen");
                  ...
                  if(isNull(trim(receAccountType.value))){
					...
					if(isNull(trim(chckCdLen.value))){
					msg += chckCdLen.title+"不能为空！@";
				    }
 ...
 　　}
	...
	<body onload="sendDate()">
		<form  name="form1" method="post"
			...
			<!-- 签发模式 -->
			<input  id="signMd" name="po.signMd" type="hidden" maxlength="19" value="01" />
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">个人现金跨行通兑</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
                                                     ...
                                                     <div class="table_content">
                                                      ...
                                                      <tr>
															...
															<tr>
																...
																<td>
																<select  name="po.businessSizeCode" title='业务类型编码' id="businessSizeCode" style="width:180px;" title="业务类型编码">
																<option value="D102"  selected="selected">个人储蓄通兑业务</option>
																</select>
																	<span  class="STYLE1">*</span>
																</td>
																<td class="text_tablehead_b" >
																...
																<select  name="po.businessClassCode" id="businessClassCode" style="width:180px;" title="业务种类编码">
																	<option value="03301"  selected="selected">现金</option>
																</select>
																	<span  class="STYLE1">*</span>
																</td>
															</tr>
																...
																<td>
																<select  name="po.checkModeCode" id="checkModeCode" style="width:180px;" title="密码验证算法">
																<option value="CD00"  selected="selected">支付密码单密码</option>
																...
																<td >
																	<input style="width:180px;" name="po.password" id="password" type="password" size="19" onblur="countLen();"
																		maxlength="19" title="密码" /><span  class="STYLE1">*</span>
                                                      	...
                                                      	<td colspan="4"><span class="text_tablehead">收款人信息</span></td>
																...
																<!-- 
																	<input name="po.receAcount" id="receAcount" type="text" onblur="PubQueryAccount(this.value);"
																		...
																		onKeyPress="charPress()" />
																	 -->	
																		 <select  name="po.receAcount" title="收款人账号" id="receAcount" >
																		 <option value="6222000055000010" selected>6222000055000010</option>
																		 </select>
																		<span  class="STYLE1">*</span>
																</td>
															...
															<td class="text_tablehead_b"  >
																...
																<td>
																		<select title='证件类型'  name="po.certsize" id="certsize">
																...
																<td>
																<input  name="po.receAccountType" value="AT02" id="receAccountType" type="hidden" readonly="readonly" title="收款人账户类型" />
																	 <select  name="po.receAccountType"  title="收款人账户类型" id="receAccountType1">
																		   <option value="AT02">个人借记卡账户</option>
																		 </select>
																		 <span  class="STYLE1">*</span>
																</td>
																...
																<td >
																	 <input type="hidden" readonly="readonly"  maxlength="30" name="po.proposerCstmrId" id="proposerCstmrId" title="收款人客户号" id="proposerCstmrId">
															...
															<tr>
																...
																<td colspan="3">
																	<input type="text"  class="text_tablehead_b_addr" name="po.cdtrAddr" id="address" title='收款人地址'
