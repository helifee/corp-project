...
{               
            var str = obj[i].msgtpcd.substring(0,4);
                    ...
                    if(str =="beps"){
                       sxf=obj[i].charge==null?"": obj[i].charge;//手续费
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">个人现金跨行通存</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
															...
															<td class="text_tablehead_b"  >
																...
																<td>
																	<input  name="po.phone" id="phone" type="text"
																		 maxlength="20" title="付款人联系电话" /> <span  class="STYLE1">*</span> 
																...
																<td>
																		 <select  name="po.payAccountType" title="付款人账户类型" id="proposerAcctTp">
