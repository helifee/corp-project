...
<html>
	...
	<script type="text/javascript" src="<%=path%>/js/common/checkIdcard.js"></script>
	   ...
	   function elect(){
	           var a=document.getElementById("businesssizenum").value;
	           ...
	           if(a=="C210"){
	           	   b[0]=new Option("薪金报酬","01200");
	           }
	           if(a=="A101"){
	           	   b[0]=new Option("慈善捐款","01300");
	           	   b[0]=new Option("其他","09001");
	           }
	      }
...
function selectBankInfo(){
	...
	<body onload="sendDate();elect();">
		<form method="post" name="form1"
			...
			<!-- 防止重复提交 -->
		 <input id="cardcrash" name="cardcrash" type="hidden" value="other">
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">实时贷记业务</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
                                                     ...
                                                     <div class="table_content">
                                                      ...
                                                      <tr>
															...
															<tr>
																...
																<td>
															    <select  name="po.businesssizenum" id="businesssizenum" style="width:180px;" title="业务类型编码" onchange="elect();">
																 <option value="C100"  selected="selected">普通实时贷记业务</option>
																 <option value="C101" >实时代付</option>
																 <option value="C210" >薪金报酬</option>
                                                    ...
                                                    <div class="table_content">
                                                         ...
                                                         <tr>
															<td class="text_tablehead_b"  >
																...
																<td>
																<input name="certtype" id="certsize1" type="hidden"  readonly="readonly"/>
                                                      	...
                                                      	<td colspan="4"><span class="text_tablehead">计费信息</span></td>
															...
															<!--  	 
																...
																<td >
																	...
																	<input type="radio" class="text_tablehead_b_rad" name="po.waive" value="N" checked="checked" onclick="zcx(this);">不减免
