												...
												<input type="hidden" name="pmtgrpid" value="${entity.pmtgrpid }"/>
			                                     	...
			                                     	<tr>
														...
														<c:if test="${entity.pmtkd eq'02102'}">普通汇兑	</c:if>
																	...
																	<c:if test="${entity.pmtkd eq'03301'}">现金</c:if>
																	<c:if test="${entity.pmtkd eq'03302'}">转账</c:if>
			               ...
			               <tr>
			                ...
			                <tr>
			               		<td  class="text_zcx" align="right" class="text1" width="190" >签发柜员</td>
													 ...
													 <tr>
			               	 						 <td   class="text_zcx" align="right" class="text1" >轧差日期</td>
														<td class="text1" >&nbsp;${entity.netgdt}</td>
														<td   class="text_zcx"  align="right" class="text1" >轧差场次</td>
														<td  class="text1" >&nbsp;
														 ${entity.netgrnd } 
							              				</td>
														<td   class="text_zcx"  align="right" class="text1" >清算日期</td>
														<td  class="text1" >&nbsp;
														 ${entity. sttlmdt} 
														</td>
...
<table> 
 ...
 <tr>
										...
										<td style="width:14%;">
		<input type="button" value="付款人信息"  style="width:100%;border: 1px solid ;background-color: #FFFFD0;margin-left: 1px;margin-top: 3px;cursor:hand;"
  onclick="selectDet(0)"/>
										</td>
								<td style="width:1%;">|
								</td>		
  ...
  onclick="selectDet(2)"/>	
                  ...
                  --%>    
                                ...
                                <div id="details" name="details" style="display:block;">
												...
												<tr>
												<td   class="text_zcx"  align="right">付款人账户类型</td>
														<td  class="text1" >&nbsp;
														<c:if test="${entity.dbtrAcctTp eq 'AT01'}">个人贷记卡账户</c:if>
														<c:if test="${entity.dbtrAcctTp eq 'AT02'}">个人借记卡账户</c:if>
		                        ...
		                        <div id="details" name="details" style="display: none;">
												...
												<tr>
												<td   class="text_zcx"  align="right">收款人账户类型</td>
														<td  class="text1" >&nbsp;
														
														 
														<c:if test="${entity.cdtrAcctTp eq 'AT01'}">个人贷记卡账户</c:if>
														<c:if test="${entity.cdtrAcctTp eq 'AT02'}">个人借记卡账户</c:if>
														</td>
			               		...
			               		<td  class="text_zcx" align="right" class="text1" width="190" >签发柜员</td>
													  ...
													  <tr>
			               		<td  class="text_zcx" align="right" class="text1" width="190" >授权柜员</td>
														<td  class="text1" width="150">&nbsp;
														${entity.warrantyid}
														</td>
												</tr>
