												...
												<td height="30">
													<div align="center">
														...
														<table>
															...
															<tr>
																<td class="text_zcx">
																	支付交易组号<input type="hidden" name="systemcd"
															...
															<input type="hidden" name="pmtgrpid"
																...
																<td class="text1" width="190">
																	...
																	<c:if test="${entity.pmttp eq 'E100'}">普通定期贷记</c:if>
 ...
 --%>
													...
													<td class="text1" width="150" colspan="3">&nbsp;${entity.proposeraddr}</td>
																			...
																			<tr>
																				...
																				<td class="text1">
																					&nbsp;
																					<c:if test="${entity.dbtrAcctTp eq 'AT00'}">对公账户</c:if>
																	...
																	<fieldset
																		...
																		<table>
																			<tr>
																				...
																				<td class="text1">
																					&nbsp;
																					<c:if test="${entity.cdtrAcctTp eq 'AT00'}">对公账户</c:if>
