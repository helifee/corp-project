...
<script language="javascript">
	...
	function viewdetails(id){
		var newurl = "<%=path %>/TransProcessAction.do?method=sendDetailMessage&pmtgrpid="+id+"&operway=04";
		viewDetails(newurl);	
	}
	
	function viewupdate(pmtgrpid){
	var newurl = "<%=path %>/TransProcessAction.do?method=sendDetailMessage&pmtgrpid="+pmtgrpid+"&operway=05";
		viewDetails(newurl);
	}
	function viewdelete(pmtgrpid){
	var newurl = "<%=path %>/TransProcessAction.do?method=sendDetailMessage&pmtgrpid="+pmtgrpid+"&operway=06";
		viewDetails(newurl);
	}
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="O">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">支付业务状态维护</span></div>
                					</td>
                				</tr>
                			</table>
									  ...
									  <logic:iterate id="po" name="queryList">
										 <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">		
							                  ...
							                  <td  class="text_list"><div align="center"><span class="text_list">
                                                 <a href="#"   onClick="viewdetails('${po.pmtgrpid}')"><u>明细
                                                
                                                 </u></a>
                                                
                                                 <a href="#"   onClick="viewupdate('${po.pmtgrpid}')"><u>维护</u></a>
                                                   <c:if test="${po.workdt != workDate}">
                                                     <a href="#"   onClick="viewdelete('${po.pmtgrpid}')"><u>作废</u></a>
                                                    </c:if>
                                               </td>				                  
						                  </tr>  
					                  </logic:iterate> 
