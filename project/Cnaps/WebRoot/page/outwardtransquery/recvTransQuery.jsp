...
<script language="javascript">
	function viewdetails(txid,msgid,id,pmttpbgclsotid,msgidunq){
		var newurl = "<%=path %>/TransProcessAction.do?method=gotoTransDetails&txid="+txid+"&msgid="+msgid+"&id="+id+"&msgidunq="+msgidunq+"&direction=I&pmttpbgclsotid="+pmttpbgclsotid;
		viewDetails(newurl);	
	}
</script>
</head>
<body>
<html:form  method="post" action="/TransProcessAction.do?method=querySendxml&direction=I&operway=">
	        		...
	        		<tr>
	          			...
	          			<div align="center">
	          				<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6"><div  class="text_title"><span class="text_blue2">支付业务来报查询</span></div></td>
                				</tr>
                				</table>
		              			...
		              			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbcolor">
					                <tr>
					                  ...
					                  <!-- <td  align="center" class="text_listhead">优先级</td>  -->
					                   ...
					                   <!--<td  align="center" class="text_listhead">扣款账户</td>
									  ...
									  <logic:iterate id="po" name="queryList">
										  <tr onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">		
							                ...
							                <td  class="text_list"><div class="gridCell_standard">
							                  ...
							                  <td  class="text_list"><div class="gridCell_standard">${po.status}-
							                 ...
							                 <td  class="text_list"><div align="center"><span class="text_list">
                                               <a href="#"   onClick="viewdetails('${po.txid }','${po.msgid}','${po.id}','${po.pmttpbgclsotid}','${po.msgIdUnq}')"><u>明细</u></a></span></div>
                                               </td>	
