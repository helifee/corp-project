											...
											<tr>
												<td height="30">
													<div align="center">
														...
														<table>
															<tr>
																<td class="text_zcx" align="right" class="text1">报文标识号</td>
												...
												<c:if test="${entity.pmttp eq 'A309'}"> CIS通用票据业务回执	
												<c:if test="${entity.pmttp eq 'C100'}">实时贷记</c:if>
								                    <c:if test="${entity.pmttp eq 'D100'}">实时借记</c:if>             </c:if>    
																</td>
																<td class="text_zcx" align="right" class="text1"
																	width="190">
																	业务种类编码
...
<c:if test="${entity.pmtkd eq '05302'}">CIS通用票据业务回执</c:if>
																...
																<td class="text_zcx" align="right" width="">
																	收款行名称
																</td>
