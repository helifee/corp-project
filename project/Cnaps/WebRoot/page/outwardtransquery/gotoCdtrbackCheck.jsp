     ...
     <div id="details" name="details" style="display:block;">
		                        ...
		                        <div id="details" name="details" style="display: none;">
												<fieldset style="width:90%;border:1px #CCCCCC solid; padding:3px;" align=center >
											  	...
											  	<tr>
													<td   class="text_zcx"  align="right" class="text1" width="190">收款人证件号</td>
													<td  class="text1" width="150">&nbsp;${entity.proposercertid}</td>
													
													<td   class="text_zcx"  align="right" class="text1" width="190">收款人证件类型</td>
													<td  class="text1" width="150">&nbsp;
												...
												<tr>
													<td   class="text_zcx"  align="right" class="text1" width="190">收款人证件发行国家</td>
													<td class="text1" width="150" >&nbsp;
												...
												<tr>
													<td class="text_zcx"  align="right" class="text1" width="190">收款人联系电话</td>
													<td class="text1" width="150">&nbsp;${entity.proposertel}</td>
												  <td class="text_zcx"  align="right" class="text1" width="190">收款人客户号</td>
												...
												<tr>
													...
													<td class="text1" width="150">&nbsp;
														...
														<td class="text_zcx"  align="right" class="text1" width="190">收款人账户币种</td>
	 	...
	 	<c:choose>
                 ...
                 <c:when test="${entity.pmttp eq 'B309'}">
												...
												<tr>
													...
													<td  class="text1" width="150">&nbsp;${addentity.issueAmt}</td>
               ...
               <c:when test="${entity.pmttp eq 'A104'}">
                <tr>
					 ...
					 <tr>
								...
								<td  class="text1" width="150">&nbsp;
									<c:if test="${entity.voucherno eq 'BL00'}">中央</c:if>
									<c:if test="${entity.voucherno eq 'BL01'}">省级</c:if>
								</td>
					</tr>
					 <tr>
								<td  class="text_zcx" align="right" class="text1" width="190" >调整期标志</td>
								<td  class="text1" width="150">&nbsp;
									<c:if test="${entity.vouchertype eq 'ID00'}">正常</c:if>
									<c:if test="${entity.vouchertype eq 'ID01'}">调整期</c:if>
								</td>
