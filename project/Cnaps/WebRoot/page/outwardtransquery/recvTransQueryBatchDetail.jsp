...
<script type="text/javascript" src="<%=path %>/js/systemManager/showeditpanel.js"></script>
		...
		var newurl = "<%=path %>/TransProcessAction.do?method=gotoTransDetails&pmtgrpid="+id+"&pmttpbgclsotid=o&systemcd="+systemcd;
		viewDetails(newurl);	
	}
	function querydetail(txid,msgid,id,pmttpbgclsotid,msgidunq){
		var  url = "<%=path %>/TransProcessAction.do?method=gotoTransDetails&txid="+txid+"&msgid="+msgid+"&id="+id+"&msgidunq="+msgidunq+"&direction=I&pmttpbgclsotid="+pmttpbgclsotid;
		viewDetails(url);
 	//var i = createWin("wind","明细查看",url);
 	//i.on("beforedestroy",function(){
	// 		var str="<%=path %>/TransProcessAction.do?method=queryPKGInfoDetail&flag=laibao&pmtgrpid=${msgid}" ;
								...
								<td>
									<div align="center">
											...
											<tr>
												<td colspan="6">
													<div class="text_title">
														<span class="text_blue2"> 小额(来报)批量包明细 </span>
													</div>
												</td>
											</tr>
										</table>
										<table width="95%" height="30" border="0" cellpadding="0"
                                           ...
                                           <a href="#"   onClick="querydetail('${po.txid }','${po.msgid}','${po.id}','${po.pmttpbgclsotid}','${po.msgIdUnq}')"><u>明细</u></a></span></div>
