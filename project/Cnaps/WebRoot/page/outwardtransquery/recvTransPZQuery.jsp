...
<script language="javascript">
	...
	function pzPrint(id,systemcd){
		...
		window.open(newurl,"大额来账凭证打印",'height=400, width=800, top=200, left=200,scrollbars=yes,resizable=yes');
		//viewDetails(newurl);	
	}
	//凭证批量打印
...
<body>
<html:form  method="post" action="/TransProcessAction.do?method=querySendxml&operway=06">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		<tr>
	          			...
	          			<div align="center">
                				...
                				<tr>
                					<td colspan="6"><div  class="text_title"><span class="text_blue2">来账凭证打印</span></div></td>
                				</tr>
                				</table>
									  ...
									  <logic:iterate id="po" name="queryList">
										  <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">		
							                  ...
							                  <td  class="text_list"><div align="center"><span class="text_list">
                                               <a href="#"   onClick="pzPrint('${po.txid}')"><u>凭证打印</u></a></span></div>
                                               </td>
							                 <td  class="text_list"><div align="center"><span class="text_list">
                                               <a href="#"   onClick="viewdetails('${po.txid}')"><u>明细</u></a></span></div>
                                               </td>				                  
						                  </tr>
					                  </logic:iterate>                
					                </logic:present>
