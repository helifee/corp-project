...
<script language="javascript">
	function viewdetails(pmtgrpid,pmttpbgclsotid,systemcd){
		...
		viewcheck(newurl,oldurl,"审核界面",document);
	}
...
<body>
<html:form  method="post"  action="/TransProcessAction.do?method=querySendxml&operway=01">
	  	...
	  	<tr valign="top">
	    	...
	    	<td >
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="O">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">支付业务审核查询</span></div>
                					</td>
                				</tr>
                			</table>
				                	...
				                	<td class="text_tablehead_b">支付交易组号</td>
				                  	...
				                  	<td  >
				                   		<html:select property="po.status" value="${condition.status }">
				                  			...
				                  			<html:option value="PR83">待审批</html:option>
				                  		</html:select>
				                  	</td>
                 ...
                 <td  class="text_list"><div align="center"><span class="text_list">
                                               <a href="#"   onClick="viewdetails('${po.pmtgrpid}','${po.pmttpbgclsotid}','${po.systemcd}')"><u>审核</u></a>
                                               </td>	
                 </c:when>
                 
                  <c:when test="${po.status eq 'PR83' }">
                  <td  class="text_list"><div align="center"><span class="text_list">
                                               <a href="#" onClick="viewdetailsback('${po.pmtgrpid}','${po.pmttpbgclsotid}','${po.systemcd}')"><u>取消审批</u></a>
                                               </td>	
                 </c:when>
                 </c:choose>
