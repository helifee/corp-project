	          				...
	          				<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px #99bbe8 solid; padding:3px;" >
                				...
                				<tr>
				                	<td class="text_tablehead_b">汇兑组号</td>
				                  	<td  colspan="3">
				                   		<input type="text" name="po.startid" maxlength="19" value="${condition.startid }"/>
				                  	</td>
				                  	<td  class="text_tablehead_b">业务状态</td>
				                  	<td  >
				                   		<select name="po.status">
				                  			<option value="PR01">待复核</option>
				                  		</select>
				                  	</td>
				                   	<td class="text_tablehead_b">业务类型11</td>
				                   	<td  >
				                  		<select name="po.pmttp">
				                  			<option value="A108">现金汇款</option>
				                  			<option value="A109">委托收款(划回)</option>
				                  			<option value="B100">普通借记业务</option>
				                  			<option value="B104">国库资金借记划拨</option>
				                  			<option value="B307">国库资金国债兑付借记划拨</option>
									  ...
									  <logic:iterate id="po" name="queryList">
										  <tr onMouseOver="this.bgColor='#99bbe8';" onMouseOut="this.bgColor='FFFFD0'" bgcolor="FFFFD0">		
							                  ...
							                  <td  class="text_list"><div align="center"><span class="text_list">
                                               <a href="#"   onClick="viewdetails('${po.pmtgrpid}')"><u>复核</u></a></span></div>
                                               </td>				                  
						                  </tr>
					                  </logic:iterate>                
					                </logic:present>
