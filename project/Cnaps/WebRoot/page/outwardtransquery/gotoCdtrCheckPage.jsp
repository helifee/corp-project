		...
		<script type="text/javascript">
			...
			var reg = /(^\s)* | (\s$)* /gi;
			  ...
			  if(VForm.Validate()){
			  	...
			  	if(document.getElementById("pmttp").value=='F100'||document.getElementById("pmttp").value=='E102'){//定期借记业务
				  	...
				  	if(document.getElementById('dbtrbrnchid').value!=document.getElementById("dbtrbrnchid1").value){
				  		alert("付款行行号与原业务付款行行号不一致");
				  		return false;
				  	}
	...
	<tr>
			               ...
			               <%-- 
			                ...
			                <tr>
			               		<td  class="text_zcx" align="right" class="text1" width="190" >签发柜员</td>
													...
													<tr>
														<td   class="text_zcx"  align="right" class="text1" width="190">附&nbsp;&nbsp;&nbsp;&nbsp;言</td>
														<td  class="text1"colspan="3">&nbsp;${entity.addtlinf}</td>
													</tr>
													<tr>
							...
							<tr>
			               		<td  class="text_zcx" align="right"  width="190" >&nbsp;</td>
												...
												<tr>
													<td class="text_zcx"  align="right" class="text1" width="190">收款人账户类型</td>
													<td class="text1" width="150">&nbsp;
	 	...
	 	<c:choose>
                 ...
                 <c:when test="${entity.pmttp eq 'B308'}">
                                <tr>
												...
												<tr>
																...
																value="票据正面" onclick="imageScan('front','${addentity.imagepath}','${addentity.imagename}')" />
																<input name="photo" type="button" style="cursor: pointer" class="button"
																value="票据背面" onclick="imageScan('back','${addentity.imagepath}','${addentity.imagename}')" />
																				</td>
																			</tr>
												 <tr>
               ...
               <c:when test="${entity.pmttp eq 'A201'}">
                ...
                <c:when test="${entity.pmttp eq 'F100' || entity.pmttp eq 'E102'}">
               <tr>
               	<td colspan="4">
               		<table>
               			 <tr>
               			 ...
               			 <tr>
												...
												<td  class="text1" width="150">&nbsp;
													...
													<c:otherwise>
														...
														<tr>
															<td class="text_zcx" align="right" width="190">付款行行号</td>
															<td width="150"><input type="hidden" name="dbtrbrnchid1" value='${entity.dbtrbrnchid}' readonly="readonly"/>
															</td>
															<td width="350"><input type="text" name="dbtrbrnchid" value=""/><font color="red">*</font>
															</td>
														</tr>
													</c:otherwise>
												</c:choose>
