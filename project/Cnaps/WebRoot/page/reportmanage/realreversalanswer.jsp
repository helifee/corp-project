...
function onprint(){
		document.forms[0].action="<%=path %>/realreversalanswerAction.do?method=signupMsgExcel";
...
<body>
<html:form method="post" action="/realreversalanswerAction.do?method=querySendMsg">
