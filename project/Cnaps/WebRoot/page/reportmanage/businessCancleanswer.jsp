...
function onprint(){
		document.forms[0].action="<%=path %>/businessCancleanswerAction.do?method=signupMsgExcel";
...
<body>
<html:form method="post" action="/businessCancleanswerAction.do?method=querySendMsg">
             ...
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                <tr>
                  ...
                  <td   align="center" class="text_listhead">撤销日期</td>
