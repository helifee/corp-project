...
<script language="javascript">
	function onprint(){
		document.forms[0].action="<%=path %>/beps131cdtrAction.do?method=queryBeps131cdtrListExcel";
		document.forms[0].submit();
		document.forms[0].action="<%=path %>/beps131cdtrAction.do?method=queryBeps131cdtrList";
	}
</script>
</head>
<body>
<html:form  method="post" action="/beps131cdtrAction.do?method=queryBeps131cdtrList">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">已签发银行本票清单</span></div>
                					</td>
                				</tr>
                			</table>
