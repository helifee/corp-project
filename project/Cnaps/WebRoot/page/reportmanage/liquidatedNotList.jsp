...
<script type="text/javascript">
	function onprint(){
		document.forms[0].action="<%=path %>/CnapspmtcollectLiquidatedAction.do?method=queryLiquidatedNotMsgExcel&statusFlag=2";
		document.forms[0].submit();
		document.forms[0].action="<%=path %>/CnapspmtcollectLiquidatedAction.do?method=queryLiquidatedMsg&statusFlag=2";
	}
</script>
</head>
	<body>
		<html:form method="post"
			action="/CnapspmtcollectLiquidatedAction.do?method=queryLiquidatedMsg&statusFlag=2">
										...
										<tr>
											<td colspan="6">
												<div class="text_title">
													<span class="text_blue2">未清算账单清单</span>
												</div>
											</td>
										</tr>
									</table>
										...
										<tr>
											...
											<td>
												<input name="query" type="button" class="button" value="查 询"
													onclick="submit()" />
												<input type="button" value="清单打印" class="button"
													onclick="onprint()">
											</td>
										</tr>
										<tr>
