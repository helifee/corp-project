...
<script language="javascript"> 
	function onprint(){
		document.forms[0].action="<%=path %>/beps130Action.do?method=queryBeps130ListExcel";
		document.forms[0].submit();
		document.forms[0].action="<%=path %>/beps130Action.do?method=queryBeps130List";
	}
</script>
</head>
<body>
<html:form  method="post" action="/beps130Action.do?method=queryBeps130List">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">当日提出支票业务登记簿</span></div>
                					</td>
                				</tr>
                			</table>
					               ...
					               <logic:present name="liquidatedMsgList">
												<logic:iterate id="liquidatedMsg" name="liquidatedMsgList">
													<tr class="text_list" onmouseover="this.bgColor='#CE4C56'"
														...
														<td class="text_list">
															${liquidatedMsg.nboftxsofscs }
														</td>
														<td class="text_list">
														<fmt:formatNumber pattern="###,###,###,###,###,###,##0.00" value="${liquidatedMsg.ctrlsum }"/>
														</td>
														<td class="text_list">
															${liquidatedMsg.nboftxs }
														</td>
														<td class="text_list">
															${liquidatedMsg.pmtkd }
														</td>
