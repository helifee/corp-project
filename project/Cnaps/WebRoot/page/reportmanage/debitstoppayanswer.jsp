...
function onprint(){
		document.forms[0].action="<%=path %>/debitstoppayanswerAction.do?method=signupMsgExcel";
...
<body>
<html:form method="post" action="/debitstoppayanswerAction.do?method=querySendMsg">
