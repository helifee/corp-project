...
<html>
	...
	<body>
		<html:form method="post"
			action="/bepsMSGRGSTRAction.do?method=querySendMsg">
								...
								<td>
										...
										<tr>
											<td colspan="6">
												<div class="text_title">
													<span class="text_blue2">小额报文登记查询</span>
												</div>
											</td>
										</tr>
									</table>
									...
									<div align="center">
										<table width="95%" class="tbcolor">
											...
											<logic:present name="bepsMsgList">
												<logic:iterate id="bepsMsg" name="bepsMsgList">
