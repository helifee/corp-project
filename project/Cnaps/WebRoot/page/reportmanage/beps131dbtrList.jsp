...
<script language="javascript">
	function onprint(){
		document.forms[0].action="<%=path %>/beps131dbtrAction.do?method=queryBeps131dbtrListExcel";
		document.forms[0].submit();
		document.forms[0].action="<%=path %>/beps131dbtrAction.do?method=queryBeps131dbtrList";
	}
</script>
</head>
<body>
<html:form  method="post" action="/beps131dbtrAction.do?method=queryBeps131dbtrList">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">已兑付银行本票清单</span></div>
                					</td>
                				</tr>
                			</table>
