...
String type=request.getParameter("type");
 %>
		...
		function selectBankHPQHH(){
			...
			//检测对付行
			function youcannull(){
				var obj=document.getElementById("billtp");
				var SP=obj.options[obj.selectedIndex].value;
				if(SP!="CT02"){
				  document.getElementById("orgnlpmtbktb").innerHTML=("<input name='orgnlpmtbk' id='orgnlpmtbk' type='text'  maxlength='32' onKeyPress='actkeyPress()' maxlength='32' title='原现金汇票兑付行' />");
				}
			}
	...
	<body onload="getDefaultDate();">
		<form method="post"
			action="<%=path%>/applyReturnedAction.do?method=sendMessage">
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">银行汇票挂失维护
						                  	</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           		 ...
                                           		 <table >
                                                      ...
                                                      <tr>
															...
															<tr>
																...
																<td >
																<select  name="billtp" id="billtp" style="width:180px;" onchange="youcannull();"  title="汇票种类" >
																<option value="${po.notestp}"  'selected' }>
															...
															<tr>
																...
																<td>
																	<input name="billseal" id="" type="text" maxlength="14" readonly="readonly" onKeyPress="numPress()"   title="汇票密押" value="${ po.billSeal}"/>
															...
															<td class="text_tablehead_b"  >
																...
																<td >
																	<input name="issuernm" id="" type="text"   maxlength="60" readonly="readonly" onKeyPress="actkeyPress()" value="${ po.proposernm}"
																		title="汇票申请人名称" />
