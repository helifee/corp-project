								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">银行汇票退回
						                  	</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                                      ...
                                                      <tr>
															...
															<tr>
																...
																<td>
																	...
																	<input name="dbtracct" id="cprq"  type="text" readonly="readonly"  value="${ addentity.issueDt}"
																...
																<td >
																	<input name="issueamt" id="issueamt" type="text"   onKeyPress="amountPress()" readonly="readonly" maxlength="12" value="${po.totalamt}"
