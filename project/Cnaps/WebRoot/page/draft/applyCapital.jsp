	...
	function queryBypaymentGroupNum(paymentGroupNum){
        ...
        PubService.queryOthersBankAccountMsg(paymentGroupNum,function(obj){
		  ...
		  if(obj==null||obj.accountnumber==null){
		      ...
		      document.getElementById("issuernm").value=obj.accountname==null?"": obj.accountname  ;//人名称
		 }
	   	});
	}
		...
		function selectBankHPQHH(){
			...
			function checkAmt(type){    
				var rmnngamt =  document.getElementById("rmnngamt"); //多余金额
				var actntryamt =  document.getElementById("actntryamt"); //实际结算金额
				var issueamt =  document.getElementById("issueamt"); //签发金额
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">申请清算银行汇票资金
						                  	</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           		 ...
                                           		 <table >
                                                      ...
                                                      <tr>
																...
																<td>
																	...
																	onkeyup="limitLength(value,1835,'提示：','notesno')"  title="汇票号码" />
															...
															<tr>
																...
																<td>
																	<input name="billseal" id="" type="text" maxlength="14" onKeyPress="numPress()"   title="汇票密押" />
															...
															<td class="text_tablehead_b"  >
																...
																<td colspan=>
																	...
																	<input type="button" class="button"   value="搜索" onclick="selectBankZHCPR()">
																</td>
																<td class="text_tablehead_b"  >
																	最后持票人开户行名称
																</td>
