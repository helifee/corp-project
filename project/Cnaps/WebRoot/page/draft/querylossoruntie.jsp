...
<body>
<html:form  method="post" action="/applyCapitalAction.do?method=querylossoruntieList">
	        		...
	        		<tr>
	          			...
	          			<div  align="center">
	          				<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">银行汇票挂失解挂查询</span></div>
                					</td>
                				</tr>
                			</table>
	          				<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_head">
                				...
                				<td  class="text_tablehead_b">工作日期</td>
				                  ...
				                  <td class="text_tablehead_b" >
																...
																<td >
																<select  name="po.billstatus" id="po.billstatus" style="width:180px;" title="汇票状态">
																<option value="0"  selected="selected">挂失</option>
																<option value="1"  selected="selected">解挂</option>
		            		...
		            		<div align="center">
		              			<table width="95%"  class="tbcolor">
					                ...
					                <logic:present name="querylossoruntieList">
									  <logic:iterate id="po" name="querylossoruntieList">
										  <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">		
							                  ...
							                  <td  ><div >${po.issueracct }</div></td>
                                               ...
                                               <td  ><div >
                                               	<c:if test="${po.billstatus eq '0' }">挂失</c:if>
													<c:if test="${po.billstatus eq '1' }">解挂</c:if>
												</div></td>
							                 <td  ><div ><span >
					                   ...
					                   <logic:empty name="querylossoruntieList">
					                  	<tr>
