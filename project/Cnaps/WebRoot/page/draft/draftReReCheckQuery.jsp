...
<script language="javascript">
	function viewdetails(id,pmttpbgclsotid,systemcd){
		var newurl = "<%=path %>/TransProcessAction.do?method=sendDetailMessage&pmtgrpid="+id+"&pmttpbgclsotid="+pmttpbgclsotid+"&operway=02"+"&systemcd="+systemcd;
		var oldurl = "<%=path %>/TransProcessAction.do?method=querySendxml&operway=02";
		//viewDetails(newurl);
		viewcheck(newurl,oldurl,"审批界面",document);
		
	}
</script>
</head>
<body>
<html:form  method="post"  action="/draftManageAction.do?method=queryCheckDraft&pmtkdAttr=02901&operway=02">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="O">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">银行汇票审批查询</span></div>
                					</td>
                				</tr>
                			</table>
									  ...
									  <logic:iterate id="po" name="queryList">
										 <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">		
							                  ...
							                  <td  class="text_list"><div align="center"><span class="text_list">
                                               <a href="#"   onClick="viewdetails('${po.pmtgrpid}','${po.pmttpbgclsotid}','${po.systemcd }')"><u>审批</u></a>
                                               </td>					                  
						                  </tr>  
					                  </logic:iterate> 
