...
<script language="javascript">
	...
	function viewdetails(pmtgrpid,type,id){
		var newurl = "<%=path %>/draftManageAction.do?method=gotoTransDetails&id="+id+"&type="+type+"&pmtgrpid="+pmtgrpid;
		viewDetails(newurl);	
	}
...
<%
String type1=request.getParameter("type");//查询类型
String type2=(String)request.getAttribute("type");
if(null!=type1) request.setAttribute("type",type1);
else request.setAttribute("type",type2); 
String pmtkdAttr1=request.getParameter("pmtkdAttr");//业务种类
String pmtkdAttr2=(String)request.getAttribute("pmtkdAttr");//业务种类
if(null!=pmtkdAttr1) request.setAttribute("pmtkdAttr",pmtkdAttr1);
else request.setAttribute("pmtkdAttr",pmtkdAttr2);
String status1=request.getParameter("status");//业务状态
String status2=(String)request.getAttribute("stauts");
if(null!=status1) request.setAttribute("status",status1);
else request.setAttribute("status",status2);
String direction1=request.getParameter("direction");//来往标识
String direction2=(String)request.getAttribute("direction");
if(null!=direction1) request.setAttribute("direction",direction1);
else request.setAttribute("direction",direction2); 
System.out.println("type : "+type2+ "pmtkd:"+pmtkdAttr2+" status:"+status2+"  direction :"+direction2+"------------------------------------------------------------");
 %>
</head>
<body>
<html:form  method="post" action="/draftManageAction.do?method=querySendxml&type=${type}&pmtkdAttr=${pmtkdAttr}&status=${status}">
	        		...
	        		<tr>
	          			...
	          			<div  align="center">
	          				...
	          				<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_head">
                				...
                				<tr>
				                	<td class="text_tablehead_b">支付交易组号<br></td>
				                  	<td  colspan="2">
					                ...
					                <logic:present name="queryList">
									  <logic:iterate id="po" name="queryList">
										  <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">		
							                  ...
							                  <td  ><div >
							                  						<c:if test="${po.pmtkd eq'02901'}">资金移存	</c:if>
