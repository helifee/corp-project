...
<html>
	...
	<body>
		<form method="post"
			...
			<input  id="signmd" name="signmd" type="hidden" maxlength="19" value="03"/><!-- 签发模式 -->
								...
								<td align="center">
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">银行汇票结算帐签发</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
                                                ...
                                                <div class="table_content">
                                                   	<table>
	                                                      ...
	                                                      <tr>
																...
																<td>
																	<input name="dbtramtacctid" id="payAccountId" type="hidden"
																		 title="扣款账号" maxlength="32" 
																		onKeyPress="actkeyPress()" />
																	<input name="dbamtnm" id="payAccountName" type="hidden"
																		title="扣款账号名称" maxlength="60"
	                                                      ...
	                                                      <tr>
															<td class="text_tablehead_b"  >
																...
																<td >
																	<input name="appcertno" id="sgrzjh" type="text" size="19" onblur="checkIdcard(this.value,'sgrzjh')"
