...
String type=request.getParameter("type");
 %>
		...
		function selectBankHPQHH(){
			...
			function fomatMoney(){
				this.document.getElementById("issueamt").value=fmoney(this.document.getElementById("issueamt").value);
			}
	...
	<body onload="fomatMoney();leave();">
		<form method="post"
			action="<%=path%>/jieFuAction.do?method=sendMessage&amp;type=money" name="form1">
											...
											<tr>
												<td>
													<div class="text_title">
														<span class="text_blue2">银行汇票现金解付 </span>
													</div>
												</td>
											</tr>
											<tr>
															...
															<table>
																...
																<tr>
																	...
																	<td class="text_tablehead_b">
																		支付交易组号
																		<input id="pmtgrpid" type="hidden"
																			value="${po.pmtgrpid }">
																	</td>
																	<td>
																		<input name="pmtgrpid" id="pmtgrpid" type="text"
																...
																<tr>
																	...
																	<td>
																		<input name="notesno" id="" type="text" maxlength="60"
																			readonly="readonly" onkeypress="numPress()"
																			title="汇票号码" value="${po.endtoendid}" />
																...
																<td >
																	...
																	<td>
																		<input name="billtp" id="billtp" type="hidden"
																			value="${addentity.billtp}" />
																...
																<tr>
																	...
																	<td>
																		...
																		<input name="dbtracct" id="cprq" type="text"
																			readonly="readonly" value="${ po.signeddt}"
																	...
																	<td>
																		<input name="issueamt" id="" type="text"
																			onkeypress="amountPress()" readonly="readonly"
																			maxlength="12" value="${po.totalamt}"
																...
																<tr>
																	...
																	<td>
																		<input name="billseal" id="" type="text"
																			maxlength="14" readonly="readonly"
																			onkeypress="numPress()" title="汇票密押"
																			value="${addentity.billseal}" />
																...
																<tr>
																	...
																	<td>
																		<input name="issuerbk" id="issuerbk" type="text"
																			readonly="readonly" value="${ po.dbtrissuer}"
																	...
																	<td>
																		<input name="rcvrnm" id="" type="text" maxlength="60"
																			readonly="readonly" onkeypress="actkeyPress()"
																			value="${ po.cdtrnm}" title="汇票收款人名称" />
																		<!--
																<td class="text_tablehead_b"  >
																	签发行名称
																</td>
																...
																<tr>
																	...
																	<td>
																		<input name="issueracct" id="" type="text"
																			maxlength="32" readonly="readonly"
																			onkeypress="actkeyPress()"
																			value="${ po.proposeracct}" title="汇票申请人账号" />
																	...
																	<td>
																		<input name="issuernm" id="" type="text"
																			maxlength="60" readonly="readonly"
																			onkeypress="actkeyPress()" value="${ po.dbtrnm}"
																			title="汇票申请人名称" />
																...
																<tr>
																	...
																	<td id="orgnlpmtbktb">
																		<input name="orgnlpmtbk" id="orgnlpmtbk" type="text"
																			readonly="readonly" maxlength="32"
																			onkeypress="actkeyPress()" value="${ po.dbtrmmbid}"
																...
																<tr>
																	...
																	<td colspan=>
																		<input name="holderBk" id="holderbk" type="text"
																			readonly="readonly" maxlength="12" title="最后持票人开户行" />
																	</td>
																	<td class="text_tablehead_b">
																		最后持票人开户行名称
																	</td>
																	<td colspan=>
																		<input name="holderbkname" id="holderbkname"
																			type="text" readonly="readonly" title="最后持票人开户行名称" />
																	</td>
																</tr>
																...
																<tr>
																	<td></td>
																	<td>
																		<!-- <input type="button" class="button"   value="搜索" onclick="selectBankZHCPR()"></td>-->
																	</td>
																</tr>
																...
																<tr>
																	...
																	<td>
																		<input name="holderacct" id="" type="text"
																			readonly="readonly" maxlength="32" title="最后持票人账号" />
																	</td>
																	<td class="text_tablehead_b">
																		最后持票人名称
																	</td>
																	<td>
																		<input name="holdernm" id="" type="text"
																			maxlength="60" readonly="readonly" title="最后持票人名称" />
																	</td>
																</tr>
																...
																<tr>
																	...
																	<td>
																		<input name="rmnngamt" id="" type="text"
																			maxlength="12" readonly="readonly" title="多余金额" />
																	</td>
																	<td class="text_tablehead_b">
																		实际结算金额
																	</td>
																	<td>
																		<input name="actntryamt" id="" type="text"
																			readonly="readonly" maxlength="12" title="实际结算金额" />
																	</td>
																</tr>
																<tr>
																	<td colspan="4">
																...
																<tr>
																	...
																	<td colspan="3">
																		<textarea name="remarkinfo" id="fy"
																			onkeypress="jsxxcd(this,60)" rows="2" cols="60"
																			onkeyup="limitLength(value,60,'提示：','fy')"></textarea>
																	</td>
																</tr>
																<tr align="center">
																	<td>
