...
<body>
<html:form  method="post" action="/applyCapitalAction.do?method=querySendreturnxml">
	        		...
	        		<tr>
	          			...
	          			<div  align="center">
	          				<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">未用退回查询</span></div>
                					</td>
                				</tr>
                			</table>
		            		...
		            		<div align="center">
		              			<table width="95%"  class="tbcolor">
					                ...
					                <logic:present name="queryreturnList">
									  <logic:iterate id="po" name="queryreturnList">
					                   ...
					                   <logic:empty name="queryreturnList">
					                  	<tr>
