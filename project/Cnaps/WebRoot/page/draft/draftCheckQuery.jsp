...
<script language="javascript">
	function viewdetails(id,pmttpbgclsotid,systemcd){
		var newurl = "<%=path %>/draftManageAction.do?method=sendDetailMessage&pmtgrpid="+id+"&pmttpbgclsotid="+pmttpbgclsotid+"&operway=00"+"&systemcd="+systemcd;
		var oldurl = "<%=path %>/draftManageAction.do?method=querySendxml&operway=00";
		viewDetails(newurl);
		//viewcheck(newurl,oldurl,"复核界面",document);
		
	}
	function viewdetailsback(id,pmttpbgclsotid,systemcd){
		var newurl = "<%=path %>/draftManageAction.do?method=sendDetailMessage&pmtgrpid="+id+"&pmttpbgclsotid="+pmttpbgclsotid+"&operway=001"+"&systemcd="+systemcd;
		viewDetails(newurl);
...
<body>
<html:form  method="post"  action="/draftManageAction.do?method=queryCheckDraft&pmtkdAttr=02901&operway=00">
		...
		<tr>
	  	...
	  	<tr valign="top">
	    	...
	    	<td >
	      			...
	      			<input type="hidden" name="po.systemcd" id="systemcd"  size="32" maxlength="32" value="HVPS"/>
	      		<table width="100%" border="0" cellspacing="0" cellpadding="O">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">银行汇票复核查询</span></div>
                					</td>
                				</tr>
                			</table>
