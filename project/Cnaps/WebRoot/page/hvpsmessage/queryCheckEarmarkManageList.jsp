...
<script language="javascript">
	function viewInfo(id){
		var newurl = "<%=path %>/checkEarmarkManageAction.do?method=findCheckEarmarkManageDetailList&id="+id;
		viewDetails(newurl,"支票圈存管理查询");
	}
</script>
</head>
<body>
<html:form  method="post" action="/checkEarmarkManageAction.do?method=findCheckEarmarkManageList&business=${business}">
          ...
          <td>
            <div align="center">
             <table width="95%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                 <td colspan="6">
                  <div class="text_title"><span class="text_blue2">支票圈存管理查询</span></div>
			 ...
			 <table width="95%" border="0" cellpadding="0" cellspacing="0" style="border:1px #B3B3B3 solid; padding:3px;background: #F2F2F2;">   
                  ...
                  <td width="120">
                  <div align="left">
                   <html:text property="po.workdt" readonly="true" onclick="WdatePicker()"/>
                  </div>
                  </td>
