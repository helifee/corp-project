...
<html:form enctype="multipart/form-data" method="post" action="/generalSignInfoAction.do?method=sendMsg&business=${business}">
	<input id="business_name" type="hidden" value="generalSignInfo">
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">通用签名录入</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
...
<script>
		    var C=AttachXMLForSelect(oxml.XMLDocument,[generalSignInfoForm("transactiontypecode")]);
		</script>
</body>
</html>
