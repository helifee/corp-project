...
<script language="javascript">
	function viewbykey(indentifier,business){
		var newurl = "<%=path %>/querybookAction.do?method=querysendMsgdetail&business="+business+"&detailid=" 
			+ indentifier;
		viewDetails(newurl);
	}
</script>
...
<body>
<html:form  method="post" action="/querybookAction.do?method=querysendMsga">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td>
                						<div  class="text_title"><span class="text_blue2">查复书录入</span></div>
                					</td>
                				</tr>
                			</table>
		            		...
		            		<div align="center">
		              			<table width="95%" class="tbcolor">
					                ...
					                <logic:present name="queryListt">
									  <logic:iterate id="po" name="queryListt">
					                  ...
					                  <td  class="text_list">
            								<a href="page/hvpsmessage/queryreplybook.jsp">发送查复书</a>
					                  </td>
					                  </tr>               
					                  </logic:iterate>
					                                
					                </logic:present>
					                <logic:notPresent name="queryListt">
					                <tr>
