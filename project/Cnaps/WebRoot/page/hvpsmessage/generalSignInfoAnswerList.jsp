...
<script language="javascript">
	function viewdetail(id){
		var newurl = "<%=path %>/generalSignInfoAction.do?method=sendDetailMessage&id="+id;
		viewDetails(newurl);	
	}
</script>
</head>
<body>
<html:form  method="post" action="/generalSignInfoAnswerAction.do?method=querysendMsg&business=${business}">
	  	...
	  	<tr valign="top">
	    	...
	    	<td >
	      		...
	      		<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">通用签名信息应答查询</span></div>
                					</td>
                				</tr>
                			</table>
