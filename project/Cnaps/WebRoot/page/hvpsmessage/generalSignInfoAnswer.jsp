...
<body>
<html:form method="post" action="/generalSignInfoAnswerAction.do?method=sendMsg&business=generalSignInfoAnswer">
	  	...
	  	<tr valign="top">
	    	...
	    	<td >
	      		...
	      		<table width="75%" border="0" cellspacing="0" cellpadding="0" align="center">
			       ...
			       <tr>
					 <td  >
						<div  class="text_title"><span class="text_blue2">通用信息查询应答</span></div>
					</td>
				 </tr>
	        		<tr>
	          			<td>
