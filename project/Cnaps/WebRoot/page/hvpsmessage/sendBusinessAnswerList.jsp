...
<script language="javascript">
	function viewbykey(indentifier,orgCode){
		var newurl = "<%=path %>/businessReturnAction.do?method=viewSendBusAnswerDet&detailid=" 
			+ indentifier;
		viewDetails(newurl);
	}
</script>
...
<body>
<html:form  method="post" action="/businessReturnAction.do?method=querysendAnswerMsg">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">业务退回应答发送查询</span></div>
                					</td>
                				</tr>
                			</table>
