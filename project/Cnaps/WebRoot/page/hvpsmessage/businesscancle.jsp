...
<body>
<html:form method="post" action="/businessCancleAction.do?method=sendMsg&business=${business}">
	<input id="business_name" type="hidden" value="businesscancle">
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">业务撤销录入</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
