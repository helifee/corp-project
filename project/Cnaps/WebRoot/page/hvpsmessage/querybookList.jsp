...
<title> 
	<c:choose> 
		<c:when test="${cxcfbz == '1510931402'}">查询书查询 </c:when>
		<c:when test="${cxcfbz == '1510931403'}">待回复的查询书查询 </c:when>
		<c:when test="${cxcfbz == '1510931502'}">查复书查询 </c:when>
	</c:choose>
 </title>
...
<body>
<html:form  method="post" action="/querybookAction.do?method=querysendMsg">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">查询书查询</span></div>
                					</td>
                				</tr>
                			</table>
