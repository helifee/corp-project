...
<script language="javascript">
	function viewbykey(indentifier,business){
		var newurl = "<%=path %>/netDebitLimitNotifyAction.do?method=sendDetailMessage&business="+business+"&id=" 
			+ indentifier;
		viewDetails(newurl);
	}
</script>
...
<body>
<html:form  method="post" action="/netDebitLimitNotifyAction.do?method=querySendxml">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">净借记限额管理通知查询列表</span></div>
                					</td>
                				</tr>
                			</table>
		              			...
		              			<table width="95%" class="tbcolor">
					                <tr>
					                  ...
					                  <td  align="center" class="text_listhead">通知类型</td> 
					                   <td  align="center" class="text_listhead">通知内容</td>
					                ...
					                <logic:present name="queryList">
									  <logic:iterate id="po" name="queryList">
										  <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">		
							                  ...
							                  <td  class="text_list">${po.recvdrctpty }</td>
							                  <td  class="text_list">${po.notificationtype }</td>
							                  <td  class="text_list">${po.notificationcontent }</td>
							                  <td  class="text_list">${po.remarkinfo }</td>
							                  <td  class="text_list">
                                               <a href="#"   onClick=" viewbykey('${po.msgid}','')"><u>明细</u></a>
                                               </td>   
						                  </tr>
					                  </logic:iterate>                
					                </logic:present>               
