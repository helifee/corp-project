												...
												<td height="30">
													...
													<br/><br/><br/>
														<table class="tbcolor">
															...
															<tr>
																<td   class="text_details_L"   >被监视清算行行号：</td>
																<td class="text_details_R">${entity.memberid}</td>
																<td   class="text_details_L"   >当前可用额度值：</td>
																<td class="text_details_R">${entity.availablenetdebit}</td>
															</tr>
															
															
															<tr>
																<td   class="text_details_L"   >预警通知类型：</td>
																<td class="text_details_R">${entity.warningstatus}</td>
																<td   class="text_details_L"   >可用额度预警值：</td>
