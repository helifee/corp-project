...
<script language="javascript">
	function viewbykey(indentifier,business){
		var newurl = "<%=path %>/sapsNetDebitLimitWarningNotifyAction.do?method=sendDetailMessage&id=" 
			+ indentifier;
		viewDetails(newurl);
	}
</script>
...
<body>
<html:form  method="post" action="/sapsNetDebitLimitWarningNotifyAction.do?method=querySendxml">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">净借记限额可用额度预警值通知列表</span></div>
                					</td>
                				</tr>
                			</table>
		              			...
		              			<table width="95%" class="tbcolor">
					                <tr>
					                  ...
					                  <td  align="center" class="text_listhead">被监视清算行行号</td> 
					                   <td  align="center" class="text_listhead">当前可用额度值</td>
					                   <td  align="center" class="text_listhead">预警通知类型值</td>					                   
					                ...
					                <logic:present name="queryList">
									  <logic:iterate id="po" name="queryList">
										   <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
							                  ...
							                  <td  class="text_list">${po.availablenetdebit }</td>
							                  <td  class="text_list">${po.warningstatus }</td>   
