...
<script language="javascript">
	function viewdetails(indentifier,business){
		var newurl = "<%=path %>/sapsNetDebitLimitAmountAddAction.do?method=sendDetailMessage&id=" 
			+ indentifier;
		viewDetails(newurl);
	}
</script>
...
<body>
<html:form  method="post" action="/sapsNetDebitLimitAmountAddAction.do?method=querySendxml">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">净借记限额圈存资金调增调查询列表</span></div>
                					</td>
                				</tr>
                			</table>
		            		...
		            		<div align="center">
		              			<table width="95%" class="tbcolor">
					                <tr>
					                  ...
					                  <td  align="center" class="text_listhead">调整类型</td> 
					                   <td  align="center" class="text_listhead">调整值</td>
					                ...
					                <logic:present name="queryList">
									  <logic:iterate id="po" name="queryList">
										   <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
							                  ...
							                  <td  class="text_list">${po.adjusttype }</td>
							                  <td  class="text_list">${po.adjustamount }</td>
