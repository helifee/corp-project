...
<script language="javascript">
	function viewbykey(indentifier,business){
		var newurl = "<%=path %>/sapsNetDebitLimitAmountSubAction.do?method=sendDetailMessage&business="+business+"&id=" 
			+ indentifier;
		viewDetails(newurl);
	}
</script>
...
<body>
<html:form  method="post" action="/sapsNetDebitLimitAmountSubAction.do?method=querySendxml">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		...
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">净借记限额圈存资金调减调查询列表</span></div>
                					</td>
                				</tr>
                			</table>
