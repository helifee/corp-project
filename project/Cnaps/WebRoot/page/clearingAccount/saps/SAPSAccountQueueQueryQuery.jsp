...
function querysapsQueryList(){
	...
	document.forms[0].action=getRootPath()+"/transfer/SAPSAccountQueueQueryAction.do?method=queryList";
...
<body>
<html:form method="post" action="/transfer/SAPSAccountQueueQueryAction.do?method=queryList">
          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2"> 清算排队查询申请  </span></div></td><td width="781"></td>
                </tr>
              </table>
			 <table width="95%" border="0" cellpadding="0" cellspacing="0" style="border:1px #B3B3B3 solid; padding:3px;background: #F2F2F2;">
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                <tr>
                 ...
                 <logic:present name="queryslist">
                 <logic:iterate id="hvpsfront141" name="queryslist">
				<tr onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
                 <td  class="text_list">${hvpsfront141.msgId}</td>
                  ...
                  <!--  <a href="#" onClick="detailClient('/transfer/SAPSAccountQueueQueryAction.do?method=queryDetail&id=${hvpsfront141.id}')"><u>明细</u></a>-->
                       <a href="#"   onClick="viewDetails('<%=path %>/transfer/SAPSAccountQueueQueryAction.do?method=queryDetail&id=${hvpsfront141.id}')"><u>明细</u></a>
