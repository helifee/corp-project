...
function querysapsQueryList(){
	...
	document.forms[0].action=getRootPath()+"/transfer/SAPSNettingQueueManagementAction.do?method=queryList";
...
<body>
<html:form method="post" action="/transfer/SAPSNettingQueueManagementAction.do?method=queryList">
          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2"> 轧差排队管理申请  </span></div></td><td width="781"></td>
                </tr>
              </table>
			...
			<tr onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
                <td  class="text_list">${hvpsfront141.msgId}</td>
	              ...
	              <td  class="text_list"><div align="center"><span class="text_list">
	                      <a href="#"   onClick="viewDetails('<%=path %>/transfer/SAPSNettingQueueManagementAction.do?method=queryDetail&id=${hvpsfront141.id}')"><u>明细</u></a>
                   </span></div></td>
