...
<html>
	...
	<tr>
			               ...
			               <tr>
			               		<td  class="text_details_L">渠道报文接收时间：</td><td  class="text_details_R">
			               			${sap.chnDtTm}
			               		</td>
			                   <td  class="text_details_L">报文标识号：</td><td  class="text_details_R">
			                   ${sap.msgId}
			                   </td>
			               </tr>
			               ...
			               <tr>
			                ...
			                ${sap.rjctDesc}
			                 ...
			                 <tr>
			                   ...
			                   <td  class="text_details_L">排队业务数目：</td><td  class="text_details_R">
			               ${sap.queueNumber}
			                   </td>
			               </tr>
			                <tr>
			               		<td  class="text_details_L">排队业务信息：</td><td  class="text_details_R">
			               			${sap.queueDetails}
			               		</td>
