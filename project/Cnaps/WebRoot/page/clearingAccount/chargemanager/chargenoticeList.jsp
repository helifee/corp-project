...
<script language="javascript">
	...
	function viewdetail(id){
		var newurl = "<%=path %>/ChargeNoticeAction.do?method=sendDetailMessage&id="+id;
		viewDetails(newurl);	
	}
</script>
...
<body>
<html:form  method="post" action="/ChargeNoticeAction.do?method=querySendxml">
          ...
          <td>
            <div align="center">
             <table width="95%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td ><div class="text_title"><span class="text_blue2"> 帐号管理通知查询</span></div></td><td width="781"></td>
                </tr>
              </table>
              ...
              <tr>
					                 <td  align="center" class="text_listhead">报文标识号</td>
					                  ...
					                  <td  align="center" class="text_listhead">接收直接参与机构</td>					                  
					                   <td  align="center" class="text_listhead">计息时点个数</td>
					                   <td  align="center" class="text_listhead">透支利息合计</td>					                   
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6"> 
                  <td  class="text_list"><div class="gridCell_standard">${po.msgId }</div></td>
							                  ...
							                  <td  class="text_list"><div class="gridCell_standard">${po.numberOfEntries }</div></td>
							                  <td  class="text_list"><div class="gridCell_standard">${po.totalNetEntryAmount }</div></td>   
