...
<html>
	...
	<tr>
			               ...
			               <tr>
			               		<td  class="text_details_L">	缺款清算行：</td><td  class="text_details_R">${entity.missingdrctpty}</td>
			               		<td  class="text_details_L">应筹金额：</td><td  class="text_details_R">${entity.raisemoney}	</td>
			               </tr>
