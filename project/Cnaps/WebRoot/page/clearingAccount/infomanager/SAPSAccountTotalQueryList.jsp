...
<script language="javascript">
	...
	function viewdetails(id){
		var newurl = "<%=path %>/sapsAccountTotalQueryAction.do?method=sendDetailMessage&id="+id;
		viewDetails(newurl);	
	}
</script>
...
<body>
<html:form  method="post" action="/sapsAccountTotalQueryAction.do?method=querySendxml">
          ...
          <td>
            <div align="center">
             <table width="95%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td><div  class="text_title"><span class="text_blue2">全面流动性查询</span></div></td>
                </tr>
              </table>
			 <table width="95%" border="0" cellpadding="0" cellspacing="0" style="border:1px #B3B3B3 solid; padding:3px;background: #F2F2F2;">
              ...
              <tr>
					                  ...
					                  <td  align="center" class="text_listhead">查询方式</td>					                  
					                  <td  align="center" class="text_listhead">被查询清算行行号</td> 
					                   <td  align="center" class="text_listhead">清算账户和非清算账户合计数</td>
					                   <td  align="center" class="text_listhead">清算账户数</td>					                   
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
							                  ...
							                  <td  class="text_list"><div class="gridCell_standard">${po.manageridentification }</div></td>
							                  <td  class="text_list"><div class="gridCell_standard">${po.totalaccount }</div></td>
							                  <td  class="text_list"><div class="gridCell_standard">${po.numberofsettlementaccount }</div></td>   
