...
<script language="javascript">
	...
	function viewdetails(id){
		var newurl = "<%=path %>/sapsAccountWarningNotifyAction.do?method=sendDetailMessage&id="+id;
		viewDetails(newurl);	
	}
</script>
...
<body>
<html:form  method="post" action="/sapsAccountWarningNotifyAction.do?method=querySendxml">
          ...
          <td>
            <div align="center">
             <table width="95%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                <td><div  class="text_title"><span class="text_blue2"> 余额告警通知查询</span></div></td>
                </tr>
              </table>
            ...
            <tr>
              ...
              <tr>
					            <td  align="center" class="text_listhead">报文标识号</td>
					                  ...
					                  <td  align="center" class="text_listhead">被监视清算行行号</td>					                  
					                  <td  align="center" class="text_listhead">预警通知类型</td> 
					                   <td  align="center" class="text_listhead">警戒金额</td>
					                   <td  align="center" class="text_listhead">警戒金额正负标志</td>
					                    <td  align="center" class="text_listhead">当前余额</td>					                   
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
							                  ...
							                  <td  class="text_list"><div class="gridCell_standard">${po.memberid }</div></td>
							                  <td  class="text_list"><div class="gridCell_standard">${po.warningtype }</div></td>
							                  <td  class="text_list"><div class="gridCell_standard">${po.warningvalue }</div></td>
							                  <td  class="text_list"><div class="gridCell_standard">${po.warningplusminustype }</div></td>
							                  <td  class="text_list"><div class="gridCell_standard">${po.currentbalance }</div></td>    
