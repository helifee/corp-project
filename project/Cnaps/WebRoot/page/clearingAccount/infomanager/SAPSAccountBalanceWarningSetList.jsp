...
<script language="javascript">
	...
	function viewdetails(id){
		var newurl = "<%=path %>/sapsAccountBalanceWarningSetAction.do?method=sendDetailMessage&id="+id;
		viewDetails(newurl);	
	}
</script>
...
<body>
<html:form  method="post" action="/sapsAccountBalanceWarningSetAction.do?method=querySendxml">
          ...
          <td>
            <div align="center">
             <table width="95%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td ><div  class="text_title"><span class="text_blue2">余额警戒值查询 </span></div></td>
              ...
              <tr>
					                <td  align="center" class="text_listhead">报文标识号</td>
					                  ...
					                  <td  align="center" class="text_listhead">预警开启关闭类型</td> 
					                   <td  align="center" class="text_listhead">清算账户警戒金额</td>
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
							                  ...
							                  <td  class="text_list"><div class="gridCell_standard">${po.switchtype }</div></td>
