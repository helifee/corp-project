...
<html>
	...
	<tr>
			               ...
			               <tr>
			               		<td  class="text_details_L">		日初余额：</td><td  class="text_details_R">${entity.initialamount}</td>
			               		<td  class="text_details_L">本日借方发生额：</td><td  class="text_details_R">${entity.dailydebtoramount}	</td>
			               </tr>
			               
			               <tr>
			                   <td  class="text_details_L">	本日贷方发生额： </td><td  class="text_details_R">${entity.dailycreditoramount}</td>
			                   <td  class="text_details_L">日终余额： </td><td  class="text_details_R">${entity.finalamount}</td>
			                  
			               </tr>
			                <tr>
			                   <td  class="text_details_L">	明细数目： </td><td  class="text_details_R">	${entity.numberoftransaction}</td>
			                   <td  class="text_details_L">明细清单： </td><td  class="text_details_R">${entity.transactionlist}</td>
