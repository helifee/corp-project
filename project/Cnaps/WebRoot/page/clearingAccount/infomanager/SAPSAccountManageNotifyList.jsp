...
<script language="javascript">
	...
	function viewdetails(id){
		var newurl = "<%=path %>/sapsAccountManageNotifyAction.do?method=sendDetailMessage&id="+id;
		viewDetails(newurl);	
	}
</script>
...
<body>
<html:form  method="post" action="/sapsAccountManageNotifyAction.do?method=querySendxml">
          ...
          <td>
            <div align="center">
             <table width="95%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                <td><div  class="text_title"><span class="text_blue2">账户管理通知查询 </span></div></td>
                </tr>
              </table>
              ...
              <tr>
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
                  <td  class="text_list"><div class="gridCell_standard">${po.msgid }</div></td>
							                  ...
							                  <td  class="text_list"><div class="gridCell_standard">${po.notificationtype }</div></td>
							                  <td  class="text_list"><div class="gridCell_standard">${po.notificationcontent }</div></td>   
