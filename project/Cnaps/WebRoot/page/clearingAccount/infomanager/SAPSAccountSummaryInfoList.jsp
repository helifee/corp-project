...
<script language="javascript">
	...
	function viewdetails(id){
		var newurl = "<%=path %>/sapsAccountSummaryInfoAction.do?method=sendDetailMessage&id="+id;
		viewDetails(newurl);	
	}
</script>
...
<body>
<html:form  method="post" action="/sapsAccountSummaryInfoAction.do?method=querySendxml">
          ...
          <td>
            <div align="center">
             <table width="95%"  border="0" cellpadding="0" cellspacing="0">
                ...
                <td><div  class="text_title"><span class="text_blue2">日报表下载查询</span></div></td>
                </tr>
              </table>
            ...
            <tr>
              ...
              <tr>
					              <td  align="center" class="text_listhead">报文标识号</td>
					                  ...
					                  <td  align="center" class="text_listhead">日初余额</td>					                  
					                  <td  align="center" class="text_listhead">日终余额</td> 
					                   <td  align="center" class="text_listhead">明细数目</td>
					                   <td  align="center" class="text_listhead">明细清单</td>					                   
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
							                  ...
							                  <td  class="text_list"><div class="gridCell_standard">${po.initialamount }</div></td>
							                  <td  class="text_list"><div class="gridCell_standard">${po.finalamount }</div></td>
							                  <td  class="text_list"><div class="gridCell_standard">${po.numberoftransaction }</div></td>
							                  <td  class="text_list"><div class="gridCell_standard">${po.transactionlist }</div></td>   
