             ...
             <tr>
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                 <tr>
					                  ...
					                  <td  align="center" class="text_listhead">拆入清算行行号</td>					                  
					                  <td  align="center" class="text_listhead">拆出清算行行号</td>
					                   <td  align="center" class="text_listhead">自动拆借管理类型</td>	
					                     <td  align="center" class="text_listhead">拆借协议号</td> 
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
                  <td  class="text_list"><div class="gridCell_standard">${po.msgId }</div></td>
							                  ...
							                  <td  class="text_list"><div class="gridCell_standard">
							                  		<c:if test="${po.interbankLoanManagementType eq 'PC00'}">签约</c:if>
													<c:if test="${po.interbankLoanManagementType eq 'PC01'}">撤销</c:if>
													<c:if test="${po.interbankLoanManagementType eq 'PC02'}">额度恢复</c:if>
							                  </div></td>
