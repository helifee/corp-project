...
<body>
<form method="post" action="<%=path%>/transfer/transferManage/pvpAction.do?method=queryPVPbforCheck">
					...
					<td >
						...
						<tr>
							<td  width="360" class="text_tablehead_b">
								<h5 align="left">&nbsp;大额支付系统&nbsp;->pvp结算申请业务->pvp结算申请复核</h5>
							</td>
							<td  width="194" ></td>
							<td  width="270"  ></td>
						</tr>
			 ...
			 <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px #99bbe8 solid; padding:3px;" >
              ...
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbcolor">
                ...
                <logic:present name="hvpsfront141List">
                 ...
                 <a href="#" onClick="checkfindTransferOfClientById('${hvpsfront141.id}')"><u>复核</u></a>
