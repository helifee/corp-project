...
<html>
	...
	<body >
		<form method="post" action="<%=path%>/transfer/transferManage/pvpAction.do?method=checkPVPSendXML">
							...
							<tr>
								...
								<td>
									<div align="center">
												...
												<td>
													...
													<table border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td><input name="purchspric" id="purchspric" type="text" style="width:180px;" maxlength="32" title="买入价" onKeyPress="amountPress()"
															...
															<td><input name="buyamt" id="buyamt" type="text" style="width:180px;" title="买入外汇数"  /></td>
													...
													<table border="0" cellspacing="0" cellpadding="0">
														...
														<td class="text_tablehead_b" align="right" style="width:180px;">付款清算行行号：</td>
															<td><input name="senddrctpty" id="senddrctpty" type="text" style="width:180px;" title="付款清算行行号"  /></td>
														
															<td class="text_tablehead_b" align="right" style="width:180px;">付款行行号：</td>
															<td><input name="sendindrctpty" id="sendindrctpty" type="text" style="width:180px;" title="付款行行号"  /></td>
													...
													<table border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															...
															<td><input name="recvdrctpty" id="hvps11120" type="text" style="width:180px;" title="收款清算行行号"  /></td>
															<td class="text_tablehead_b" align="right" style="width:180px;">收款行行号：</td>
															<td><input name="recvindrctpty" id="hvps11116" type="text" style="width:180px;" title="收款行行号"   /></td>
														</tr>
										...
										<br />
										<br />
										<input name="addButton" type="button" style="cursor: pointer" class="button" value="复核" onclick="commitForm();" />
										&nbsp;
