...
<body>
<html:form method="post" action="/transfer/transferManage/pvpAction.do?method=modPVPClient">
					...
					<td >
						...
						<tr>
							<td  width="360" class="text_tablehead_b">
								<h5 align="left">&nbsp;大额支付系统&nbsp;->pvp结算申请业务->pvp结算申请修改</h5>
							</td>
							<td  width="194" ></td>
							<td  width="270"  ></td>
						</tr>
            ...
            <table width="95%" height="30" border="0" cellpadding="0" cellspacing="0" > 
			 ...
			 <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px #99bbe8 solid; padding:3px;" >
               <tr>
                  ...
                  <td width="120"><div align="left">
                  <input type="text" name="senddrctpty"/>
                                 </div></td>
                    <td width="120" height="40" class="text_tablehead_b">买入价：</td>
                  <td width="120"><div align="left">
                     <input type="text" name="purchspric"/>
                                 </div></td>
              ...
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbcolor">
                ...
                <td   align="center" class="text_listhead">交易流水号</td>
                 ...
                 <td   align="center" class="text_listhead">录入人</td>
                  <td   align="center" class="text_listhead">锁定人</td>
                  <td   align="center" class="text_listhead">锁定状态</td>
                  <td   align="center" class="text_listhead">数据操作</td>
                </tr> 
                <logic:present name="hvpsfront141List">
                 <logic:iterate id="hvpsfront141" name="hvpsfront141List">
                  ...
                  <td  class="text_list">${hvpsfront141.inputteller}</td>
                  <td  class="text_list">${hvpsfront141.lockteller}</td>
                  <td  class="text_list">${hvpsfront141.lockflag}</td>
	              <td  class="text_list"><div align="center"><span class="text_list">
                  <a href="#" onClick="detailTransferOfClient('${hvpsfront141.id}')"><u>明细</u></a>
                 <a href="#" onClick="updateTransferOfClient('${hvpsfront141.id}')"><u>修改</u></a>
                 <a href="#" onClick="delTransferOfClient('${hvpsfront141.id}')"><u>删除</u></a>
