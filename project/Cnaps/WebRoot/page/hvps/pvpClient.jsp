...
<html>
	...
	<body >
		<html:form method="post" action="/transfer/transferManage/pvpAction.do?method=addPVPClient">
					...
					<td >
						<table width="100%" height="48" border="0" cellpadding="0" cellspacing="0">
							...
							<td  width="360" class="text_tablehead_b">
									<h5 align="left">大额支付系统&nbsp;->&nbsp;PVP结算申请&nbsp;->PVP结算申请${pvpform==null ? "录入": "复核"}</h5>
								</td>
								<td  width="194" ></td>
								<td  width="270"  ></td>
							</tr>
								...
								<td>
									<div align="center">
										<table border="0" cellspacing="0" cellpadding="0">
											<th class="text_tablehead_b" ><h4 align="center">PVP结算申请${pvpform==null ? "录入": "复核"}</h4></th>
											<tr>
												<td>
													...
													<table border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td><input name="purchspric" id="purchspric" type="text" style="width:180px;" maxlength="21" title="买入价"  onKeyPress="amountPress()"
															...
															<td><input name="buyamt" id="buyamt" type="text" style="width:180px;" title="买入外汇数" maxlength="21" onKeyPress="numPress()" /></td>
														...
														<tr>
															...
															<td><input name="currency" id="currency" type="text" style="width:180px;" title="货币符号" value="CNY" readonly="readonly"   /> </td>
															
															<td class="text_tablehead_b" align="right">手续费金额：</td>
															<td><input name="charge" id="charge" type="text" style="width:180px;" title="手续费金额" value="${pvpform.charge}" maxlength="21" onKeyPress="amountPress()"
															onkeyup="value=value.replace(/[^\d.,]/g,'')  "
															onblur="value=fmoney(value, 2);if(value == 'NaN.undefined') value = '';"/></td>
														</tr>
														<tr>
														<!--
															<td class="text_tablehead_b" align="right">业务优先级：</td>
															<td><input name="sttlmprty"id="hvps11110" type="text" style="width:180px;" title="业务优先级"/></td>
														-->
															<td class="text_tablehead_b" align="right">备注：</td>
																<td><textarea  name="remarkinfo" id="remarkinfo" style="width:180px" rows="4" title="备注"  onKeyPress="charPress()" >${pvpform.remarkinfo}</textarea></td>
														</tr>
													</table>
													</fieldset>
													<fieldset style="width:700px;border:1px #CCCCCC solid; padding:3px;" align="center" >
													...
													<table border="0" cellspacing="0" cellpadding="0">
														...
														<td class="text_tablehead_b" align="right" style="width:180px;">付款清算行行号：</td>
															<td><input name="senddrctpty" id="senddrctpty" type="text" style="width:180px;" title="付款清算行行号"  maxlength="12" /></td>
														
															<td class="text_tablehead_b" align="right" style="width:180px;" >付款行行号：</td>
															<td><input name="sendindrctpty" id="sendindrctpty" type="text" style="width:180px;" title="付款行行号" maxlength="12" /></td>
													...
													<table border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															...
															<td><input name="recvdrctpty" id="hvps11120" type="text" style="width:180px;" title="收款清算行行号"  maxlength="12"/></td>
															<td class="text_tablehead_b" align="right" style="width:180px;">收款行行号：</td>
															<td><input name="recvindrctpty" id="hvps11116" type="text" style="width:180px;" title="收款行行号"  maxlength="12" /></td>
														</tr>
