...
<html>
	...
	<body>
		<form name="form1" method="post"
			action="<%=path%>/cashJiefuAction.do?method=sendMessage&type=money">
			...
			<input id="issueState" name="po.issueState" type="hidden" value="CN">
											...
											<tr>
												<td>
													<div class="text_title">
														<span class="text_blue2">银行本票解付</span>
													</div>
												</td>
											</tr>
											<tr>
