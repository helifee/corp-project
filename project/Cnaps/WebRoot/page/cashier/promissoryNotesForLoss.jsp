...
<html>
	...
	<body>
		<form name="form1" method="post"
			action="<%=path%>/cashGuashiAction.do?method=sendMessage">
											...
											<tr>
												<td>
													<div class="text_title">
														<span class="text_blue2">银行本票现金挂失</span>
													</div>
												</td>
											</tr>
											<tr>
                                                         ...
                                                         <tr>
															...
															<tr>
															 <td class="text_tablehead_b">
																	...
																	<td>
																		<input name="po.helpproposerNm" id="helpproposerNm" type="text"
																			title="协助挂失申请人名称" maxlength="60" onKeyPress="charPress()" />
																		<span name="validate" dataName="po.helpproposerNm" dataType="Empty" msg="协助挂失申请人名称不能为空！" class="STYLE1">*</span>	
                                                    		...
                                                    		<tr>
																...
																<td colspan="3">
																	<textarea name="po.lossreason" id="lossreason"   onKeyPress="jsxxcd(this,60)"
																	 cols="60" onKeyPress="charPress()" onkeyup="limitLength(value,135,'提示：','lossreason')"></textarea>
																	 <span name="validate" dataName="po.lossreason" dataType="Empty" msg="挂失事由不能为空！" class="STYLE1">*</span>
																</td>
