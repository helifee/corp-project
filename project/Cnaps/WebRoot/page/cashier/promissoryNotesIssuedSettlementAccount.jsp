...
<html>
	<head>
		...
		<script language="javascript">
			function commitForm(){
			   ...
			   var proposerAcct = document.getElementById("proposerAcct");//申请人账号
			   ...
			   var totalMoney = document.getElementById("totalMoney");
				    ...
				    if(isNull(trim(proposerAcct.value))){
						msg += proposerAcct.title+"不能为空！@";
				    }
			...
			var pop = createPopWin("popid",'系统正处理...',"<%=request.getContextPath()%>/page/transfer/shouquanCons.jsp");
				...
				PubService.QueryAccount(paymentGroupNum,function(obj){
					...
					if(obj==null||obj.acctid==null){
						...
						document.getElementById("proposerNm").value=obj.mm==null?"": obj.mm;//名称
	...
	<body onload="sendDate()">
		<form  name="form1" method="post"
		  ...
		  <input name="po.payBankName" id="fkhmc" type="hidden" title="付款行名称" value="${bankInfo.participantname }"/>
		  <input type="hidden" name="po.payBankNum" id="fkhhh"  title="付款行行号" value="${bankInfo.bankcode }"/>
								...
								<td>
									...
									<br/>
						               <table width="689" border="0" cellspacing="0" cellpadding="0" >
                                          <tr>
						                  <td  >
						                  	<div  class="text_title"><span class="text_blue2">银行本票结算帐签发</span></div>
						                  </td>
						                </tr>
                                         <tr>
                                           <td>
														...
														<div class="table_content">
															<table>
																...
																<td class="text_tablehead_b">
																	...
																	<td>
																		<input name=po.proposerAcct id="proposerAcct" type="text"
																			title="申请人账号" maxlength="60" onKeyPress="charPress()" 
																...
																<tr>
																	...
																	<td>
																	<input type="hidden" name="po.certsize" id="certsize1" />
