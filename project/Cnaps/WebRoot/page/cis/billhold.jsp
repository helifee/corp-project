...
function fileselect(imgFile){ 
    ...
    var length= this.document.getElementById("gkzjgzdfjjhb_mx").rows.length	;//得到的删除前的值
		 ...
		 this.document.getElementById("numOfEndrsr").value=length;
			   ...
			   var msg = "@";
			var pmtkd = document.getElementById("pmtkd");//业务种类编码
			// var agrmtNb = document.getElementById("agrmtNb");//合同协议号
			var rcptLtd = document.getElementById("rcptLtd");//	回执期限
			 
			 
		 			var proposerAcctTp = document.getElementById("proposerAcctTp");//申请人账户类型
			var dbtrbrnchid = document.getElementById("dbtrbrnchid");//付款行行号
			var dbtracct = document.getElementById("dbtracct");//付款人账号
			var dbtrissuer = document.getElementById("dbtrissuer");//付款人开户行行号
			var cdtrbrnchid = document.getElementById("cdtrbrnchid");//收款行行号
			var cdtrbrnchnm = document.getElementById("cdtrbrnchnm");//收款行名称
			...
			if(isNull(trim(cdtracct.value))){
			 ...
			 var applyNm=document.getElementById("applyNm") ;
			              if(isNull(trim(applyAcct.value))){
					          msg += "业务种类为商业本票时:  "+applyAcct.title+"不能为空！@";
				          }
				          if(isNull(trim(applyNm.value))){
					          msg += "业务种类为商业本票时:  "+applyNm.title+"不能为空！@";
				          }
			 }
			    ...
			    var drawerNm =document.getElementById("drawerNm") ;
			     var trnsctnCntrctNo =document.getElementById("trnsctnCntrctNo") ;
			                    ...
			                    if(isNull(trim(maturityDt.value))){
					               msg += "业务种类为商业承兑汇票时：  "+maturityDt.title+"不能为空！@";
				               }
				                if(isNull(trim(accptncDt.value))){
					               msg += "业务种类为商业承兑汇票时：  "+accptncDt.title+"不能为空！@";
				               }
				                if(isNull(trim(accptncNm.value))){
					               msg += "业务种类为商业承兑汇票时：  "+accptncNm.title+"不能为空！@";
				               }
				               if(isNull(trim(drawerNm.value))){
					               msg += "业务种类为商业承兑汇票时：  "+drawerNm.title+"不能为空！@";
				               }
				               if(isNull(trim(trnsctnCntrctNo.value))){
					               msg += "业务种类为商业承兑汇票时：  "+trnsctnCntrctNo.title+"不能为空！@";
				               }
			 ...
			 if(pmtkd.value=="03404"){
			      ...
			      var accptncNm =document.getElementById("accptncNm") ;
			       ...
			       if(isNull(trim(maturityDt.value))){
					               msg += "业务种类为银行承兑汇票时：  "+maturityDt.title+"不能为空！@";
				               }
			       if(isNull(trim(accptncagrmntNo.value))){
					               msg += "业务种类为银行承兑汇票时：  "+accptncagrmntNo.title+"不能为空！@";
				               }
				   if(isNull(trim(accptncDt.value))){
					               msg += "业务种类为银行承兑汇票时：  "+accptncDt.title+"不能为空！@";
				               }         
				    if(isNull(trim(accptncNm.value))){
					               msg += "业务种类为银行承兑汇票时：  "+accptncNm.title+"不能为空！@";
				               }            
			        if(isNull(trim(drawerAcct.value))){
					               msg += "业务种类为银行承兑汇票时：  "+drawerAcct.title+"不能为空！@";
				               }  
			       if(isNull(trim(trnsctnCntrctNo.value))){
					               msg += "业务种类为银行承兑汇票时：  "+trnsctnCntrctNo.title+"不能为空！@";
				               } 
...
<form name="form1" enctype="multipart/form-data" method="post" action="<%=path%>/ChequeholdAction.do?method=billhold">
	...
	<input id="contrperson" name="bill.warrantyId" type="hidden" ><!-- 授权柜员(手续费) -->
				      		...
				      		<table width="689" border="0" cellspacing="0" cellpadding="0" >
				        		<tr>
						        	<td>
											 ...
											 <div class="text_title"><span class="text_blue2">通用票据截留</span></div> 
						          			...
						          			<table>
				                			    <tr>
				                				 ...
				                				 <tr>
								                  	...
								                  	<td colspan="4">
								                   		<input type="text"  name="bill.pmtgrpid" id="pmtgrpid"  title="支付交易组号"  readonly="readonly" maxlength="20" value="${transId}"/><font color="#FF0000">*</font>
								                   	</td>
								                 </tr>
				                				 <tr>
				                					<td class="text_tablehead_b"  >
								                  	...
								                  	<td>
								                   		<select name="bill.pmtTp" id="pmttp"  >
								                   			<option value="B309">通用票据截留</option>
								                  	...
								                  	<td >
								                   		<select name="bill.pmtKd" id="pmtkd"  onchange="ch_cxtj(this);" title="业务种类编码" >
								                   		 <option value="">请选择 </option>
								                   			<!--   <option value="03402">银行汇票 </option>-->
								                   			<option value="03403">商业承兑汇票 </option>
								                   			<option value="03404">银行承兑汇票 </option>
								                   			<option value="03405">商业本票 </option>
								                   			<!--<option value="03406">银行本票 </option>-->
								                 ...
								                 <tr>
								                 	<td class="text_tablehead_b" >
								                  	...
								                  	<td >
								                   		<input type="text"  name="bill.agrmtNb" id="agrmtNb"  title="合同协议号"  maxlength="60"/>
						                ...
						                <div class="table_content">
						          			<table>
				                				  ...
				                				  <tr>
								                  	...
								                  	<td >
								                   		<input type="text" name="bill.cdtrAcct" id="cdtracct" title="收款人账号"  maxlength="32" onblur="PubQueryAccount(this.value);" />
								                   		<font color="#FF0000">*</font>
								                  	</td>
								                  	<td class="text_tablehead_b">
								                  		收款人名称
								                  	...
								                  	<td>
								                   		<input type="text" name="bill.cdtrNm" id="cdtrnm" title="收款人名称" readonly="readonly"  maxlength="60" />
								                   		<font color="#FF0000">*</font>
								                  	</td>
								                 </tr>
				                				 <tr>
								                  ...
								                  <tr>
								                  	...
								                  	<td>
								                   		<input type="text" name="bill.proposerTel"  readonly="readonly" title="收款人联系电话" id="proposerTel" maxlength="20"/>
								                    </td>
								                    <td  class="text_tablehead_b">
								                  		收款人客户号
								                  	</td>
								                  	<td  >
								                   		<input type="text" name="bill.proposerCstmrId"  id="proposerCstmrId" readonly="readonly" title="收款人客户号" maxlength="30"/>
								                ...
								                <tr>
								                  	...
								                  	<td >
								                   		<input type="text" name="bill.proposerAcctCcy"  id="proposerAcctCcy"  
								                   			title="收款人账户币种" value="CNY" readonly=readonly maxlength="3"/>
								                  	</td>
								                  	<td class="text_tablehead_b" >
								                  		收款人账户类型
								                  	</td>
								                  	<td>
								                  		<input type="hidden" name="bill.proposerAcctTp" id="proposerAcctTp" title="收款人账户类型" >
								                 ...
								                 <tr>
				                					...
				                					<td class="text_tablehead_b">
								                  	...
								                  	<td>
								                   		<input type="hidden" name="bill.cdtrBrnchId" id="cdtrbrnchid" title="收款行行号"    maxlength="14" readonly="readonly" 
								                  	...
								                  	<td>
								                   		<input type="hidden" name="bill.cdtrBrnchNm" id="cdtrbrnchnm"  title="收款行名称"  readonly="readonly"
								                  ...
								                  <!-- 	收款人开户行行号 -->	
								                  	...
								                  	<td>
								                   		<input type="hidden" name="bill.cdtrIssuer" id="cdtrissuer" title="收款人开户行行号" value="${bankInfo.bankcode }" maxlength="14" readonly="readonly" style="width:100px;"/>
								                  	...
								                  	<td >
								                   		<input type="hidden" name="bill.cdtrIssuerNm" id="cdtrissuernm" title="收款人开户行名称"  value="${bankInfo.participantname }" maxlength="60" readonly="readonly"/>
								                   	</td>
								                   </tr>
								                 ...
								                 <tr>
								                	<td>
								                  	...
								                  	<tr>
									                  	...
									                  	<td >
									                   		<input type="text" name="bill.dbtrAcct"  id="dbtracct"  title="付款人账号" maxlength="32" onblur="queryBypaymentGroupNum(this.value)"/>
									                   		<font color="#FF0000">*</font>
									                  	</td>
									                  	<td class="text_tablehead_b">
								                  		付款人名称
								                  	...
								                  	<td>
								                   		<input type="text" name="bill.dbtrNm" id="dbtrnm" title="付款人名称" maxlength="60" />
								                   		<font color="#FF0000">*</font>
								                  	</td>
								                  	</tr>
								                  	<tr>
								                  	...
								                  	<td>
								                   		<input type="text" name="bill.dbtrBrnchId" id="dbtrbrnchid" maxlength="14"  title="付款行行号" readonly="readonly" style="width:100px;"/>
								                  	...
								                  	<td>
								                   		<input type="text" name="bill.dbtrBrnchNm" id="dbtrbrnchnm"  title="付款行名称" readonly="readonly"
								                   		maxlength="60"  value=""/>
								                   		<font color="#FF0000">*</font>
								                  	</td>
								                  	</tr>
								                  	...
								                  	<td>
								                   		<input type="hidden" name="bill.dbtrIssuer" id="dbtrissuer" title="付款人开户行行号" maxlength="14" readonly="readonly" style="width:100px;"/>
								                  	...
								                  	<td>
								                   		<input type="hidden" name="bill.dbtrIssuerNm" id="dbtrissuernm" title="付款人开户行名称"  maxlength="60" readonly="readonly"/>
								                  	</td>
								                  	</tr>
								                  	<tr>
								                  			<td class="text_tablehead_b">
								                  	...
								                  	<td>
								                   		<input type="hidden" name="bill.dbtrMmbId" id="dbtrmmbid" title="付款清算行行号" maxlength="14" readonly="readonly"
								                   		 />
			          				    ...
			          				    <div class="table_content">
							               <table>
							                 ...
							                 <tr>
							                  	...
							                  	<td>
							                   		<input type="text" name="bill.totalamt" id="totalamt" maxlength="9" title="总额"
							                   		 readonly="readonly"
							                 ...
							                 <tr>
							                  	...
							                  	<td colspan="4">
							                   		<input type="text" name="bill.amount" id="amount" title="交易金额"
							                   		 maxlength="9" 
							                   		 onKeyPress="amountPress()"
																		onkeyup="value=value.replace(/[^\d.,]/g,'')  "
					...
					<td >					
						...
						<input type="radio" class="text_tablehead_b_rad" name="po.waive" id="waiven" value="N"  onclick="clrAmt0()">不收取
							                  	...
							                  	<tr>
								                  	...
								                  	<td>
								                   		<input type="text" name="bill.serviceCharge" id="sxf" title="手续费"
								                  		...
								                  		<td class="text_tablehead_b" >
																...
																<td>
																	<input name="bill.systemcd" id="xth" type="hidden" title="系统号" maxlength="12" value=""/> 
							                  ...
							                  <td class="text_tablehead_b"  >
								                  	...
								                  	<td>
								                   		<input type="text" name="bill.postage" id="ydf" title="邮电费" 
							                  	...
							                  	<td><input type="text" name="bill.outstationCharge" id="ydjs" title="异地加收"
							                   		 maxlength="9"  readonly="readonly"
							                   		 onKeyPress="amountPress()"
																		onkeyup="value=value.replace(/[^\d.,]/g,'')  "
																		onblur="value=fmoney(value, 2);if(value == 'NaN.undefined') value = ''; jisuan();" 
							                  	...
							                  	<td>
							                   			<input type="hidden" name="bill.agncyCharge" id="agncycharge" title="代理行手续费"
							                   		maxlength="9" 
							                   		 onKeyPress="amountPress()"
																		onkeyup="value=value.replace(/[^\d.,]/g,'')  "
																		onblur="value=fmoney(value, 2);if(value == 'NaN.undefined') value = ''; jisuan();" 
								                  ...
								                  <tr>
								                  	...
								                  	<td colspan="4">
								                   		<textarea name="bill.addtlInf" id="addtlInf" cols="60" rows="2"
								                   		 onKeyPress="charPress()" onkeyup="limitLength(value,256,'提示：','addtlInf')"
								                   		 ></textarea>
								                  	</td>
								                  </tr>
							                    </table>
						               		...
						               		<tr>
							                	<td>
									                ...
									                <table   border="0"   cellpadding="0" cellspacing="0" >
										                ...
										                <td ><!-- value="${sessionScope.workFormatDate }" 默认日期 -->
										                 	<input type="text" name="bill.issueDt" id="issueDt"  title="出票日期"   readonly="readonly" class="Wdate"  onclick="WdatePicker()"/><font color="#FF0000">*</font>
										                </td>
										                <td  class="text_tablehead_b" >
										                   	提示付款日期
										                </td>
										                <td >
										                 	<input type="text" name="bill.payDt" id="payDt"   title="提示付款日期"  readonly="readonly"    class="Wdate"  onclick="WdatePicker()"  /><font color="#FF0000">*</font>
										                </td>
										             ...
										             <tr>
										                ...
										                <td>
										                 	<input type="text" name="bill.notesNo" id="notesNo" title="票据号码" maxlength="32" onkeypress="amountPress()"  /><font color="#FF0000">*</font>
										                </td>
										                	 <td class="text_tablehead_b">
										                出票金额
										                </td>
										                <td>
										                 	<input type="text" name="bill.issueAmt" id="issueAmt" title="出票金额" maxlength="10" readonly="readonly"
										                 	onKeyPress="amountPress()"
																		onkeyup="value=value.replace(/[^\d.,]/g,'')  "
										             ...
										             <tr>
										                ...
										                <td>
										                 	<input type="password" name="bill.pymntPswd" id="pymntPswd" maxlength="10" title="支付密码"  /> 
										                </td>			
										                <td class="text_tablehead_b">
										                 用途
										                </td>
										                <td>
										                 	<input type="text" name="bill.purpose" id="purpose" title="用途" /> 
										                </td>
									                 </tr>
									                  ...
									                  <tr>
										                ...
										                <td>
										                 	<input type="text" name="bill.maturityDt" id="maturityDt" maxlength="10" title="汇票到期日期"  readonly="readonly" class="Wdate"  onclick="WdatePicker()" /> 
										                </td>			
										                <td class="text_tablehead_b">
										                汇票密押
										                </td>
										                <td>
										                 	<input type="text" name="bill.billSeal" id="billSeal" title="汇票密押" /> <font color="#FF0000">*</font>
										                </td>
									                 </tr>
										                ...
										                <td>
										                 	<input type="text" name="bill.accptncagrmntNo" id="accptncagrmntNo" maxlength="10" title="承兑协议编号"  />  
										                </td>			
										                <td class="text_tablehead_b">
										               承兑日期
										                </td>
										                <td>
										                 	<input type="text" name="bill.accptncDt" id="accptncDt" title="承兑日期"  readonly="readonly" class="Wdate"  onclick="WdatePicker()"/> 
										                </td>
									                 </tr>
										            ...
										            承兑人 
										                ...
										                <td>
										                 	<input type="text" name="bill.accptncNm" id="accptncNm" maxlength="10" title="承兑人 "  /> 
										                </td>
										                      <td class="text_tablehead_b">
										           交易合同号码
										                </td>
										                <td>
										                 	<input type="text" name="bill.trnsctnCntrctNo" id="trnsctnCntrctNo" maxlength="10" title="交易合同号码"  />
										                </td>				
										           ...
										           票据申请人账号
										                ...
										                <td>
										                 	<input type="text" name="bill.applyAcct" id="applyAcct" maxlength="10" title="票据申请人账号"  /> 
										                </td>			
										                 <td class="text_tablehead_b">
										               票据申请人名称
										                </td>
										                <td>
										                 	<input type="text" name="bill.applyNm" id="applyNm" title="票据申请人名称" /> 
										                </td>
										              ...
										              出票人账号
										                ...
										                <td>
										                 	<input type="text" name="bill.drawerAcct" id="drawerAcct" title="出票人账号" /> 
										                </td> 
										               ...
										               出票人全称
										                ...
										                <td>
										                 	<input type="text" name="bill.drawerNm" id="drawerNm" title="出票人全称" /> 
										                </td>
									                 ...
									                 <tr>
										                ...
										                <td>
										                 	<input type="text" name="bill.oriCrdtrNm" id="oriCrdtrNm" maxlength="10" title="原收款人名称"   /> 
										                </td>
										                   <td class="text_tablehead_b">
										                 图像信息
										                </td>
                  								  ...
                  								  <input name="photo" type="button" style="cursor: pointer" class="button"
									                  ...
									                  <tr>
										           	 	<td class="text_tablehead_b">图像路径</td>
											           	<td >
										                   <input type="text"   id="imagepath" name="bill.imagepath" title="图片路径"  readonly="readonly"  />
										                </td>
										                <td class="text_tablehead_b">图像名称</td>
										                <td >
										                 	<input type="text"   id="imagename" name="bill.imagename"  title="图片名称"  readonly="readonly"  />
										                </td>
									                 ...
									                 <tr>
										                ...
										                <td>
										                 	<input type="text" name="bill.numOfEndrsr" id="numOfEndrsr" maxlength="10" title="背书人数"  onkeyup="fun_number(this);namezcx(this);" /><font color="#FF0000">*</font>
										                </td>
									                 </tr>
									                 <tr>
									                 	<td colspan="4">
