          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2">票交回执业务查询</span></div></td><td width="781"></td>
                </tr>
              </table>
			 <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_head">
               <tr>
                ...
                <tr>
              		...
              		<td class="text_tablehead_b">收款人帐号</td>
             		 <td   >
				                  <html:text property="po.cdtrAcct" maxlength="20" style="width:210px;"/>
				                  	</td>
              		<td class="text_tablehead_b">付款人帐号</td>
                   <td   >
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                <tr>
					                   ...
					                   <td  align="center" class="text_listhead">明细标识号</td>					                  
					                   <td  align="center" class="text_listhead">原cis交易序号</td>
					                   <td  align="center" class="text_listhead">原cis票据号码</td>
					                     <td  align="center" class="text_listhead">回执状态</td>
                 ...
                 <logic:present name="queryList">
									  ...
									  <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
							                  ...
							                  <td  class="text_list"><div class="gridCell_standard">${po.ornglCisNotesNo}</td>
							                  <td  class="text_list"><div class="gridCell_standard">${po.rcptSts}</td>
