...
<script language="javascript">
	...
	function pushbackcheck(id){
	var newurl = "<%=path %>/TransProcessAction.do?method=comcheck&PID="+id +"&operway=00&viewcheck=viewcheck";
		// newurl = "<%=path %>/RecvTransProcessAction.do?method=pushbackcheck&id="+id ;
		viewDetails(newurl);	
	}
...
<html:form  method="post" action="/RecvTransProcessAction.do?method=querySendConfirmxml">
          ...
          <td>
            <div align="center">
              <table width="95%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                <td colspan="6"><div  class="text_title"><span class="text_blue2">来报待处理复核查询条件</span></div></td>
                </tr>
              </table>
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                <tr>
					                    ...
					                    <c:if test="${condition.pmtTp eq 'F100'}">
					                     ...
					                     <td  align="center" class="text_listhead">成功回执金额</td>
					                      <td  align="center" class="text_listhead">成功回执笔数</td>
					       				...
					       				<td  align="center" class="text_listhead">复核</td>
					            </tr>
                 <logic:present name="queryList">
                     ...
                     <td  class="text_list"><div class="gridCell_standard">
							                     <a href="#"   onClick="pushbackcheck('${po.pid }')"><u>复核1 </u></a>
