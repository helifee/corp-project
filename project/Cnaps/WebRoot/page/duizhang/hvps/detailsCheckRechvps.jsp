	          			...
	          			<td>
		            		...
		            		<div align="center"><table width="95%"  class="tbcolor">
					                <tr class="text_listhead">
					                   ...
					                   <td  align="center" class="text_listhead">本类报文金额</td>
									  ...
									  <logic:iterate id="po" name="queryList">
										   <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
						                      ...
						                      <td  class="text_list"><div align="center"><span class="text_list">
                                               <a href="#"   onClick="viewdetails('${po.id}','${po.sndrcvtp}','${po.chckdt }','${po.pmttp }')"><u>业务明细核对</u></a></span></div>
                                               </td>
						                  </tr>
					                  </logic:iterate> 
