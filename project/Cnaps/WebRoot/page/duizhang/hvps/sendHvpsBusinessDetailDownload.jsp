...
<body>
<html:form method="post" action="/hvpsBusinessDetailDownloadAction.do?method=sendMsg">
	  	...
	  	<tr valign="top">
	    	...
	    	<td >
	      		...
	      		<table width="75%" border="0" cellspacing="0" cellpadding="0" align="center">
			       ...
			       <tr>
					 <td  >
						<div  class="text_title"><span class="text_blue2">大额明细下载申请</span></div>
					</td>
				 </tr>
	        		<tr>
	          			<td>
				...
				.getAttribute("bankInfo");
				                 ...
				                 <tr>
				                  ...
				                  <tr>
                                   	<td colspan="4"><span class="text_tablehead">明细清单</span></td>
                                   </tr>
                                   <tr>
				                  	<td  class="text_tablehead_b">
				                  		明细总条数：
