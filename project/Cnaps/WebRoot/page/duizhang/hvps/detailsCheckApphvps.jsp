...
<script language="javascript">
	...
	function viewdetails1(id){
		var newurl = "<%=path %>/DuizhangAction.do?method=detailsCheckDetl&systemcd=HVPS&msgId="+id;
		viewDetails(newurl);	
	}
	function viewdetails2(id){
		var newurl = "<%=path %>/DuizhangAction.do?method=detailsCheckDuizhangDetl&systemcd=HVPS&msgId="+id;
		viewDetails(newurl);	
	}
</script>
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">大额明细核对申请查询</span></div>
                					</td>
                				</tr>
                			</table>
							                  ...
							                  <td  ><div class="gridCell_standard">${po.instgdrctpty }</div></td>
							                   <td  ><div class="gridCell_standard">${po.systemcd }</div></td>		
							                    <td  ><div class="gridCell_standard">${po.chckdt }</div></td>	
							                     <td  ><div class="gridCell_standard">${po.nbofchckreq }</div></td>
