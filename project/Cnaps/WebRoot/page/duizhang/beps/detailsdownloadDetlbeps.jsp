	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		<tr>
	          			...
	          			<div align="center">
                				...
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">小额明细下载明细</span></div>
                					</td>
                				</tr>
                			</table>
											</div>
					                ...
					                <logic:present name="queryList">
									  <logic:iterate id="po" name="queryList">
										   <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
							                  <td  ><div class="gridCell_standard">${po.orgnlmsgid }</div></td>
							                  <td  ><div class="gridCell_standard">${po.orgnlinstgpty }</div></td>
							                  <td  ><div class="gridCell_standard">${po.orgnlmsgtpcd }</div></td>
						                    ...
						                    <td  ><div class="gridCell_standard">${po.prccd }</div></td>
							                  <td  ><div class="gridCell_standard">${po.rjctinf }</div></td>
							                  <td  ><div class="gridCell_standard">${po.netgdt }</div></td>
							                  <td  ><div class="gridCell_standard">${po.netgrnd }</div></td>
							                  <td  ><div class="gridCell_standard">${po.sttlmdt }</div></td> 
							                  <td  ><div class="gridCell_standard">${po.dwnldmsg }</div></td> 
						                  </tr>
					                  </logic:iterate> 
