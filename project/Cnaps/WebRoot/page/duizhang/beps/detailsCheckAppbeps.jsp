...
<script language="javascript">
	...
	function viewdetails1(id){
		var newurl = "<%=path %>/DuizhangAction.do?method=detailsCheckDetl&systemcd=BEPS&msgId="+id;
		viewDetails(newurl);	
	}
	function viewdetails2(id){
		var newurl = "<%=path %>/DuizhangAction.do?method=detailsCheckDuizhangDetl&systemcd=BEPS&msgId="+id;
		viewDetails(newurl);	
	}
</script>
...
<body>
<html:form  method="post" action="/DuizhangAction.do?method=queryDetailsCheck">
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">小额明细核对申请查询</span></div>
                					</td>
                				</tr>
                			</table>
										   ...
										   <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
							                  ...
							                  <td  ><div class="gridCell_standard">${po.instgdrctpty }</div></td>
							                   <td  ><div class="gridCell_standard">${po.systemcd }</div></td>		
							                    ...
							                    <td  ><div class="gridCell_standard">${po.nbofpmtchckrsp }</div></td>	
							                    <td  ><div class="gridCell_standard">${po.nbofmsgchckrsp }</div></td>	
							                   <td  ><div class="gridCell_standard">${po.prcsts }</div></td>          
						                      <td  ><div align="center"><span >
                                               <a href="#"   onClick="viewdetails1('${po.msgid}')"><u>明细</u></a></span></div>
                                               </td>
						                      <td  ><div align="center"><span >
                                               <a href="#"   onClick="viewdetails2('${po.msgid}')"><u>明细核对申请信息</u></a></span></div>
                                               </td>
						                  </tr>
					                  </logic:iterate> 
