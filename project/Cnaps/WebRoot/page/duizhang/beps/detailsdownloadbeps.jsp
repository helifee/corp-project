...
<script language="javascript">
	...
	function viewdetails(id){
		var newurl = "<%=path %>/DuizhangAction.do?method=detailsDownloadDetl&systemcd=BEPS&msgId="+id;
		viewDetails(newurl);	
	}
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">小额业务明细下载</span></div>
                					</td>
                				</tr>
                			</table>
					                ...
					                <logic:present name="queryList">
									  <logic:iterate id="po" name="queryList">
										   <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
							                  ...
							                  <td  ><div class="gridCell_standard">${po.credttm }</div></td>
							                  <td  ><div class="gridCell_standard">${po.instgdrctpty }</div></td>
							                  <td  ><div class="gridCell_standard">${po.instgpty }</div></td>
							                  <td  ><div class="gridCell_standard">${po.instddrctpty }</div></td>
							                  <td  ><div class="gridCell_standard">${po.instdpty }</div></td>
							                   <td  ><div class="gridCell_standard">${po.systemcd }</div></td>		
							                    <td  ><div class="gridCell_standard">${po.nbofdwnld }</div></td>					                  
						                      <td  ><div align="center"><span >
                                               <a href="#"   onClick="viewdetails('${po.msgid}')"><u>明细</u></a></span></div>
                                               </td>
