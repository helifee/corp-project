...
<script language="javascript">
	...
	function viewdetails1(id){
		var newurl = "<%=path %>/DuizhangAction.do?method=checkNotifyDetails&systemcd=BEPS&msgId="+id;
		viewDetails(newurl);	
	}
	function viewdetails2(chckdt){
		var newurl = "<%=path %>/DuizhangAction.do?method=checkDetails&systemcd=BEPS&chckdt="+chckdt;
		viewDetails(newurl);	
	}
</script>
	      		...
	      		<table width="100%" border="0" cellspacing="0" cellpadding="0">
	        		<tr>
	          			...
	          			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" >
                				<tr>
                					<td colspan="6">
                						<div  class="text_title"><span class="text_blue2">小额汇总核对通知查询</span></div>
                					</td>
                				</tr>
                			</table>
