...
<body>
<html:form method="post" action="/bepsBusinessDuizhangAction.do?method=sendMsg">
	  	...
	  	<tr valign="top">
	    	...
	    	<td >
	      		...
	      		<table width="75%" border="0" cellspacing="0" cellpadding="0" align="center">
			       ...
			       <tr>
					 <td  >
						<div  class="text_title"><span class="text_blue2">小额业务对账申请</span></div>
					</td>
				 </tr>
	        		<tr>
	          			<td>
