...
<script language="javascript">
	function viewbykey(indentifier,business){
		var newurl = "<%=path %>/hvpscitycodealterdetailAction.do?method=querysendMsg&business="+business+"&detailid=" 
			+ indentifier;
		viewDetails(newurl);
	}
</script>
...
<body>
<html:form  method="post" action="/hvpscitycodealternotifyAction.do?method=findList&business=${business}">
          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2"> 城市代码变更通知</span></div></td><td width="781"></td>
                </tr>
              </table>
			 <table width="95%" border="0" cellpadding="0" cellspacing="0" style="border:1px #B3B3B3 solid; padding:3px;background: #F2F2F2;">
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                ...
                <tr>
                  ...
                  <td  align="center" class="text_listhead">总记录数</td>
                  <!--<td  align="center" class="text_listhead">本报文记录起始序号</td> -->
                  <!--<td  align="center" class="text_listhead">本报文记录截止序号</td> -->
                  <td  align="center" class="text_listhead">变更期数</td>
                  <td  align="center" class="text_listhead">变更记录数目</td>
                  <!--<td  align="center" class="text_listhead">行别变更数目</td> -->
                  <!--<td  align="center" class="text_listhead">CCPC代码变更数目</td> -->
                  <td  align="center" class="text_listhead">城市代码变更数目</td>
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6"> 
                 ...
                 <!--<td  class="text_list"><div class="gridCell_standard">${po.id }</td> -->
                  ...
                  <td  class="text_list"><div class="gridCell_standard">${po.totalnumber }</td>
                  <!--<td  class="text_list"><div class="gridCell_standard">${po.startnumber }</td>   -->                     
                  <!--<td  class="text_list"><div class="gridCell_standard">${po.endnumber }</td>        -->          
                  <td  class="text_list"><div class="gridCell_standard">${po.changenumber}</td>
                  <td  class="text_list"><div class="gridCell_standard">${po.changerecordnumber}</td>
                  <!--<td  class="text_list"><div class="gridCell_standard">${po.banktypechangenumber}</td>-->
                  <!--<td  class="text_list"><div class="gridCell_standard">${po.ccpcchangenumbe}</td>-->
                  <td  class="text_list"><div class="gridCell_standard">${po.citychangenumber}</td>
                  <td  class="text_list">
