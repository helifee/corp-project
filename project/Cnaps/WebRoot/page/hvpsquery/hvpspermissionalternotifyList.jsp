...
<script language="javascript">
	function viewbykey(indentifier,business){
		var newurl = "<%=path %>/hvpspermissionalterdetailAction.do?method=querysendMsg&business="+business+"&detailid=" 
			+ indentifier;
		viewDetails(newurl);
	}
</script>
...
<body>
<html:form  method="post" action="/hvpspermissionalternotifyAction.do?method=findList&business=${business}">
          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2"> 业务权限变更通知 </span></div></td><td width="781"></td>
                </tr>
              </table>
			 <table width="95%" border="0" cellpadding="0" cellspacing="0" style="border:1px #B3B3B3 solid; padding:3px;background: #F2F2F2;">
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6">
                  ...
                  <td  class="text_list"><div class="gridCell_standard">${po.sendbranch }</div></td>
                  <td  class="text_list"><div class="gridCell_standard">${po.recvbranch }</div></td>
                  <td  class="text_list"><div class="gridCell_standard">${po.syscd }</div></td>   
                  <td  class="text_list"><div class="gridCell_standard">${po.remarkinfo }</div></td> 
