...
<body>
<html:form  method="post" action="/hvpssystemstatusnotifyAction.do?method=findList&business=${business}">
          ...
          <td>
            <div align="center">
             <table width="95%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td ><div class="text_title"><span class="text_blue2"> 系统状态变更列表</span></div></td>
                </tr>
              </table>
