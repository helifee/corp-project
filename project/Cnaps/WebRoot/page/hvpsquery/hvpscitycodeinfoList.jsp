...
<body>
<html:form  method="post" action="/hvpscitycodeinfoAction.do?method=findList&business=${business}">
          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2"> 城市代码查询</span></div></td><td width="781"></td>
                </tr>
              </table>
			 <table width="95%" border="0" cellpadding="0" cellspacing="0" style="border:1px #B3B3B3 solid; padding:3px;background: #F2F2F2;">
                <tr>
                 <td width="120" height="40" class="text_tablehead_b">城市代码：</td>
                  <td width="120"><div align="left">
                   <html:text property="po.citycode" maxlength="6" onkeyup="fun_number(this)" onblur="fun_number(this)"/>
                  </td>
                  <td width="120" height="40" class="text_tablehead_b">城市名称：</td>
                  <td width="120"><div align="left">
                   <html:text property="po.cityname" maxlength="35"/>
                  </td>
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                ...
                <tr>
                  ...
                  <td  align="center" class="text_listhead">城市代码</td>
                  <td  align="center" class="text_listhead">城市名称</td>
                  <td  align="center" class="text_listhead">城市类型</td>
               ...
               <!-- <td  class="text_list"><div class="gridCell_standard">${po.id }</td>-->
                  ...
                  <td  class="text_list"><div class="gridCell_standard">${po.cityname}</td>
                  <td  class="text_list"><div class="gridCell_standard">${po.citytype}</td>
