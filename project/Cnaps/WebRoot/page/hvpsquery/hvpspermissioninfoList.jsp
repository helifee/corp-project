          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2"> 业务权限查询 </span></div></td><td width="781"></td>
                </tr>
              </table>
			 <table width="95%" border="0" cellpadding="0" cellspacing="0" style="border:1px #B3B3B3 solid; padding:3px;background: #F2F2F2;">
                <tr>
                 <td width="120" height="40" class="text_tablehead_b">发起参与机构：</td>
                  ...
                  <td width="120" height="40" class="text_tablehead_b">接收参与机构：</td>
                  <td width="120"><div align="left">
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                <tr>
                   ...
                   <td  align="center" class="text_listhead">发起参与机构行别</td>
                  <td  align="center" class="text_listhead">接收参与机构行别</td>
                                   
                   <td  align="center" class="text_listhead">发起参与机构</td>
                    <td  align="center" class="text_listhead">接受参与机构</td>
                    <td  align="center" class="text_listhead">报文编号</td>
                  <td  align="center" class="text_listhead">业务类型编码</td>
                  <td  align="center" class="text_listhead">权限标识</td>
                  <td  align="center" class="text_listhead">权限权重值</td>
