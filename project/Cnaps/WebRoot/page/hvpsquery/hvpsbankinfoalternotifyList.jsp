...
<script language="javascript">
	function viewbykey(indentifier,business){
		var newurl = "<%=path %>/hvpsbankinfoalterdetailAction.do?method=querysendMsg&business="+business+"&detailid=" 
			+ indentifier;
		viewDetails(newurl);
	}
</script>
...
<body>
<html:form  method="post" action="/hvpsbankinfoalternotifyAction.do?method=findList&business=${business}">
          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2"> 行名行号变更通知 </span></div></td><td width="781"></td>
                </tr>
              </table>
