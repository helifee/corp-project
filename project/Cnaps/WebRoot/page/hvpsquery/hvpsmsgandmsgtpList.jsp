...
<body>
<html:form  method="post" action="/hvpsmsgandmsgtpAction.do?method=findList&business=${business}">
<input id="repeatmark" type="hidden" value="0" />
 ...
 <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr valign="top">
            ...
            <div align="center">
			 ...
			 <table width="95%" border="0" cellpadding="0" cellspacing="0" style="border:1px #B3B3B3 solid; padding:3px;background: #F2F2F2;">
                 ...
                 <td width="120" height="40" class="text_tablehead_b">
												...
												<td width="120">
													<div align="left">
														<html:text property="po.msgtp" maxlength="35"
												...
												<td width="120">
													<div align="left">
														<html:text property="po.syscode" readonly="true"
															onclick="WdatePicker()" />
												</td>
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                <tr>
                   ...
                   <td  align="center" class="text_listhead">业务种类</td>
    ...
    <td  class="text_list"><div class="gridCell_standard">${po.syscode}</td>
                 <td  class="text_list"><div class="gridCell_standard">${po.msgtp}</td>
                  <td  class="text_list"><div class="gridCell_standard">${po.pmttp}</td>
                  <td  class="text_list"><div class="gridCell_standard">${po.pmtkd}</td>
