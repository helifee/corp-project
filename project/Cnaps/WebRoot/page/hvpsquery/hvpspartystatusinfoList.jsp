...
<body>
<html:form  method="post" action="/hvpspartystatusinfoAction.do?method=findList&business=${business}">
          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2"> 参与者运行状态查询</span></div></td><td width="781"></td>
                </tr>
              </table>
			 <table width="95%" border="0" cellpadding="0" cellspacing="0" style="border:1px #B3B3B3 solid; padding:3px;background: #F2F2F2;">
                 ...
                 <td width="120" height="40" class="text_tablehead_b">
												...
												<td width="120">
													<div align="left">
														<html:text property="po.bankcode" maxlength="35"
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                <tr>
                   ...
                   <td  align="center" class="text_listhead">参与机构行号</td>
                   <td  align="center" class="text_listhead">参与机构运行状态</td>
                ...
                <tr class="text_list" onmouseover="this.bgColor='#CE4C56'" onmouseout="this.bgColor='E6E6E6'" style="cursor: hand;" bgcolor="E6E6E6"> 
                 <td  class="text_list"><div class="gridCell_standard">${po.bankcode}</td>
                  <td  class="text_list"><div class="gridCell_standard">${po.runstat}</td>
                  <td  class="text_list"><div class="gridCell_standard">${po.nodcode}</td>
