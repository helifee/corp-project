...
<body>
<html:form  method="post" action="/hvpsserviceofflinenotifyAction.do?method=findList&business=${business}">
          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2"> 停启运通知查询</span></div></td><td width="781"></td>
                </tr>
              </table>
			 <table width="95%" border="0" cellpadding="0" cellspacing="0" style="border:1px #B3B3B3 solid; padding:3px;background: #F2F2F2;">
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                <tr>
                   ...
                   <td  align="center" class="text_listhead">停运日期</td>
                   <td  align="center" class="text_listhead">预计启运时间</td>
                ...
                <!-- <td  class="text_list"><div class="gridCell_standard">${po.id }</td>-->
                  ...
                  <td  class="text_list"><div class="gridCell_standard">${po.stopgsvcdt }</td>
                  <td  class="text_list"><div class="gridCell_standard">${po.estmtdstartsvc }</td>   
