...
<body>
<html:form  method="post" action="/hvpspartystatusnotifyAction.do?method=findList&business=${business}">
          ...
          <td>
            <div align="center">
             <table width="95%" height="22" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="134" style="background-image:url('<%=path%>/image/psimage.jpg');"><div align="left"><span class="text_blue2">  状态变更通知查询</span></div></td><td width="781"></td>
                </tr>
              </table>
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
                <tr>
        		  ...
        		  <td  align="center" class="text_listhead">系统号</td>
       			  <td  align="center" class="text_listhead">参与机构</td>
       			  <td  align="center" class="text_listhead">状态变更类型</td>
                ...
                <!-- <td  class="text_list"><div class="gridCell_standard">${po.id }</td>-->
                  ...
                  <td  class="text_list"><div class="gridCell_standard">${po.altertype }</td>
