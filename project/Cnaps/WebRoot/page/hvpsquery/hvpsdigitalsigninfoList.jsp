...
<html>
	...
	<body>
		<html:form method="post"
			action="/hvpsdigitalsigninfoAction.do?method=findList&business=${business}">
									...
									<div align="center">
										<table width="95%" height="22" border="0" cellpadding="0"
											...
											<tr>
												<td width="134"
													...
													<div align="left">
														<span class="text_blue2"> 数字证书查询</span>
													</div>
												</td>
												<td width="781"></td>
											</tr>
										...
										<table width="95%" border="0" cellpadding="0" cellspacing="0"
											...
											<tr>
												...
												<td width="120">
													<div align="left">
														<html:text property="po.bankcode" maxlength="14"
												...
												<td width="120">
													<div align="left">
														<html:text property="po.certbinddate" maxlength="14"
															onkeyup="fun_number(this)" onblur="fun_number(this)" />
												</td>
