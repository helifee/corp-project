...
<body>
<html:form  method="post" action="/hvpssysparaalterdetailAction.do?method=findList">
			 ...
			 <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="normalline">
              ...
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbcolor">
                <tr>
                   ...
                   <td  align="center" class="text_listhead">公共数据值</td>
                ...
                <logic:present name="queryList">
                 ...
                 <td  class="text_list"><div class="gridCell_standard">${po.cmondataval }</td>
