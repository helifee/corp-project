...
<html>
	...
	<body>
		<html:form method="post"
			action="/hvpscisagentAction.do?method=findList&business=${business}">
									...
									<div align="center">
										<table width="95%" height="22" border="0" cellpadding="0"
											...
											<tr>
												<td width="134"
													...
													<div align="left">
														<span class="text_blue2"> CIS代理行信息查询</span>
													</div>
												</td>
												<td width="781"></td>
											</tr>
										...
										<table width="95%" border="0" cellpadding="0" cellspacing="0"
											...
											<tr>
												...
												<td width="120">
													<div align="left">
														<html:text property="po.workdate" readonly="true"
															onclick="WdatePicker()" />
												</td>
										...
										<table width="95%" border="0" cellpadding="0" cellspacing="0"
											...
											<tr>
												...
												<td align="center" class="text_listhead">小额代理行号</td>
