          ...
          <td>
            <div align="center">
             <table width="95%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td ><div class="text_title"><span class="text_blue2"> CCPC数据变更通知</span></div></td><td width="781"></td>
                </tr>
              </table>
           ...
           <tr>
                  ...
                  <td width="120" height="40" class="text_tablehead_b">CCPC代码：</td>
                  <td width="120"><div align="left">
                   <input width="120" type="text" name="po.ndcd"/>
                  </td>
                  <td width="120" height="40" class="text_tablehead_b">CCPC名称：</td>
                  <td width="120"><div align="left">
              ...
              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tbcolor">
               <tr>
                  ...
                  <td  align="center" class="text_listhead">CCPC代码</td>
                  <td  align="center" class="text_listhead">CCPC名称</td>
                  <td  align="center" class="text_listhead">CCPC类型</td>
