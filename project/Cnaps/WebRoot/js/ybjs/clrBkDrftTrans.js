...
function mytestpanel1(){
	...
	var panelItems = [
			{xtype:'tabpanel',
				...
				items:[
					{title:'录入',
						html:loaderUrl('/hvpsFront115Action.do?method=gotoSaveSendDraftAmtPage','add')},
					{title:'修改',
						html:loaderUrl('/hvpsFront115Action.do?method=findModifySendList','modify')},
					{title:'复核',
						html:loaderUrl('/hvpsFront115Action.do?method=findCheckSendList','check')}
				]
			}
	];
