...
var i = 1, j = 1;   
function AddRow() {
	listnum1 =document.getElementById("listnum1").value;
...
//oNewCell1.style.class="text11";
	oNewCell1.innerHTML = "<select name='collcode'><option value='1111111111'>\u56fd\u7a0e</option>" + "<option value='2222222222'>\u5730\u7a0e</option><option value='3333333333'>\u6d77\u5173</option>" + "<option value='4444444444'>\u8d22\u653f</option><option value='5555555555'>\u5176\u4ed6</option></select>";
	...
	oNewCell3.innerHTML = "<input type='text' name='amt' id='amt" + j + "'" +"  value=\"\"  onblur=\"value=fmoney(value, 2);if(value == 'NaN.undefined') value = '';addchange();\" >";
