// JavaScript Document
    ...
    HVPS=[PA100,PA108,PA109,PA110,PA101,PA102,PA104,PA201];
    
    BEPS=[PA100,PA108,PA109,PA110,PA101,PA102,PA104,PA201,PA301];
	...
	function isDisplayToInline(temp){
		...
		var alist = [];
		//将所有的输入框数组集群
		var lists = A1000211_67.concat(A10502108).concat(A2020290_1).concat(A201000).concat(A2020290_2).concat(A0000);
		//将所有的输入框滞空
		if(signval=="sign0"){
...
//提交时的判断
	function validate(){
		...
		var skhkhhhh = document.getElementById('skhkhhhh');//收款行开户行行号
		var skrkhhmc = document.getElementById('skrkhhmc');//收款人开户行名称
