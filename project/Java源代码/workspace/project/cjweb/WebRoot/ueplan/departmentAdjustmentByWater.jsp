...
<html>
  ...
  <body>
  	<table align="center">
    	...
    	<tr>
    		<td>
	    		<a href="ueplan/departmentAdjustmentByEle.jsp?type=ele">用电量</a>&nbsp;&nbsp;
	    		<a>用水量</a>
    		</td>
    	</tr>
		<tr>
			<td>
				<table align="center">
					<tr>
						<td>总量：<span class="underline">10000</span>&nbsp;立方米</td>
						<td>分配量：<span class="underline">8000</span>&nbsp;立方米</td>
						<td>剩余量：<span id="remaining" class="underline">2000</span>&nbsp;立方米</td>
					</tr>
				</table>
			</td>
		</tr>
